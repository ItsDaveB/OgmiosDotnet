...
public readonly partial struct Ogmios
{
    ...
    public readonly partial struct QueryLedgerStateUnavailableInCurrentEra
    {
        ...
        public readonly partial struct SomeQueryIsNotAvailableForTheRequestedLedgerEra
            : IJsonObject<Generated.Ogmios.QueryLedgerStateUnavailableInCurrentEra.SomeQueryIsNotAvailableForTheRequestedLedgerEra>
        {
            /// <summary>
            /// Conversion from <see cref="ImmutableList{JsonObjectProperty}"/>.
            /// </summary>
            /// <param name="value">The value from which to convert.</param>
            public static implicit operator SomeQueryIsNotAvailableForTheRequestedLedgerEra(ImmutableList<JsonObjectProperty> value)
            {
                return new(value);
            }
            ...
            /// </summary>
            /// <param name="value">The value from which to convert.</param>
            public static implicit operator ImmutableList<JsonObjectProperty>(SomeQueryIsNotAvailableForTheRequestedLedgerEra value)
            {
                return
            ...
            /// </summary>
            /// <param name="value">The value from which to convert.</param>
            public static implicit operator SomeQueryIsNotAvailableForTheRequestedLedgerEra(JsonObject value)
            {
            ...
            /// </summary>
            /// <param name="value">The value from which to convert.</param>
            public static implicit operator JsonObject(SomeQueryIsNotAvailableForTheRequestedLedgerEra value)
            {
                return
                    value.AsObject;
            }
            ...
            /// </para>
            /// </remarks>
            public Generated.Ogmios.QueryLedgerStateUnavailableInCurrentEra.SomeQueryIsNotAvailableForTheRequestedLedgerEra.CodeEntity Code
            {
                get
                {
                    if ((this.backing & Backing.JsonElement) != 0)
                    ...
                    if ((this.backing & Backing.Object) != 0)
                    {
                        ...
                        {
                            return result.As<Generated.Ogmios.QueryLedgerStateUnavailableInCurrentEra.SomeQueryIsNotAvailableForTheRequestedLedgerEra.CodeEntity>();
                        }
                    }
            ...
            /// <inheritdoc/>
            public static SomeQueryIsNotAvailableForTheRequestedLedgerEra FromProperties(IDictionary<JsonPropertyName, JsonAny> source)
            {
                return new(source.Select(kvp => new JsonObjectProperty(kvp.Key, kvp.Value)).ToImmutableList());
            }

            /// <inheritdoc/>
            public static SomeQueryIsNotAvailableForTheRequestedLedgerEra FromProperties(params (JsonPropertyName Name, JsonAny Value)[] source)
            {
            ...
            public static SomeQueryIsNotAvailableForTheRequestedLedgerEra FromProperties(ImmutableList<JsonObjectProperty> source)
            {
                return new(source);
            }

            /// <summary>
            /// Creates an instance of a <see cref="SomeQueryIsNotAvailableForTheRequestedLedgerEra"/>.
            /// </summary>
            public static SomeQueryIsNotAvailableForTheRequestedLedgerEra Create(in Generated.Ogmios.QueryLedgerStateUnavailableInCurrentEra.SomeQueryIsNotAvailableForTheRequestedLedgerEra.CodeEntity code, in Corvus.Json.JsonString message)
            {
            ...
            public SomeQueryIsNotAvailableForTheRequestedLedgerEra WithCode(in Generated.Ogmios.QueryLedgerStateUnavailableInCurrentEra.SomeQueryIsNotAvailableForTheRequestedLedgerEra.CodeEntity value)
            {
            ...
            /// <param name="value">The new property value</param>
            /// <returns>The instance with the property set.</returns>
            public SomeQueryIsNotAvailableForTheRequestedLedgerEra WithMessage(in Corvus.Json.JsonString value)
            {
            ...
            /// <inheritdoc />
            public SomeQueryIsNotAvailableForTheRequestedLedgerEra SetProperty<TValue>(in JsonPropertyName name, TValue value)
            ...
            /// <inheritdoc />
            public SomeQueryIsNotAvailableForTheRequestedLedgerEra RemoveProperty(in JsonPropertyName name)
            {
                return new(__CorvusObjectHelpers.GetPropertyBackingWithout(this, name));
            }

            /// <inheritdoc />
            public SomeQueryIsNotAvailableForTheRequestedLedgerEra RemoveProperty(string name)
            {
                return new(__CorvusObjectHelpers.GetPropertyBackingWithout(this, name));
            }

            /// <inheritdoc />
            public SomeQueryIsNotAvailableForTheRequestedLedgerEra RemoveProperty(ReadOnlySpan<char> name)
            {
                return new(__CorvusObjectHelpers.GetPropertyBackingWithout(this, name));
            }

            /// <inheritdoc />
            public SomeQueryIsNotAvailableForTheRequestedLedgerEra RemoveProperty(ReadOnlySpan<byte> name)
            {
                return new(__CorvusObjectHelpers.GetPropertyBackingWithout(this, name));
            }
            ...
            private static class __CorvusObjectHelpers
            {
                ...
                /// <exception cref="InvalidOperationException">The value is not an object.</exception>
                public static ImmutableList<JsonObjectProperty> GetPropertyBacking(in SomeQueryIsNotAvailableForTheRequestedLedgerEra that)
                {
                ...
                /// <exception cref="InvalidOperationException">The value is not an object.</exception>
                public static ImmutableList<JsonObjectProperty> GetPropertyBackingWithout(in SomeQueryIsNotAvailableForTheRequestedLedgerEra that, in JsonPropertyName name)
                {
                    if ((that.backing & Backing.Object) != 0)
                    {
                ...
                /// <returns>An immutable list of <see cref="JsonObjectProperty"/>, built from the existing object, without the given property.</returns>
                /// <exception cref="InvalidOperationException">The value is not an object.</exception>
                public static ImmutableList<JsonObjectProperty> GetPropertyBackingWithout(in SomeQueryIsNotAvailableForTheRequestedLedgerEra that, ReadOnlySpan<char> name)
                {
                    if ((that.backing & Backing.Object) != 0)
                    {
                        return that.objectBacking.Remove(name);
                ...
                /// <returns>An immutable list of <see cref="JsonObjectProperty"/>, built from the existing object, without the given property.</returns>
                /// <exception cref="InvalidOperationException">The value is not an object.</exception>
                public static ImmutableList<JsonObjectProperty> GetPropertyBackingWithout(in SomeQueryIsNotAvailableForTheRequestedLedgerEra that, ReadOnlySpan<byte> name)
                {
                    if ((that.backing & Backing.Object) != 0)
                    {
                        return that.objectBacking.Remove(name);
                ...
                /// <returns>An immutable list of <see cref="JsonObjectProperty"/>, built from the existing object, without the given property.</returns>
                /// <exception cref="InvalidOperationException">The value is not an object.</exception>
                public static ImmutableList<JsonObjectProperty> GetPropertyBackingWithout(in SomeQueryIsNotAvailableForTheRequestedLedgerEra that, string name)
                {
                    if ((that.backing & Backing.Object) != 0)
                    {
                        return that.objectBacking.Remove(name);
                ...
                /// <exception cref="InvalidOperationException">The value is not an object.</exception>
                public static ImmutableList<JsonObjectProperty> GetPropertyBackingWith(in SomeQueryIsNotAvailableForTheRequestedLedgerEra that, in JsonPropertyName name, in JsonAny value)
                {
                    if ((that.backing & Backing.Object) != 0)
                    {
