        ...
        public readonly partial struct RequiredCredentialAndFromArray
        {
            ...
            public ValidationContext Validate(in ValidationContext validationContext, ValidationLevel level = ValidationLevel.Flag)
            {
                ...
                if (level > ValidationLevel.Basic)
                {
                    ...
                    result = result.PushSchemaLocation("Ogmios.Schema/Ogmios/v6.14/Source/cardano.json#/definitions/DelegateRepresentativeSummary/oneOf/2/properties/delegators");
                }
            ...
            public static partial class CorvusValidation
            {
                    ...
                    ValidationLevel level)
                {
                    ...
                    int length = 0;
                    using JsonArrayEnumerator<Generated.DelegateRepresentativeSummary.DelegateRepresentativeAbstain.RequiredCredentialAndFromArray.RequiredCredentialAndFrom> arrayEnumerator = value.EnumerateArray();
