...
public readonly partial struct Ogmios
{
    ...
    public readonly partial struct SubmitTransactionFailure
    {
        ...
        public readonly partial struct SubmitTransactionFailureDRepNotRegistered
            : IJsonObject<Generated.Ogmios.SubmitTransactionFailure.SubmitTransactionFailureDRepNotRegistered>
        {
            /// <summary>
            /// Conversion from <see cref="ImmutableList{JsonObjectProperty}"/>.
            /// </summary>
            /// <param name="value">The value from which to convert.</param>
            public static implicit operator SubmitTransactionFailureDRepNotRegistered(ImmutableList<JsonObjectProperty> value)
            {
                return new(value);
            }
            ...
            /// </summary>
            /// <param name="value">The value from which to convert.</param>
            public static implicit operator ImmutableList<JsonObjectProperty>(SubmitTransactionFailureDRepNotRegistered value)
            {
                return
            ...
            /// </summary>
            /// <param name="value">The value from which to convert.</param>
            public static implicit operator SubmitTransactionFailureDRepNotRegistered(JsonObject value)
            {
            ...
            /// </summary>
            /// <param name="value">The value from which to convert.</param>
            public static implicit operator JsonObject(SubmitTransactionFailureDRepNotRegistered value)
            {
                return
                    value.AsObject;
            }
            ...
            /// </para>
            /// </remarks>
            public Generated.Ogmios.SubmitTransactionFailure.SubmitTransactionFailureDRepNotRegistered.CodeEntity Code
            {
                get
                {
                    if ((this.backing & Backing.JsonElement) != 0)
                    ...
                    if ((this.backing & Backing.Object) != 0)
                    {
                        ...
                        {
                            return result.As<Generated.Ogmios.SubmitTransactionFailure.SubmitTransactionFailureDRepNotRegistered.CodeEntity>();
                        }
                    }
            ...
            /// </para>
            /// </remarks>
            public Generated.Ogmios.SubmitTransactionFailure.SubmitTransactionFailureDRepNotRegistered.RequiredUnknownDelegateRepresentative Data
            {
                get
                {
                    if ((this.backing & Backing.JsonElement) != 0)
                    ...
                    if ((this.backing & Backing.Object) != 0)
                    {
                        ...
                        {
                            return result.As<Generated.Ogmios.SubmitTransactionFailure.SubmitTransactionFailureDRepNotRegistered.RequiredUnknownDelegateRepresentative>();
                        }
                    }
            ...
            /// <inheritdoc/>
            public static SubmitTransactionFailureDRepNotRegistered FromProperties(IDictionary<JsonPropertyName, JsonAny> source)
            {
                return new(source.Select(kvp => new JsonObjectProperty(kvp.Key, kvp.Value)).ToImmutableList());
            }

            /// <inheritdoc/>
            public static SubmitTransactionFailureDRepNotRegistered FromProperties(params (JsonPropertyName Name, JsonAny Value)[] source)
            {
            ...
            public static SubmitTransactionFailureDRepNotRegistered FromProperties(ImmutableList<JsonObjectProperty> source)
            {
                return new(source);
            }

            /// <summary>
            /// Creates an instance of a <see cref="SubmitTransactionFailureDRepNotRegistered"/>.
            /// </summary>
            public static SubmitTransactionFailureDRepNotRegistered Create(
                in Generated.Ogmios.SubmitTransactionFailure.SubmitTransactionFailureDRepNotRegistered.CodeEntity code,
                in Generated.Ogmios.SubmitTransactionFailure.SubmitTransactionFailureDRepNotRegistered.RequiredUnknownDelegateRepresentative data,
            ...
            public SubmitTransactionFailureDRepNotRegistered WithCode(in Generated.Ogmios.SubmitTransactionFailure.SubmitTransactionFailureDRepNotRegistered.CodeEntity value)
            {
            ...
            /// <param name="value">The new property value</param>
            /// <returns>The instance with the property set.</returns>
            public SubmitTransactionFailureDRepNotRegistered WithData(in Generated.Ogmios.SubmitTransactionFailure.SubmitTransactionFailureDRepNotRegistered.RequiredUnknownDelegateRepresentative value)
            {
            ...
            /// <param name="value">The new property value</param>
            /// <returns>The instance with the property set.</returns>
            public SubmitTransactionFailureDRepNotRegistered WithMessage(in Corvus.Json.JsonString value)
            {
            ...
            /// <inheritdoc />
            public SubmitTransactionFailureDRepNotRegistered SetProperty<TValue>(in JsonPropertyName name, TValue value)
            ...
            /// <inheritdoc />
            public SubmitTransactionFailureDRepNotRegistered RemoveProperty(in JsonPropertyName name)
            {
                return new(__CorvusObjectHelpers.GetPropertyBackingWithout(this, name));
            }

            /// <inheritdoc />
            public SubmitTransactionFailureDRepNotRegistered RemoveProperty(string name)
            {
                return new(__CorvusObjectHelpers.GetPropertyBackingWithout(this, name));
            }

            /// <inheritdoc />
            public SubmitTransactionFailureDRepNotRegistered RemoveProperty(ReadOnlySpan<char> name)
            {
                return new(__CorvusObjectHelpers.GetPropertyBackingWithout(this, name));
            }

            /// <inheritdoc />
            public SubmitTransactionFailureDRepNotRegistered RemoveProperty(ReadOnlySpan<byte> name)
            {
                return new(__CorvusObjectHelpers.GetPropertyBackingWithout(this, name));
            }
            ...
            private static class __CorvusObjectHelpers
            {
                ...
                /// <exception cref="InvalidOperationException">The value is not an object.</exception>
                public static ImmutableList<JsonObjectProperty> GetPropertyBacking(in SubmitTransactionFailureDRepNotRegistered that)
                {
                ...
                /// <exception cref="InvalidOperationException">The value is not an object.</exception>
                public static ImmutableList<JsonObjectProperty> GetPropertyBackingWithout(in SubmitTransactionFailureDRepNotRegistered that, in JsonPropertyName name)
                {
                    if ((that.backing & Backing.Object) != 0)
                    {
                ...
                /// <returns>An immutable list of <see cref="JsonObjectProperty"/>, built from the existing object, without the given property.</returns>
                /// <exception cref="InvalidOperationException">The value is not an object.</exception>
                public static ImmutableList<JsonObjectProperty> GetPropertyBackingWithout(in SubmitTransactionFailureDRepNotRegistered that, ReadOnlySpan<char> name)
                {
                    if ((that.backing & Backing.Object) != 0)
                    {
                        return that.objectBacking.Remove(name);
                ...
                /// <returns>An immutable list of <see cref="JsonObjectProperty"/>, built from the existing object, without the given property.</returns>
                /// <exception cref="InvalidOperationException">The value is not an object.</exception>
                public static ImmutableList<JsonObjectProperty> GetPropertyBackingWithout(in SubmitTransactionFailureDRepNotRegistered that, ReadOnlySpan<byte> name)
                {
                    if ((that.backing & Backing.Object) != 0)
                    {
                        return that.objectBacking.Remove(name);
                ...
                /// <returns>An immutable list of <see cref="JsonObjectProperty"/>, built from the existing object, without the given property.</returns>
                /// <exception cref="InvalidOperationException">The value is not an object.</exception>
                public static ImmutableList<JsonObjectProperty> GetPropertyBackingWithout(in SubmitTransactionFailureDRepNotRegistered that, string name)
                {
                    if ((that.backing & Backing.Object) != 0)
                    {
                        return that.objectBacking.Remove(name);
                ...
                /// <exception cref="InvalidOperationException">The value is not an object.</exception>
                public static ImmutableList<JsonObjectProperty> GetPropertyBackingWith(in SubmitTransactionFailureDRepNotRegistered that, in JsonPropertyName name, in JsonAny value)
                {
                    if ((that.backing & Backing.Object) != 0)
                    {
