...
public readonly partial struct Transaction
{
    ...
    /// </summary>
#if NET8_0_OR_GREATER
    [CollectionBuilder(typeof(CertificateArray), "Create")]
#endif
    public readonly partial struct CertificateArray
        : IJsonArray<Generated.Transaction.CertificateArray>,
          IReadOnlyCollection<Generated.Certificate>
    {
        /// <summary>
        /// Gets an empty array.
        /// </summary>
        public static CertificateArray EmptyArray { get; } = From(ImmutableList<JsonAny>.Empty);
        ...
        /// <inheritdoc/>
        Corvus.Json.JsonAny IJsonArray<CertificateArray>.this[int index]
        {
            get
            {
        ...
        public Generated.Certificate this[int index]
        {
            get
            {
                if ((this.backing & Backing.JsonElement) != 0)
                ...
                if ((this.backing & Backing.Array) != 0)
                {
                    try
                    {
                        return this.arrayBacking[index].As<Generated.Certificate>();
                    }
                    catch (ArgumentOutOfRangeException ex)
                    {
                        throw new IndexOutOfRangeException(ex.Message, ex);
        ...
        public static implicit operator CertificateArray(ImmutableList<JsonAny> value)
        {
            return new(value);
        }
        ...
        /// </summary>
        /// <param name="value">The value from which to convert.</param>
        public static implicit operator ImmutableList<JsonAny>(CertificateArray value)
        {
            return
        ...
        /// </summary>
        /// <param name="value">The value from which to convert.</param>
        public static implicit operator CertificateArray(JsonArray value)
        {
        ...
        /// </summary>
        /// <param name="value">The value from which to convert.</param>
        public static implicit operator JsonArray(CertificateArray value)
        {
            return
                value.AsArray;
        }
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="CertificateArray"/> struct.
        /// </summary>
        ...
        public static CertificateArray From(ImmutableList<JsonAny> items)
        {
            return new(items);
        }

        /// <summary>
        /// Create an new instance of the <see cref="CertificateArray"/>" struct from a span of items.
        /// </summary>
        ...
        public static CertificateArray Create(ReadOnlySpan<Generated.Certificate> items)
        {
            return new([..items]);
        }
        ...
        public static CertificateArray FromItems(params Generated.Certificate[] items)
        {
            return new([..items]);
        }
        ...
        public static CertificateArray FromItems(in Generated.Certificate item1)
        {
        ...
        /// <returns>An instance of the array constructed from the values.</returns>
        public static CertificateArray FromItems(in Generated.Certificate item1, in Generated.Certificate item2)
        {
        ...
        /// <returns>An instance of the array constructed from the values.</returns>
        public static CertificateArray FromItems(in Generated.Certificate item1, in Generated.Certificate item2, in Generated.Certificate item3)
        {
        ...
        /// <returns>An instance of the array constructed from the values.</returns>
        public static CertificateArray FromItems(in Generated.Certificate item1, in Generated.Certificate item2, in Generated.Certificate item3, in Generated.Certificate item4)
        {
        ...
        /// <returns>An instance of the array constructed from the values.</returns>
        public static CertificateArray FromItems(in Generated.Certificate item1, in Generated.Certificate item2, in Generated.Certificate item3, in Generated.Certificate item4, in Generated.Certificate item5)
        {
        ...
        /// <returns>An instance of the array constructed from the values.</returns>
        public static CertificateArray FromItems(in Generated.Certificate item1, in Generated.Certificate item2, in Generated.Certificate item3, in Generated.Certificate item4, in Generated.Certificate item5, in Generated.Certificate item6)
        {
        ...
        /// <returns>An instance of the array constructed from the values.</returns>
        public static CertificateArray FromItems(in Generated.Certificate item1, in Generated.Certificate item2, in Generated.Certificate item3, in Generated.Certificate item4, in Generated.Certificate item5, in Generated.Certificate item6, in Generated.Certificate item7)
        {
        ...
        public static CertificateArray FromRange(IEnumerable<Generated.Certificate> items)
        {
            return new([..items]);
        }
        ...
        /// <param name="items">The items from which to construct the instance.</param>
        /// <returns>An instance of the array constructed from the items .</returns>
        static CertificateArray IJsonArray<CertificateArray>.FromRange(IEnumerable<JsonAny> items)
        {
            return new([..items]);
        }
        ...
        /// <param name="items">The items from which to construct the instance.</param>
        /// <returns>An instance of the array constructed from the items.</returns>
        static CertificateArray IJsonArray<CertificateArray>.FromRange<T>(IEnumerable<T> items)
        {
        ...
        /// <inheritdoc/>
        IEnumerator<Generated.Certificate> IEnumerable<Generated.Certificate>.GetEnumerator() => this.EnumerateArray();

        /// <inheritdoc/>
        IEnumerator IEnumerable.GetEnumerator() => this.EnumerateArray();

        /// <inheritdoc/>
        int IReadOnlyCollection<Generated.Certificate>.Count => this.GetArrayLength();
        ...
        /// <inheritdoc/>
        public JsonArrayEnumerator<Generated.Certificate> EnumerateArray()
        {
            if ((this.backing & Backing.JsonElement) != 0)
            {
        ...
        /// <inheritdoc/>
        JsonArrayEnumerator IJsonArray<CertificateArray>.EnumerateArray()
        {
            if ((this.backing & Backing.JsonElement) != 0)
            {
                return new(this.jsonElementBacking);
        ...
        /// <inheritdoc/>
        JsonArrayEnumerator<TItem> IJsonArray<CertificateArray>.EnumerateArray<TItem>()
        {
            if ((this.backing & Backing.JsonElement) != 0)
            {
                return new(this.jsonElementBacking);
        ...
        /// <inheritdoc/>
        CertificateArray IJsonArray<CertificateArray>.Add(in JsonAny item1)
        {
        ...
        /// <inheritdoc/>
        CertificateArray IJsonArray<CertificateArray>.Add(params JsonAny[] items)
        {
            ImmutableList<JsonAny>.Builder builder = __CorvusArrayHelpers.GetImmutableListBuilder(this);
        ...
        /// <inheritdoc/>
        CertificateArray IJsonArray<CertificateArray>.AddRange<TArray>(in TArray items)
        {
            ImmutableList<JsonAny>.Builder builder = __CorvusArrayHelpers.GetImmutableListBuilder(this);
        ...
        /// <inheritdoc/>
        CertificateArray IJsonArray<CertificateArray>.AddRange<TItem>(IEnumerable<TItem> items)
        {
            ImmutableList<JsonAny>.Builder builder = __CorvusArrayHelpers.GetImmutableListBuilder(this);
        ...
        /// <inheritdoc/>
        CertificateArray IJsonArray<CertificateArray>.AddRange(IEnumerable<JsonAny> items)
        {
            ImmutableList<JsonAny>.Builder builder = __CorvusArrayHelpers.GetImmutableListBuilder(this);
        ...
        /// <inheritdoc/>
        CertificateArray IJsonArray<CertificateArray>.Insert(int index, in JsonAny item1)
        {
            return new(__CorvusArrayHelpers.GetImmutableListWith(this, index, item1));
        }

        /// <inheritdoc/>
        CertificateArray IJsonArray<CertificateArray>.InsertRange<TArray>(int index, in TArray items)
        {
            return new(__CorvusArrayHelpers.GetImmutableListWith(this, index, items.EnumerateArray()));
        }

        /// <inheritdoc/>
        CertificateArray IJsonArray<CertificateArray>.InsertRange<TItem>(int index, IEnumerable<TItem> items)
        {
            return new(__CorvusArrayHelpers.GetImmutableListWith(this, index, items.Select(item => item.AsAny)));
        }

        /// <inheritdoc/>
        CertificateArray IJsonArray<CertificateArray>.InsertRange(int index, IEnumerable<JsonAny> items)
        {
            return new(__CorvusArrayHelpers.GetImmutableListWith(this, index, items));
        }

        /// <inheritdoc/>
        CertificateArray IJsonArray<CertificateArray>.Replace(in JsonAny oldValue, in JsonAny newValue)
        {
            return new(__CorvusArrayHelpers.GetImmutableListReplacing(this, oldValue, newValue));
        }

        /// <inheritdoc/>
        CertificateArray IJsonArray<CertificateArray>.SetItem(int index, in JsonAny value)
        {
            return new(__CorvusArrayHelpers.GetImmutableListSetting(this, index, value));
        }

        /// <inheritdoc/>
        public CertificateArray Add(in Generated.Certificate item1)
        {
            ImmutableList<JsonAny>.Builder builder = __CorvusArrayHelpers.GetImmutableListBuilder(this);
        ...
        /// <inheritdoc/>
        public CertificateArray Add(params Generated.Certificate[] items)
        {
            ImmutableList<JsonAny>.Builder builder = __CorvusArrayHelpers.GetImmutableListBuilder(this);
            foreach (Generated.Certificate item in items)
            {
                builder.Add(item.AsAny);
            }
        ...
        /// <inheritdoc/>
        public CertificateArray AddRange(IEnumerable<Generated.Certificate> items)
        {
            ImmutableList<JsonAny>.Builder builder = __CorvusArrayHelpers.GetImmutableListBuilder(this);
            foreach (Generated.Certificate item in items)
            {
        ...
        /// <inheritdoc/>
        public CertificateArray Insert(int index, in Generated.Certificate item1)
        {
            return new(__CorvusArrayHelpers.GetImmutableListWith(this, index, item1));
        }

        /// <inheritdoc/>
        public CertificateArray InsertRange(int index, IEnumerable<Generated.Certificate> items)
        {
            return new(__CorvusArrayHelpers.GetImmutableListWith(this, index, items.Select(item => item.AsAny)));
        }

        /// <inheritdoc/>
        public CertificateArray Replace(in Generated.Certificate oldValue, in Generated.Certificate newValue)
        {
            return new(__CorvusArrayHelpers.GetImmutableListReplacing(this, oldValue, newValue));
        }

        /// <inheritdoc/>
        public CertificateArray SetItem(int index, in Generated.Certificate value)
        {
            return new(__CorvusArrayHelpers.GetImmutableListSetting(this, index, value));
        }

        /// <inheritdoc/>
        CertificateArray IJsonArray<CertificateArray>.Remove(in JsonAny oldValue)
        {
            return new(__CorvusArrayHelpers.GetImmutableListWithout(this, oldValue));
        }

        /// <inheritdoc/>
        CertificateArray IJsonArray<CertificateArray>.RemoveAt(int index)
        {
            return new(__CorvusArrayHelpers.GetImmutableListWithoutRange(this, index, 1));
        }

        /// <inheritdoc/>
        CertificateArray IJsonArray<CertificateArray>.RemoveRange(int index, int count)
        {
            return new(__CorvusArrayHelpers.GetImmutableListWithoutRange(this, index, count));
        }

        /// <inheritdoc/>
        public CertificateArray Remove(in Generated.Certificate oldValue)
        {
            return new(__CorvusArrayHelpers.GetImmutableListWithout(this, oldValue));
        }
        ...
        private static class __CorvusArrayHelpers
        {
            ...
            /// <exception cref = "InvalidOperationException">The value is not an array.</exception>
            public static ImmutableList<JsonAny> GetImmutableList(in CertificateArray arrayInstance)
            {
            ...
            /// <exception cref = "InvalidOperationException">The value is not an array.</exception>
            public static ImmutableList<JsonAny>.Builder GetImmutableListBuilder(in CertificateArray arrayInstance)
            {
            ...
            public static ImmutableList<JsonAny> GetImmutableListSetting(in CertificateArray arrayInstance, int index, in JsonAny value)
            {
                if ((arrayInstance.backing & Backing.JsonElement) != 0)
                {
                    if (arrayInstance.jsonElementBacking.ValueKind == JsonValueKind.Array)
            ...
            /// <exception cref = "InvalidOperationException">The value is not an array.</exception>
            public static ImmutableList<JsonAny> GetImmutableListReplacing(in CertificateArray arrayInstance, in JsonAny oldItem, in JsonAny newItem)
            {
                if ((arrayInstance.backing & Backing.JsonElement) != 0)
                {
                    if (arrayInstance.jsonElementBacking.ValueKind == JsonValueKind.Array)
            ...
            /// <exception cref = "InvalidOperationException">The value is not an array.</exception>
            public static ImmutableList<JsonAny> GetImmutableListWithout(in CertificateArray arrayInstance, in JsonAny item)
            {
                if ((arrayInstance.backing & Backing.JsonElement) != 0)
                {
                    if (arrayInstance.jsonElementBacking.ValueKind == JsonValueKind.Array)
            ...
            /// <exception cref = "InvalidOperationException">The value is not an array.</exception>
            /// <exception cref = "IndexOutOfRangeException">Thrown if the range is beyond the bounds of the array.</exception>
            public static ImmutableList<JsonAny> GetImmutableListWithoutRange(in CertificateArray arrayInstance, int index, int count)
            {
                if ((arrayInstance.backing & Backing.JsonElement) != 0)
                {
                    if (arrayInstance.jsonElementBacking.ValueKind == JsonValueKind.Array)
            ...
            // <exception cref = "InvalidOperationException">The value is not an array.</exception>
            // <exception cref = "IndexOutOfRangeException">Thrown if the range is beyond the bounds of the array.</exception>
            public static ImmutableList<JsonAny> GetImmutableListWith(in CertificateArray arrayInstance, int index, in JsonAny value)
            {
                if ((arrayInstance.backing & Backing.JsonElement) != 0)
                {
                    if (arrayInstance.jsonElementBacking.ValueKind == JsonValueKind.Array)
            ...
            /// <exception cref = "InvalidOperationException">The value is not an array.</exception>
            /// <exception cref = "IndexOutOfRangeException">Thrown if the range is beyond the bounds of the array.</exception>
            public static ImmutableList<JsonAny> GetImmutableListWith<TEnumerable>(in CertificateArray arrayInstance, int index, TEnumerable values)
