...
public readonly partial struct Ogmios
{
    ...
    public readonly partial struct QueryLedgerStateProjectedRewards
    {
        ...
        public readonly partial struct ParamsEntity
        {
            ...
            /// </summary>
#if NET8_0_OR_GREATER
            [CollectionBuilder(typeof(ValueAdaOnlyArray), "Create")]
#endif
            public readonly partial struct ValueAdaOnlyArray
                : IJsonArray<Generated.Ogmios.QueryLedgerStateProjectedRewards.ParamsEntity.ValueAdaOnlyArray>,
                  IReadOnlyCollection<Generated.ValueAdaOnly>
            {
                /// <summary>
                /// Gets an empty array.
                /// </summary>
                public static ValueAdaOnlyArray EmptyArray { get; } = From(ImmutableList<JsonAny>.Empty);
                ...
                /// <inheritdoc/>
                Corvus.Json.JsonAny IJsonArray<ValueAdaOnlyArray>.this[int index]
                {
                    get
                    {
                ...
                public Generated.ValueAdaOnly this[int index]
                {
                    get
                    {
                        if ((this.backing & Backing.JsonElement) != 0)
                        ...
                        if ((this.backing & Backing.Array) != 0)
                        {
                            try
                            {
                                return this.arrayBacking[index].As<Generated.ValueAdaOnly>();
                            }
                            catch (ArgumentOutOfRangeException ex)
                            {
                                throw new IndexOutOfRangeException(ex.Message, ex);
                ...
                public static implicit operator ValueAdaOnlyArray(ImmutableList<JsonAny> value)
                {
                    return new(value);
                }
                ...
                /// </summary>
                /// <param name="value">The value from which to convert.</param>
                public static implicit operator ImmutableList<JsonAny>(ValueAdaOnlyArray value)
                {
                    return
                ...
                /// </summary>
                /// <param name="value">The value from which to convert.</param>
                public static implicit operator ValueAdaOnlyArray(JsonArray value)
                {
                ...
                /// </summary>
                /// <param name="value">The value from which to convert.</param>
                public static implicit operator JsonArray(ValueAdaOnlyArray value)
                {
                    return
                        value.AsArray;
                }
                ...
                /// <summary>
                /// Initializes a new instance of the <see cref="ValueAdaOnlyArray"/> struct.
                /// </summary>
                ...
                public static ValueAdaOnlyArray From(ImmutableList<JsonAny> items)
                {
                    return new(items);
                }

                /// <summary>
                /// Create an new instance of the <see cref="ValueAdaOnlyArray"/>" struct from a span of items.
                /// </summary>
                ...
                public static ValueAdaOnlyArray Create(ReadOnlySpan<Generated.ValueAdaOnly> items)
                {
                    return new([..items]);
                }
                ...
                public static ValueAdaOnlyArray FromItems(params Generated.ValueAdaOnly[] items)
                {
                    return new([..items]);
                }
                ...
                public static ValueAdaOnlyArray FromItems(in Generated.ValueAdaOnly item1)
                {
                ...
                /// <returns>An instance of the array constructed from the values.</returns>
                public static ValueAdaOnlyArray FromItems(in Generated.ValueAdaOnly item1, in Generated.ValueAdaOnly item2)
                {
                ...
                /// <returns>An instance of the array constructed from the values.</returns>
                public static ValueAdaOnlyArray FromItems(in Generated.ValueAdaOnly item1, in Generated.ValueAdaOnly item2, in Generated.ValueAdaOnly item3)
                {
                ...
                /// <returns>An instance of the array constructed from the values.</returns>
                public static ValueAdaOnlyArray FromItems(in Generated.ValueAdaOnly item1, in Generated.ValueAdaOnly item2, in Generated.ValueAdaOnly item3, in Generated.ValueAdaOnly item4)
                {
                ...
                /// <returns>An instance of the array constructed from the values.</returns>
                public static ValueAdaOnlyArray FromItems(in Generated.ValueAdaOnly item1, in Generated.ValueAdaOnly item2, in Generated.ValueAdaOnly item3, in Generated.ValueAdaOnly item4, in Generated.ValueAdaOnly item5)
                {
                ...
                /// <returns>An instance of the array constructed from the values.</returns>
                public static ValueAdaOnlyArray FromItems(in Generated.ValueAdaOnly item1, in Generated.ValueAdaOnly item2, in Generated.ValueAdaOnly item3, in Generated.ValueAdaOnly item4, in Generated.ValueAdaOnly item5, in Generated.ValueAdaOnly item6)
                {
                ...
                /// <returns>An instance of the array constructed from the values.</returns>
                public static ValueAdaOnlyArray FromItems(in Generated.ValueAdaOnly item1, in Generated.ValueAdaOnly item2, in Generated.ValueAdaOnly item3, in Generated.ValueAdaOnly item4, in Generated.ValueAdaOnly item5, in Generated.ValueAdaOnly item6, in Generated.ValueAdaOnly item7)
                {
                ...
                public static ValueAdaOnlyArray FromRange(IEnumerable<Generated.ValueAdaOnly> items)
                {
                    return new([..items]);
                }
                ...
                /// <param name="items">The items from which to construct the instance.</param>
                /// <returns>An instance of the array constructed from the items .</returns>
                static ValueAdaOnlyArray IJsonArray<ValueAdaOnlyArray>.FromRange(IEnumerable<JsonAny> items)
                {
                    return new([..items]);
                }
                ...
                /// <param name="items">The items from which to construct the instance.</param>
                /// <returns>An instance of the array constructed from the items.</returns>
                static ValueAdaOnlyArray IJsonArray<ValueAdaOnlyArray>.FromRange<T>(IEnumerable<T> items)
                {
                ...
                /// <inheritdoc/>
                IEnumerator<Generated.ValueAdaOnly> IEnumerable<Generated.ValueAdaOnly>.GetEnumerator() => this.EnumerateArray();

                /// <inheritdoc/>
                IEnumerator IEnumerable.GetEnumerator() => this.EnumerateArray();

                /// <inheritdoc/>
                int IReadOnlyCollection<Generated.ValueAdaOnly>.Count => this.GetArrayLength();
                ...
                /// <inheritdoc/>
                public JsonArrayEnumerator<Generated.ValueAdaOnly> EnumerateArray()
                {
                    if ((this.backing & Backing.JsonElement) != 0)
                    {
                ...
                /// <inheritdoc/>
                JsonArrayEnumerator IJsonArray<ValueAdaOnlyArray>.EnumerateArray()
                {
                    if ((this.backing & Backing.JsonElement) != 0)
                    {
                        return new(this.jsonElementBacking);
                ...
                /// <inheritdoc/>
                JsonArrayEnumerator<TItem> IJsonArray<ValueAdaOnlyArray>.EnumerateArray<TItem>()
                {
                    if ((this.backing & Backing.JsonElement) != 0)
                    {
                        return new(this.jsonElementBacking);
                ...
                /// <inheritdoc/>
                ValueAdaOnlyArray IJsonArray<ValueAdaOnlyArray>.Add(in JsonAny item1)
                {
                ...
                /// <inheritdoc/>
                ValueAdaOnlyArray IJsonArray<ValueAdaOnlyArray>.Add(params JsonAny[] items)
                {
                    ImmutableList<JsonAny>.Builder builder = __CorvusArrayHelpers.GetImmutableListBuilder(this);
                ...
                /// <inheritdoc/>
                ValueAdaOnlyArray IJsonArray<ValueAdaOnlyArray>.AddRange<TArray>(in TArray items)
                {
                    ImmutableList<JsonAny>.Builder builder = __CorvusArrayHelpers.GetImmutableListBuilder(this);
                ...
                /// <inheritdoc/>
                ValueAdaOnlyArray IJsonArray<ValueAdaOnlyArray>.AddRange<TItem>(IEnumerable<TItem> items)
                {
                    ImmutableList<JsonAny>.Builder builder = __CorvusArrayHelpers.GetImmutableListBuilder(this);
                ...
                /// <inheritdoc/>
                ValueAdaOnlyArray IJsonArray<ValueAdaOnlyArray>.AddRange(IEnumerable<JsonAny> items)
                {
                    ImmutableList<JsonAny>.Builder builder = __CorvusArrayHelpers.GetImmutableListBuilder(this);
                ...
                /// <inheritdoc/>
                ValueAdaOnlyArray IJsonArray<ValueAdaOnlyArray>.Insert(int index, in JsonAny item1)
                {
                    return new(__CorvusArrayHelpers.GetImmutableListWith(this, index, item1));
                }

                /// <inheritdoc/>
                ValueAdaOnlyArray IJsonArray<ValueAdaOnlyArray>.InsertRange<TArray>(int index, in TArray items)
                {
                    return new(__CorvusArrayHelpers.GetImmutableListWith(this, index, items.EnumerateArray()));
                }

                /// <inheritdoc/>
                ValueAdaOnlyArray IJsonArray<ValueAdaOnlyArray>.InsertRange<TItem>(int index, IEnumerable<TItem> items)
                {
                    return new(__CorvusArrayHelpers.GetImmutableListWith(this, index, items.Select(item => item.AsAny)));
                }

                /// <inheritdoc/>
                ValueAdaOnlyArray IJsonArray<ValueAdaOnlyArray>.InsertRange(int index, IEnumerable<JsonAny> items)
                {
                    return new(__CorvusArrayHelpers.GetImmutableListWith(this, index, items));
                }

                /// <inheritdoc/>
                ValueAdaOnlyArray IJsonArray<ValueAdaOnlyArray>.Replace(in JsonAny oldValue, in JsonAny newValue)
                {
                    return new(__CorvusArrayHelpers.GetImmutableListReplacing(this, oldValue, newValue));
                }

                /// <inheritdoc/>
                ValueAdaOnlyArray IJsonArray<ValueAdaOnlyArray>.SetItem(int index, in JsonAny value)
                {
                    return new(__CorvusArrayHelpers.GetImmutableListSetting(this, index, value));
                }

                /// <inheritdoc/>
                public ValueAdaOnlyArray Add(in Generated.ValueAdaOnly item1)
                {
                    ImmutableList<JsonAny>.Builder builder = __CorvusArrayHelpers.GetImmutableListBuilder(this);
                ...
                /// <inheritdoc/>
                public ValueAdaOnlyArray Add(params Generated.ValueAdaOnly[] items)
                {
                    ImmutableList<JsonAny>.Builder builder = __CorvusArrayHelpers.GetImmutableListBuilder(this);
                    foreach (Generated.ValueAdaOnly item in items)
                    {
                        builder.Add(item.AsAny);
                    }
                ...
                /// <inheritdoc/>
                public ValueAdaOnlyArray AddRange(IEnumerable<Generated.ValueAdaOnly> items)
                {
                    ImmutableList<JsonAny>.Builder builder = __CorvusArrayHelpers.GetImmutableListBuilder(this);
                    foreach (Generated.ValueAdaOnly item in items)
                    {
                ...
                /// <inheritdoc/>
                public ValueAdaOnlyArray Insert(int index, in Generated.ValueAdaOnly item1)
                {
                    return new(__CorvusArrayHelpers.GetImmutableListWith(this, index, item1));
                }

                /// <inheritdoc/>
                public ValueAdaOnlyArray InsertRange(int index, IEnumerable<Generated.ValueAdaOnly> items)
                {
                    return new(__CorvusArrayHelpers.GetImmutableListWith(this, index, items.Select(item => item.AsAny)));
                }

                /// <inheritdoc/>
                public ValueAdaOnlyArray Replace(in Generated.ValueAdaOnly oldValue, in Generated.ValueAdaOnly newValue)
                {
                    return new(__CorvusArrayHelpers.GetImmutableListReplacing(this, oldValue, newValue));
                }

                /// <inheritdoc/>
                public ValueAdaOnlyArray SetItem(int index, in Generated.ValueAdaOnly value)
                {
                    return new(__CorvusArrayHelpers.GetImmutableListSetting(this, index, value));
                }

                /// <inheritdoc/>
                ValueAdaOnlyArray IJsonArray<ValueAdaOnlyArray>.Remove(in JsonAny oldValue)
                {
                    return new(__CorvusArrayHelpers.GetImmutableListWithout(this, oldValue));
                }

                /// <inheritdoc/>
                ValueAdaOnlyArray IJsonArray<ValueAdaOnlyArray>.RemoveAt(int index)
                {
                    return new(__CorvusArrayHelpers.GetImmutableListWithoutRange(this, index, 1));
                }

                /// <inheritdoc/>
                ValueAdaOnlyArray IJsonArray<ValueAdaOnlyArray>.RemoveRange(int index, int count)
                {
                    return new(__CorvusArrayHelpers.GetImmutableListWithoutRange(this, index, count));
                }

                /// <inheritdoc/>
                public ValueAdaOnlyArray Remove(in Generated.ValueAdaOnly oldValue)
                {
                    return new(__CorvusArrayHelpers.GetImmutableListWithout(this, oldValue));
                }
                ...
                private static class __CorvusArrayHelpers
                {
                    ...
                    /// <exception cref = "InvalidOperationException">The value is not an array.</exception>
                    public static ImmutableList<JsonAny> GetImmutableList(in ValueAdaOnlyArray arrayInstance)
                    {
                    ...
                    /// <exception cref = "InvalidOperationException">The value is not an array.</exception>
                    public static ImmutableList<JsonAny>.Builder GetImmutableListBuilder(in ValueAdaOnlyArray arrayInstance)
                    {
                    ...
                    public static ImmutableList<JsonAny> GetImmutableListSetting(in ValueAdaOnlyArray arrayInstance, int index, in JsonAny value)
                    {
                        if ((arrayInstance.backing & Backing.JsonElement) != 0)
                        {
                            if (arrayInstance.jsonElementBacking.ValueKind == JsonValueKind.Array)
                    ...
                    /// <exception cref = "InvalidOperationException">The value is not an array.</exception>
                    public static ImmutableList<JsonAny> GetImmutableListReplacing(in ValueAdaOnlyArray arrayInstance, in JsonAny oldItem, in JsonAny newItem)
                    {
                        if ((arrayInstance.backing & Backing.JsonElement) != 0)
                        {
                            if (arrayInstance.jsonElementBacking.ValueKind == JsonValueKind.Array)
                    ...
                    /// <exception cref = "InvalidOperationException">The value is not an array.</exception>
                    public static ImmutableList<JsonAny> GetImmutableListWithout(in ValueAdaOnlyArray arrayInstance, in JsonAny item)
                    {
                        if ((arrayInstance.backing & Backing.JsonElement) != 0)
                        {
                            if (arrayInstance.jsonElementBacking.ValueKind == JsonValueKind.Array)
                    ...
                    /// <exception cref = "InvalidOperationException">The value is not an array.</exception>
                    /// <exception cref = "IndexOutOfRangeException">Thrown if the range is beyond the bounds of the array.</exception>
                    public static ImmutableList<JsonAny> GetImmutableListWithoutRange(in ValueAdaOnlyArray arrayInstance, int index, int count)
                    {
                        if ((arrayInstance.backing & Backing.JsonElement) != 0)
                        {
                            if (arrayInstance.jsonElementBacking.ValueKind == JsonValueKind.Array)
                    ...
                    // <exception cref = "InvalidOperationException">The value is not an array.</exception>
                    // <exception cref = "IndexOutOfRangeException">Thrown if the range is beyond the bounds of the array.</exception>
                    public static ImmutableList<JsonAny> GetImmutableListWith(in ValueAdaOnlyArray arrayInstance, int index, in JsonAny value)
                    {
                        if ((arrayInstance.backing & Backing.JsonElement) != 0)
                        {
                            if (arrayInstance.jsonElementBacking.ValueKind == JsonValueKind.Array)
                    ...
                    /// <exception cref = "InvalidOperationException">The value is not an array.</exception>
                    /// <exception cref = "IndexOutOfRangeException">Thrown if the range is beyond the bounds of the array.</exception>
                    public static ImmutableList<JsonAny> GetImmutableListWith<TEnumerable>(in ValueAdaOnlyArray arrayInstance, int index, TEnumerable values)
