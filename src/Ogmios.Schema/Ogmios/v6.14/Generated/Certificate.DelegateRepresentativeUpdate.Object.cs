...
public readonly partial struct Certificate
{
    ...
    /// <remarks>
    /// </remarks>
    public readonly partial struct DelegateRepresentativeUpdate
        : IJsonObject<Generated.Certificate.DelegateRepresentativeUpdate>
    {
        /// <summary>
        /// Conversion from <see cref="ImmutableList{JsonObjectProperty}"/>.
        /// </summary>
        /// <param name="value">The value from which to convert.</param>
        public static implicit operator DelegateRepresentativeUpdate(ImmutableList<JsonObjectProperty> value)
        {
            return new(value);
        }
        ...
        /// </summary>
        /// <param name="value">The value from which to convert.</param>
        public static implicit operator ImmutableList<JsonObjectProperty>(DelegateRepresentativeUpdate value)
        {
            return
        ...
        /// </summary>
        /// <param name="value">The value from which to convert.</param>
        public static implicit operator DelegateRepresentativeUpdate(JsonObject value)
        {
        ...
        /// </summary>
        /// <param name="value">The value from which to convert.</param>
        public static implicit operator JsonObject(DelegateRepresentativeUpdate value)
        {
            return
                value.AsObject;
        }
        ...
        /// </para>
        /// </remarks>
        public Generated.Certificate.DelegateRepresentativeUpdate.MetadataEntity Metadata
        {
            get
            {
                if ((this.backing & Backing.JsonElement) != 0)
                ...
                if ((this.backing & Backing.Object) != 0)
                {
                    ...
                    {
                        return result.As<Generated.Certificate.DelegateRepresentativeUpdate.MetadataEntity>();
                    }
                }
        ...
        /// </para>
        /// </remarks>
        public Generated.Certificate.DelegateRepresentativeUpdate.TypeEntity Type
        {
            get
            {
                if ((this.backing & Backing.JsonElement) != 0)
                ...
                if ((this.backing & Backing.Object) != 0)
                {
                    ...
                    {
                        return result.As<Generated.Certificate.DelegateRepresentativeUpdate.TypeEntity>();
                    }
                }
        ...
        /// <inheritdoc/>
        public static DelegateRepresentativeUpdate FromProperties(IDictionary<JsonPropertyName, JsonAny> source)
        {
            return new(source.Select(kvp => new JsonObjectProperty(kvp.Key, kvp.Value)).ToImmutableList());
        }

        /// <inheritdoc/>
        public static DelegateRepresentativeUpdate FromProperties(params (JsonPropertyName Name, JsonAny Value)[] source)
        {
        ...
        public static DelegateRepresentativeUpdate FromProperties(ImmutableList<JsonObjectProperty> source)
        {
            return new(source);
        }

        /// <summary>
        /// Creates an instance of a <see cref="DelegateRepresentativeUpdate"/>.
        /// </summary>
        public static DelegateRepresentativeUpdate Create(
            in Generated.DelegateRepresentative delegateRepresentative,
            in Generated.Certificate.DelegateRepresentativeUpdate.MetadataEntity metadata,
            in Generated.Certificate.DelegateRepresentativeUpdate.TypeEntity type)
        {
        ...
        public DelegateRepresentativeUpdate WithDelegateRepresentative(in Generated.DelegateRepresentative value)
        {
        ...
        /// <param name="value">The new property value</param>
        /// <returns>The instance with the property set.</returns>
        public DelegateRepresentativeUpdate WithMetadata(in Generated.Certificate.DelegateRepresentativeUpdate.MetadataEntity value)
        {
        ...
        /// <param name="value">The new property value</param>
        /// <returns>The instance with the property set.</returns>
        public DelegateRepresentativeUpdate WithType(in Generated.Certificate.DelegateRepresentativeUpdate.TypeEntity value)
        {
        ...
        /// <inheritdoc />
        public DelegateRepresentativeUpdate SetProperty<TValue>(in JsonPropertyName name, TValue value)
        ...
        /// <inheritdoc />
        public DelegateRepresentativeUpdate RemoveProperty(in JsonPropertyName name)
        {
            return new(__CorvusObjectHelpers.GetPropertyBackingWithout(this, name));
        }

        /// <inheritdoc />
        public DelegateRepresentativeUpdate RemoveProperty(string name)
        {
            return new(__CorvusObjectHelpers.GetPropertyBackingWithout(this, name));
        }

        /// <inheritdoc />
        public DelegateRepresentativeUpdate RemoveProperty(ReadOnlySpan<char> name)
        {
            return new(__CorvusObjectHelpers.GetPropertyBackingWithout(this, name));
        }

        /// <inheritdoc />
        public DelegateRepresentativeUpdate RemoveProperty(ReadOnlySpan<byte> name)
        {
            return new(__CorvusObjectHelpers.GetPropertyBackingWithout(this, name));
        }
        ...
        private static class __CorvusObjectHelpers
        {
            ...
            /// <exception cref="InvalidOperationException">The value is not an object.</exception>
            public static ImmutableList<JsonObjectProperty> GetPropertyBacking(in DelegateRepresentativeUpdate that)
            {
            ...
            /// <exception cref="InvalidOperationException">The value is not an object.</exception>
            public static ImmutableList<JsonObjectProperty> GetPropertyBackingWithout(in DelegateRepresentativeUpdate that, in JsonPropertyName name)
            {
                if ((that.backing & Backing.Object) != 0)
                {
            ...
            /// <returns>An immutable list of <see cref="JsonObjectProperty"/>, built from the existing object, without the given property.</returns>
            /// <exception cref="InvalidOperationException">The value is not an object.</exception>
            public static ImmutableList<JsonObjectProperty> GetPropertyBackingWithout(in DelegateRepresentativeUpdate that, ReadOnlySpan<char> name)
            {
                if ((that.backing & Backing.Object) != 0)
                {
                    return that.objectBacking.Remove(name);
            ...
            /// <returns>An immutable list of <see cref="JsonObjectProperty"/>, built from the existing object, without the given property.</returns>
            /// <exception cref="InvalidOperationException">The value is not an object.</exception>
            public static ImmutableList<JsonObjectProperty> GetPropertyBackingWithout(in DelegateRepresentativeUpdate that, ReadOnlySpan<byte> name)
            {
                if ((that.backing & Backing.Object) != 0)
                {
                    return that.objectBacking.Remove(name);
            ...
            /// <returns>An immutable list of <see cref="JsonObjectProperty"/>, built from the existing object, without the given property.</returns>
            /// <exception cref="InvalidOperationException">The value is not an object.</exception>
            public static ImmutableList<JsonObjectProperty> GetPropertyBackingWithout(in DelegateRepresentativeUpdate that, string name)
            {
                if ((that.backing & Backing.Object) != 0)
                {
                    return that.objectBacking.Remove(name);
            ...
            /// <exception cref="InvalidOperationException">The value is not an object.</exception>
            public static ImmutableList<JsonObjectProperty> GetPropertyBackingWith(in DelegateRepresentativeUpdate that, in JsonPropertyName name, in JsonAny value)
            {
                if ((that.backing & Backing.Object) != 0)
                {
