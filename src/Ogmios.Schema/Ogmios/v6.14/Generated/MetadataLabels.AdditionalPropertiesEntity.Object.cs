...
public readonly partial struct MetadataLabels
{
    ...
    public readonly partial struct AdditionalPropertiesEntity
        : IJsonObject<Generated.MetadataLabels.AdditionalPropertiesEntity>
    {
        /// <summary>
        ...
        /// </summary>
        public Generated.MetadataLabels.AdditionalPropertiesEntity.CborEntity Cbor
        {
            get
            {
                if ((this.backing & Backing.JsonElement) != 0)
                ...
                if ((this.backing & Backing.Object) != 0)
                {
                    ...
                    {
                        return result.As<Generated.MetadataLabels.AdditionalPropertiesEntity.CborEntity>();
                    }
                }
        ...
        /// </summary>
        public Generated.Metadatum Json
        {
            get
            {
                if ((this.backing & Backing.JsonElement) != 0)
                ...
                if ((this.backing & Backing.Object) != 0)
                {
                    ...
                    {
                        return result.As<Generated.Metadatum>();
                    }
                }
        ...
        /// </summary>
        public static AdditionalPropertiesEntity Create(in Generated.MetadataLabels.AdditionalPropertiesEntity.CborEntity? cbor = null, in Generated.Metadatum? json = null)
        {
            ...
            if (json is not null)
            {
                builder.Add(JsonPropertyNames.Json, json.Value.AsAny);
            }
        ...
        public AdditionalPropertiesEntity WithCbor(in Generated.MetadataLabels.AdditionalPropertiesEntity.CborEntity value)
        {
            return this.SetProperty(JsonPropertyNames.Cbor, value);
        }

        /// <summary>
        /// Sets the (optional) <c>json</c> property.
        /// </summary>
        /// <param name="value">The new property value</param>
        /// <returns>The instance with the property set.</returns>
        public AdditionalPropertiesEntity WithJson(in Generated.Metadatum value)
        {
