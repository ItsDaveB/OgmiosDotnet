...
public readonly partial struct Ogmios
{
    ...
    public readonly partial struct EvaluateTransactionFailure
    {
        ...
        public readonly partial struct EvaluateTransactionFailureUnsupportedEra
            : IJsonObject<Generated.Ogmios.EvaluateTransactionFailure.EvaluateTransactionFailureUnsupportedEra>
        {
            /// <summary>
            /// Conversion from <see cref="ImmutableList{JsonObjectProperty}"/>.
            /// </summary>
            /// <param name="value">The value from which to convert.</param>
            public static implicit operator EvaluateTransactionFailureUnsupportedEra(ImmutableList<JsonObjectProperty> value)
            {
                return new(value);
            }
            ...
            /// </summary>
            /// <param name="value">The value from which to convert.</param>
            public static implicit operator ImmutableList<JsonObjectProperty>(EvaluateTransactionFailureUnsupportedEra value)
            {
                return
            ...
            /// </summary>
            /// <param name="value">The value from which to convert.</param>
            public static implicit operator EvaluateTransactionFailureUnsupportedEra(JsonObject value)
            {
            ...
            /// </summary>
            /// <param name="value">The value from which to convert.</param>
            public static implicit operator JsonObject(EvaluateTransactionFailureUnsupportedEra value)
            {
                return
                    value.AsObject;
            }
            ...
            /// </para>
            /// </remarks>
            public Generated.Ogmios.EvaluateTransactionFailure.EvaluateTransactionFailureUnsupportedEra.CodeEntity Code
            {
                get
                {
                    if ((this.backing & Backing.JsonElement) != 0)
                    ...
                    if ((this.backing & Backing.Object) != 0)
                    {
                        ...
                        {
                            return result.As<Generated.Ogmios.EvaluateTransactionFailure.EvaluateTransactionFailureUnsupportedEra.CodeEntity>();
                        }
                    }
            ...
            /// </para>
            /// </remarks>
            public Generated.Ogmios.EvaluateTransactionFailure.EvaluateTransactionFailureUnsupportedEra.TheEraInWhichTheTransactionHasBeenIdentified Data
            {
                get
                {
                    if ((this.backing & Backing.JsonElement) != 0)
                    ...
                    if ((this.backing & Backing.Object) != 0)
                    {
                        ...
                        {
                            return result.As<Generated.Ogmios.EvaluateTransactionFailure.EvaluateTransactionFailureUnsupportedEra.TheEraInWhichTheTransactionHasBeenIdentified>();
                        }
                    }
            ...
            /// <inheritdoc/>
            public static EvaluateTransactionFailureUnsupportedEra FromProperties(IDictionary<JsonPropertyName, JsonAny> source)
            {
                return new(source.Select(kvp => new JsonObjectProperty(kvp.Key, kvp.Value)).ToImmutableList());
            }

            /// <inheritdoc/>
            public static EvaluateTransactionFailureUnsupportedEra FromProperties(params (JsonPropertyName Name, JsonAny Value)[] source)
            {
            ...
            public static EvaluateTransactionFailureUnsupportedEra FromProperties(ImmutableList<JsonObjectProperty> source)
            {
                return new(source);
            }

            /// <summary>
            /// Creates an instance of a <see cref="EvaluateTransactionFailureUnsupportedEra"/>.
            /// </summary>
            public static EvaluateTransactionFailureUnsupportedEra Create(
                in Generated.Ogmios.EvaluateTransactionFailure.EvaluateTransactionFailureUnsupportedEra.CodeEntity code,
                in Generated.Ogmios.EvaluateTransactionFailure.EvaluateTransactionFailureUnsupportedEra.TheEraInWhichTheTransactionHasBeenIdentified data,
            ...
            public EvaluateTransactionFailureUnsupportedEra WithCode(in Generated.Ogmios.EvaluateTransactionFailure.EvaluateTransactionFailureUnsupportedEra.CodeEntity value)
            {
            ...
            /// </para>
            /// </remarks>
            public EvaluateTransactionFailureUnsupportedEra WithData(in Generated.Ogmios.EvaluateTransactionFailure.EvaluateTransactionFailureUnsupportedEra.TheEraInWhichTheTransactionHasBeenIdentified value)
            {
            ...
            /// <param name="value">The new property value</param>
            /// <returns>The instance with the property set.</returns>
            public EvaluateTransactionFailureUnsupportedEra WithMessage(in Corvus.Json.JsonString value)
            {
            ...
            /// <inheritdoc />
            public EvaluateTransactionFailureUnsupportedEra SetProperty<TValue>(in JsonPropertyName name, TValue value)
            ...
            /// <inheritdoc />
            public EvaluateTransactionFailureUnsupportedEra RemoveProperty(in JsonPropertyName name)
            {
                return new(__CorvusObjectHelpers.GetPropertyBackingWithout(this, name));
            }

            /// <inheritdoc />
            public EvaluateTransactionFailureUnsupportedEra RemoveProperty(string name)
            {
                return new(__CorvusObjectHelpers.GetPropertyBackingWithout(this, name));
            }

            /// <inheritdoc />
            public EvaluateTransactionFailureUnsupportedEra RemoveProperty(ReadOnlySpan<char> name)
            {
                return new(__CorvusObjectHelpers.GetPropertyBackingWithout(this, name));
            }

            /// <inheritdoc />
            public EvaluateTransactionFailureUnsupportedEra RemoveProperty(ReadOnlySpan<byte> name)
            {
                return new(__CorvusObjectHelpers.GetPropertyBackingWithout(this, name));
            }
            ...
            private static class __CorvusObjectHelpers
            {
                ...
                /// <exception cref="InvalidOperationException">The value is not an object.</exception>
                public static ImmutableList<JsonObjectProperty> GetPropertyBacking(in EvaluateTransactionFailureUnsupportedEra that)
                {
                ...
                /// <exception cref="InvalidOperationException">The value is not an object.</exception>
                public static ImmutableList<JsonObjectProperty> GetPropertyBackingWithout(in EvaluateTransactionFailureUnsupportedEra that, in JsonPropertyName name)
                {
                    if ((that.backing & Backing.Object) != 0)
                    {
                ...
                /// <returns>An immutable list of <see cref="JsonObjectProperty"/>, built from the existing object, without the given property.</returns>
                /// <exception cref="InvalidOperationException">The value is not an object.</exception>
                public static ImmutableList<JsonObjectProperty> GetPropertyBackingWithout(in EvaluateTransactionFailureUnsupportedEra that, ReadOnlySpan<char> name)
                {
                    if ((that.backing & Backing.Object) != 0)
                    {
                        return that.objectBacking.Remove(name);
                ...
                /// <returns>An immutable list of <see cref="JsonObjectProperty"/>, built from the existing object, without the given property.</returns>
                /// <exception cref="InvalidOperationException">The value is not an object.</exception>
                public static ImmutableList<JsonObjectProperty> GetPropertyBackingWithout(in EvaluateTransactionFailureUnsupportedEra that, ReadOnlySpan<byte> name)
                {
                    if ((that.backing & Backing.Object) != 0)
                    {
                        return that.objectBacking.Remove(name);
                ...
                /// <returns>An immutable list of <see cref="JsonObjectProperty"/>, built from the existing object, without the given property.</returns>
                /// <exception cref="InvalidOperationException">The value is not an object.</exception>
                public static ImmutableList<JsonObjectProperty> GetPropertyBackingWithout(in EvaluateTransactionFailureUnsupportedEra that, string name)
                {
                    if ((that.backing & Backing.Object) != 0)
                    {
                        return that.objectBacking.Remove(name);
                ...
                /// <exception cref="InvalidOperationException">The value is not an object.</exception>
                public static ImmutableList<JsonObjectProperty> GetPropertyBackingWith(in EvaluateTransactionFailureUnsupportedEra that, in JsonPropertyName name, in JsonAny value)
                {
                    if ((that.backing & Backing.Object) != 0)
                    {
