...
public readonly partial struct Ogmios
{
    ...
    public readonly partial struct SubmitTransactionFailure
    {
            ...
            : IJsonObject<Generated.Ogmios.SubmitTransactionFailure.SubmitTransactionFailureInvalidOrMissingPreviousProposals>
        {
            ...
            public SubmitTransactionFailureInvalidOrMissingPreviousProposals WithCode(in Generated.Ogmios.SubmitTransactionFailure.SubmitTransactionFailureInvalidOrMissingPreviousProposals.CodeEntity value)
            {
            ...
            /// <param name="value">The new property value</param>
            /// <returns>The instance with the property set.</returns>
            public SubmitTransactionFailureInvalidOrMissingPreviousProposals WithData(in Generated.Ogmios.SubmitTransactionFailure.SubmitTransactionFailureInvalidOrMissingPreviousProposals.RequiredInvalidOrMissingPreviousProposals value)
            {
            ...
            /// <param name="value">The new property value</param>
            /// <returns>The instance with the property set.</returns>
            public SubmitTransactionFailureInvalidOrMissingPreviousProposals WithMessage(in Corvus.Json.JsonString value)
            {
