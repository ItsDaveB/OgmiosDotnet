...
public readonly partial struct BootstrapOperationalCertificate
    : IJsonObject<Generated.BootstrapOperationalCertificate>
{
    /// <summary>
    /// Conversion from <see cref="ImmutableList{JsonObjectProperty}"/>.
    /// </summary>
    /// <param name="value">The value from which to convert.</param>
    public static implicit operator BootstrapOperationalCertificate(ImmutableList<JsonObjectProperty> value)
    {
        return new(value);
    }
    ...
    /// </summary>
    /// <param name="value">The value from which to convert.</param>
    public static implicit operator ImmutableList<JsonObjectProperty>(BootstrapOperationalCertificate value)
    {
        return
    ...
    /// </summary>
    /// <param name="value">The value from which to convert.</param>
    public static implicit operator BootstrapOperationalCertificate(JsonObject value)
    {
    ...
    /// </summary>
    /// <param name="value">The value from which to convert.</param>
    public static implicit operator JsonObject(BootstrapOperationalCertificate value)
    {
        return
            value.AsObject;
    }
    ...
    /// </para>
    /// </remarks>
    public Generated.BootstrapOperationalCertificate.RequiredVerificationKey Delegate
    {
        get
        {
            if ((this.backing & Backing.JsonElement) != 0)
            ...
            if ((this.backing & Backing.Object) != 0)
            {
                ...
                {
                    return result.As<Generated.BootstrapOperationalCertificate.RequiredVerificationKey>();
                }
            }
    ...
    /// </para>
    /// </remarks>
    public Generated.BootstrapOperationalCertificate.BootstrapOperationalCertificateRequiredVerificationKey Issuer
    {
        get
        {
            if ((this.backing & Backing.JsonElement) != 0)
            ...
            if ((this.backing & Backing.Object) != 0)
            {
                ...
                {
                    return result.As<Generated.BootstrapOperationalCertificate.BootstrapOperationalCertificateRequiredVerificationKey>();
                }
            }
    ...
    /// <inheritdoc/>
    public static BootstrapOperationalCertificate FromProperties(IDictionary<JsonPropertyName, JsonAny> source)
    {
        return new(source.Select(kvp => new JsonObjectProperty(kvp.Key, kvp.Value)).ToImmutableList());
    }

    /// <inheritdoc/>
    public static BootstrapOperationalCertificate FromProperties(params (JsonPropertyName Name, JsonAny Value)[] source)
    {
    ...
    public static BootstrapOperationalCertificate FromProperties(ImmutableList<JsonObjectProperty> source)
    {
        return new(source);
    }

    /// <summary>
    /// Creates an instance of a <see cref="BootstrapOperationalCertificate"/>.
    /// </summary>
    public static BootstrapOperationalCertificate Create(in Generated.BootstrapOperationalCertificate.RequiredVerificationKey delegateValue, in Generated.BootstrapOperationalCertificate.BootstrapOperationalCertificateRequiredVerificationKey issuer)
    {
    ...
    public BootstrapOperationalCertificate WithDelegate(in Generated.BootstrapOperationalCertificate.RequiredVerificationKey value)
    {
    ...
    /// <param name="value">The new property value</param>
    /// <returns>The instance with the property set.</returns>
    public BootstrapOperationalCertificate WithIssuer(in Generated.BootstrapOperationalCertificate.BootstrapOperationalCertificateRequiredVerificationKey value)
    {
    ...
    /// <inheritdoc />
    public BootstrapOperationalCertificate SetProperty<TValue>(in JsonPropertyName name, TValue value)
    ...
    /// <inheritdoc />
    public BootstrapOperationalCertificate RemoveProperty(in JsonPropertyName name)
    {
        return new(__CorvusObjectHelpers.GetPropertyBackingWithout(this, name));
    }

    /// <inheritdoc />
    public BootstrapOperationalCertificate RemoveProperty(string name)
    {
        return new(__CorvusObjectHelpers.GetPropertyBackingWithout(this, name));
    }

    /// <inheritdoc />
    public BootstrapOperationalCertificate RemoveProperty(ReadOnlySpan<char> name)
    {
        return new(__CorvusObjectHelpers.GetPropertyBackingWithout(this, name));
    }

    /// <inheritdoc />
    public BootstrapOperationalCertificate RemoveProperty(ReadOnlySpan<byte> name)
    {
        return new(__CorvusObjectHelpers.GetPropertyBackingWithout(this, name));
    }
    ...
    private static class __CorvusObjectHelpers
    {
        ...
        /// <exception cref="InvalidOperationException">The value is not an object.</exception>
        public static ImmutableList<JsonObjectProperty> GetPropertyBacking(in BootstrapOperationalCertificate that)
        {
        ...
        /// <exception cref="InvalidOperationException">The value is not an object.</exception>
        public static ImmutableList<JsonObjectProperty> GetPropertyBackingWithout(in BootstrapOperationalCertificate that, in JsonPropertyName name)
        {
            if ((that.backing & Backing.Object) != 0)
            {
        ...
        /// <returns>An immutable list of <see cref="JsonObjectProperty"/>, built from the existing object, without the given property.</returns>
        /// <exception cref="InvalidOperationException">The value is not an object.</exception>
        public static ImmutableList<JsonObjectProperty> GetPropertyBackingWithout(in BootstrapOperationalCertificate that, ReadOnlySpan<char> name)
        {
            if ((that.backing & Backing.Object) != 0)
            {
                return that.objectBacking.Remove(name);
        ...
        /// <returns>An immutable list of <see cref="JsonObjectProperty"/>, built from the existing object, without the given property.</returns>
        /// <exception cref="InvalidOperationException">The value is not an object.</exception>
        public static ImmutableList<JsonObjectProperty> GetPropertyBackingWithout(in BootstrapOperationalCertificate that, ReadOnlySpan<byte> name)
        {
            if ((that.backing & Backing.Object) != 0)
            {
                return that.objectBacking.Remove(name);
        ...
        /// <returns>An immutable list of <see cref="JsonObjectProperty"/>, built from the existing object, without the given property.</returns>
        /// <exception cref="InvalidOperationException">The value is not an object.</exception>
        public static ImmutableList<JsonObjectProperty> GetPropertyBackingWithout(in BootstrapOperationalCertificate that, string name)
        {
            if ((that.backing & Backing.Object) != 0)
            {
                return that.objectBacking.Remove(name);
        ...
        /// <exception cref="InvalidOperationException">The value is not an object.</exception>
        public static ImmutableList<JsonObjectProperty> GetPropertyBackingWith(in BootstrapOperationalCertificate that, in JsonPropertyName name, in JsonAny value)
        {
            if ((that.backing & Backing.Object) != 0)
            {
