...
public readonly partial struct GovernanceVoter
{
    ...
    public readonly partial struct VoterConstitutionalCommittee
        : IJsonObject<Generated.GovernanceVoter.VoterConstitutionalCommittee>
    {
        /// <summary>
        /// Conversion from <see cref="ImmutableList{JsonObjectProperty}"/>.
        /// </summary>
        /// <param name="value">The value from which to convert.</param>
        public static implicit operator VoterConstitutionalCommittee(ImmutableList<JsonObjectProperty> value)
        {
            return new(value);
        }
        ...
        /// </summary>
        /// <param name="value">The value from which to convert.</param>
        public static implicit operator ImmutableList<JsonObjectProperty>(VoterConstitutionalCommittee value)
        {
            return
        ...
        /// </summary>
        /// <param name="value">The value from which to convert.</param>
        public static implicit operator VoterConstitutionalCommittee(JsonObject value)
        {
        ...
        /// </summary>
        /// <param name="value">The value from which to convert.</param>
        public static implicit operator JsonObject(VoterConstitutionalCommittee value)
        {
            return
                value.AsObject;
        }
        ...
        /// </para>
        /// </remarks>
        public Generated.GovernanceVoter.VoterConstitutionalCommittee.RoleEntity Role
        {
            get
            {
                if ((this.backing & Backing.JsonElement) != 0)
                {
                    ...
                    if (this.jsonElementBacking.TryGetProperty(JsonPropertyNames.RoleUtf8, out JsonElement result))
                    {
                        return new(result);
                    }
                }
                ...
                if ((this.backing & Backing.Object) != 0)
                {
                    if (this.objectBacking.TryGetValue(JsonPropertyNames.Role, out JsonAny result))
                    {
                        return result.As<Generated.GovernanceVoter.VoterConstitutionalCommittee.RoleEntity>();
                    }
                }
        ...
        /// <inheritdoc/>
        public static VoterConstitutionalCommittee FromProperties(IDictionary<JsonPropertyName, JsonAny> source)
        {
            return new(source.Select(kvp => new JsonObjectProperty(kvp.Key, kvp.Value)).ToImmutableList());
        }

        /// <inheritdoc/>
        public static VoterConstitutionalCommittee FromProperties(params (JsonPropertyName Name, JsonAny Value)[] source)
        {
        ...
        public static VoterConstitutionalCommittee FromProperties(ImmutableList<JsonObjectProperty> source)
        {
            return new(source);
        }

        /// <summary>
        /// Creates an instance of a <see cref="VoterConstitutionalCommittee"/>.
        /// </summary>
        public static VoterConstitutionalCommittee Create(
            in Generated.CredentialOrigin from,
            in Generated.DigestBlake2b224 id,
            in Generated.GovernanceVoter.VoterConstitutionalCommittee.RoleEntity role)
        {
            var builder = ImmutableList.CreateBuilder<JsonObjectProperty>();
            builder.Add(JsonPropertyNames.From, from.AsAny);
            builder.Add(JsonPropertyNames.Id, id.AsAny);
            builder.Add(JsonPropertyNames.Role, role.AsAny);
        ...
        public VoterConstitutionalCommittee WithFrom(in Generated.CredentialOrigin value)
        {
        ...
        /// </para>
        /// </remarks>
        public VoterConstitutionalCommittee WithId(in Generated.DigestBlake2b224 value)
        {
            return this.SetProperty(JsonPropertyNames.Id, value);
        }

        /// <summary>
        /// Sets the <c>role</c> property.
        /// </summary>
        /// <param name="value">The new property value</param>
        /// <returns>The instance with the property set.</returns>
        public VoterConstitutionalCommittee WithRole(in Generated.GovernanceVoter.VoterConstitutionalCommittee.RoleEntity value)
        {
            return this.SetProperty(JsonPropertyNames.Role, value);
        }
        ...
        /// <inheritdoc />
        public VoterConstitutionalCommittee SetProperty<TValue>(in JsonPropertyName name, TValue value)
        ...
        /// <inheritdoc />
        public VoterConstitutionalCommittee RemoveProperty(in JsonPropertyName name)
        {
            return new(__CorvusObjectHelpers.GetPropertyBackingWithout(this, name));
        }

        /// <inheritdoc />
        public VoterConstitutionalCommittee RemoveProperty(string name)
        {
            return new(__CorvusObjectHelpers.GetPropertyBackingWithout(this, name));
        }

        /// <inheritdoc />
        public VoterConstitutionalCommittee RemoveProperty(ReadOnlySpan<char> name)
        {
            return new(__CorvusObjectHelpers.GetPropertyBackingWithout(this, name));
        }

        /// <inheritdoc />
        public VoterConstitutionalCommittee RemoveProperty(ReadOnlySpan<byte> name)
        {
            return new(__CorvusObjectHelpers.GetPropertyBackingWithout(this, name));
        }
        ...
        private static class __CorvusObjectHelpers
        {
            ...
            /// <exception cref="InvalidOperationException">The value is not an object.</exception>
            public static ImmutableList<JsonObjectProperty> GetPropertyBacking(in VoterConstitutionalCommittee that)
            {
            ...
            /// <exception cref="InvalidOperationException">The value is not an object.</exception>
            public static ImmutableList<JsonObjectProperty> GetPropertyBackingWithout(in VoterConstitutionalCommittee that, in JsonPropertyName name)
            {
                if ((that.backing & Backing.Object) != 0)
                {
            ...
            /// <returns>An immutable list of <see cref="JsonObjectProperty"/>, built from the existing object, without the given property.</returns>
            /// <exception cref="InvalidOperationException">The value is not an object.</exception>
            public static ImmutableList<JsonObjectProperty> GetPropertyBackingWithout(in VoterConstitutionalCommittee that, ReadOnlySpan<char> name)
            {
                if ((that.backing & Backing.Object) != 0)
                {
                    return that.objectBacking.Remove(name);
            ...
            /// <returns>An immutable list of <see cref="JsonObjectProperty"/>, built from the existing object, without the given property.</returns>
            /// <exception cref="InvalidOperationException">The value is not an object.</exception>
            public static ImmutableList<JsonObjectProperty> GetPropertyBackingWithout(in VoterConstitutionalCommittee that, ReadOnlySpan<byte> name)
            {
                if ((that.backing & Backing.Object) != 0)
                {
                    return that.objectBacking.Remove(name);
            ...
            /// <returns>An immutable list of <see cref="JsonObjectProperty"/>, built from the existing object, without the given property.</returns>
            /// <exception cref="InvalidOperationException">The value is not an object.</exception>
            public static ImmutableList<JsonObjectProperty> GetPropertyBackingWithout(in VoterConstitutionalCommittee that, string name)
            {
                if ((that.backing & Backing.Object) != 0)
                {
                    return that.objectBacking.Remove(name);
            ...
            /// <exception cref="InvalidOperationException">The value is not an object.</exception>
            public static ImmutableList<JsonObjectProperty> GetPropertyBackingWith(in VoterConstitutionalCommittee that, in JsonPropertyName name, in JsonAny value)
            {
                if ((that.backing & Backing.Object) != 0)
                {
