...
public readonly partial struct Ogmios
{
    ...
    public readonly partial struct QueryLedgerStateAcquiredExpired
    {
        ...
        public readonly partial struct PreviouslyAcquiredLedgerStateIsNoLongerAvailable
            : IJsonObject<Generated.Ogmios.QueryLedgerStateAcquiredExpired.PreviouslyAcquiredLedgerStateIsNoLongerAvailable>
        {
            /// <summary>
            /// Conversion from <see cref="ImmutableList{JsonObjectProperty}"/>.
            /// </summary>
            /// <param name="value">The value from which to convert.</param>
            public static implicit operator PreviouslyAcquiredLedgerStateIsNoLongerAvailable(ImmutableList<JsonObjectProperty> value)
            {
                return new(value);
            }
            ...
            /// </summary>
            /// <param name="value">The value from which to convert.</param>
            public static implicit operator ImmutableList<JsonObjectProperty>(PreviouslyAcquiredLedgerStateIsNoLongerAvailable value)
            {
                return
            ...
            /// </summary>
            /// <param name="value">The value from which to convert.</param>
            public static implicit operator PreviouslyAcquiredLedgerStateIsNoLongerAvailable(JsonObject value)
            {
            ...
            /// </summary>
            /// <param name="value">The value from which to convert.</param>
            public static implicit operator JsonObject(PreviouslyAcquiredLedgerStateIsNoLongerAvailable value)
            {
                return
                    value.AsObject;
            }
            ...
            /// </para>
            /// </remarks>
            public Generated.Ogmios.QueryLedgerStateAcquiredExpired.PreviouslyAcquiredLedgerStateIsNoLongerAvailable.CodeEntity Code
            {
                get
                {
                    if ((this.backing & Backing.JsonElement) != 0)
                    ...
                    if ((this.backing & Backing.Object) != 0)
                    {
                        ...
                        {
                            return result.As<Generated.Ogmios.QueryLedgerStateAcquiredExpired.PreviouslyAcquiredLedgerStateIsNoLongerAvailable.CodeEntity>();
                        }
                    }
            ...
            /// </para>
            /// </remarks>
            public Corvus.Json.JsonString Data
            {
                get
                {
                    if ((this.backing & Backing.JsonElement) != 0)
            ...
            /// <inheritdoc/>
            public static PreviouslyAcquiredLedgerStateIsNoLongerAvailable FromProperties(IDictionary<JsonPropertyName, JsonAny> source)
            {
                return new(source.Select(kvp => new JsonObjectProperty(kvp.Key, kvp.Value)).ToImmutableList());
            }

            /// <inheritdoc/>
            public static PreviouslyAcquiredLedgerStateIsNoLongerAvailable FromProperties(params (JsonPropertyName Name, JsonAny Value)[] source)
            {
            ...
            public static PreviouslyAcquiredLedgerStateIsNoLongerAvailable FromProperties(ImmutableList<JsonObjectProperty> source)
            {
                return new(source);
            }

            /// <summary>
            /// Creates an instance of a <see cref="PreviouslyAcquiredLedgerStateIsNoLongerAvailable"/>.
            /// </summary>
            public static PreviouslyAcquiredLedgerStateIsNoLongerAvailable Create(
                in Generated.Ogmios.QueryLedgerStateAcquiredExpired.PreviouslyAcquiredLedgerStateIsNoLongerAvailable.CodeEntity code,
                in Corvus.Json.JsonString data,
            ...
            public PreviouslyAcquiredLedgerStateIsNoLongerAvailable WithCode(in Generated.Ogmios.QueryLedgerStateAcquiredExpired.PreviouslyAcquiredLedgerStateIsNoLongerAvailable.CodeEntity value)
            {
            ...
            /// </para>
            /// </remarks>
            public PreviouslyAcquiredLedgerStateIsNoLongerAvailable WithData(in Corvus.Json.JsonString value)
            {
            ...
            /// <param name="value">The new property value</param>
            /// <returns>The instance with the property set.</returns>
            public PreviouslyAcquiredLedgerStateIsNoLongerAvailable WithMessage(in Corvus.Json.JsonString value)
            {
            ...
            /// <inheritdoc />
            public PreviouslyAcquiredLedgerStateIsNoLongerAvailable SetProperty<TValue>(in JsonPropertyName name, TValue value)
            ...
            /// <inheritdoc />
            public PreviouslyAcquiredLedgerStateIsNoLongerAvailable RemoveProperty(in JsonPropertyName name)
            {
                return new(__CorvusObjectHelpers.GetPropertyBackingWithout(this, name));
            }

            /// <inheritdoc />
            public PreviouslyAcquiredLedgerStateIsNoLongerAvailable RemoveProperty(string name)
            {
                return new(__CorvusObjectHelpers.GetPropertyBackingWithout(this, name));
            }

            /// <inheritdoc />
            public PreviouslyAcquiredLedgerStateIsNoLongerAvailable RemoveProperty(ReadOnlySpan<char> name)
            {
                return new(__CorvusObjectHelpers.GetPropertyBackingWithout(this, name));
            }

            /// <inheritdoc />
            public PreviouslyAcquiredLedgerStateIsNoLongerAvailable RemoveProperty(ReadOnlySpan<byte> name)
            {
                return new(__CorvusObjectHelpers.GetPropertyBackingWithout(this, name));
            }
            ...
            private static class __CorvusObjectHelpers
            {
                ...
                /// <exception cref="InvalidOperationException">The value is not an object.</exception>
                public static ImmutableList<JsonObjectProperty> GetPropertyBacking(in PreviouslyAcquiredLedgerStateIsNoLongerAvailable that)
                {
                ...
                /// <exception cref="InvalidOperationException">The value is not an object.</exception>
                public static ImmutableList<JsonObjectProperty> GetPropertyBackingWithout(in PreviouslyAcquiredLedgerStateIsNoLongerAvailable that, in JsonPropertyName name)
                {
                    if ((that.backing & Backing.Object) != 0)
                    {
                ...
                /// <returns>An immutable list of <see cref="JsonObjectProperty"/>, built from the existing object, without the given property.</returns>
                /// <exception cref="InvalidOperationException">The value is not an object.</exception>
                public static ImmutableList<JsonObjectProperty> GetPropertyBackingWithout(in PreviouslyAcquiredLedgerStateIsNoLongerAvailable that, ReadOnlySpan<char> name)
                {
                    if ((that.backing & Backing.Object) != 0)
                    {
                        return that.objectBacking.Remove(name);
                ...
                /// <returns>An immutable list of <see cref="JsonObjectProperty"/>, built from the existing object, without the given property.</returns>
                /// <exception cref="InvalidOperationException">The value is not an object.</exception>
                public static ImmutableList<JsonObjectProperty> GetPropertyBackingWithout(in PreviouslyAcquiredLedgerStateIsNoLongerAvailable that, ReadOnlySpan<byte> name)
                {
                    if ((that.backing & Backing.Object) != 0)
                    {
                        return that.objectBacking.Remove(name);
                ...
                /// <returns>An immutable list of <see cref="JsonObjectProperty"/>, built from the existing object, without the given property.</returns>
                /// <exception cref="InvalidOperationException">The value is not an object.</exception>
                public static ImmutableList<JsonObjectProperty> GetPropertyBackingWithout(in PreviouslyAcquiredLedgerStateIsNoLongerAvailable that, string name)
                {
                    if ((that.backing & Backing.Object) != 0)
                    {
                        return that.objectBacking.Remove(name);
                ...
                /// <exception cref="InvalidOperationException">The value is not an object.</exception>
                public static ImmutableList<JsonObjectProperty> GetPropertyBackingWith(in PreviouslyAcquiredLedgerStateIsNoLongerAvailable that, in JsonPropertyName name, in JsonAny value)
                {
                    if ((that.backing & Backing.Object) != 0)
                    {
