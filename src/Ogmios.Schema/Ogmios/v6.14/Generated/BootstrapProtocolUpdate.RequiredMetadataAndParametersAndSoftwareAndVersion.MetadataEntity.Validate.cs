        ...
        public readonly partial struct MetadataEntity
        {
            ...
            public ValidationContext Validate(in ValidationContext validationContext, ValidationLevel level = ValidationLevel.Flag)
            {
                ...
                if (level > ValidationLevel.Basic)
                {
                    ...
                    result = result.PushSchemaLocation("Ogmios.Schema/Ogmios/v6.14/Source/cardano.json#/definitions/BootstrapProtocolUpdate/properties/proposal/properties/metadata");
                }
