...
public readonly partial struct Ogmios
{
    ...
    public readonly partial struct ScriptExecutionFailure
    {
        ...
        public readonly partial struct ScriptExecutionFailureUnsuitableOutputReference
            : IJsonObject<Generated.Ogmios.ScriptExecutionFailure.ScriptExecutionFailureUnsuitableOutputReference>
        {
            /// <summary>
            /// Conversion from <see cref="ImmutableList{JsonObjectProperty}"/>.
            /// </summary>
            /// <param name="value">The value from which to convert.</param>
            public static implicit operator ScriptExecutionFailureUnsuitableOutputReference(ImmutableList<JsonObjectProperty> value)
            {
                return new(value);
            }
            ...
            /// </summary>
            /// <param name="value">The value from which to convert.</param>
            public static implicit operator ImmutableList<JsonObjectProperty>(ScriptExecutionFailureUnsuitableOutputReference value)
            {
                return
            ...
            /// </summary>
            /// <param name="value">The value from which to convert.</param>
            public static implicit operator ScriptExecutionFailureUnsuitableOutputReference(JsonObject value)
            {
            ...
            /// </summary>
            /// <param name="value">The value from which to convert.</param>
            public static implicit operator JsonObject(ScriptExecutionFailureUnsuitableOutputReference value)
            {
                return
                    value.AsObject;
            }
            ...
            /// </para>
            /// </remarks>
            public Generated.Ogmios.ScriptExecutionFailure.ScriptExecutionFailureUnsuitableOutputReference.CodeEntity Code
            {
                get
                {
                    if ((this.backing & Backing.JsonElement) != 0)
                    ...
                    if ((this.backing & Backing.Object) != 0)
                    {
                        ...
                        {
                            return result.As<Generated.Ogmios.ScriptExecutionFailure.ScriptExecutionFailureUnsuitableOutputReference.CodeEntity>();
                        }
                    }
            ...
            /// </para>
            /// </remarks>
            public Generated.Ogmios.ScriptExecutionFailure.ScriptExecutionFailureUnsuitableOutputReference.RequiredUnsuitableOutputReference Data
            {
                get
                {
                    if ((this.backing & Backing.JsonElement) != 0)
                    ...
                    if ((this.backing & Backing.Object) != 0)
                    {
                        ...
                        {
                            return result.As<Generated.Ogmios.ScriptExecutionFailure.ScriptExecutionFailureUnsuitableOutputReference.RequiredUnsuitableOutputReference>();
                        }
                    }
            ...
            /// <inheritdoc/>
            public static ScriptExecutionFailureUnsuitableOutputReference FromProperties(IDictionary<JsonPropertyName, JsonAny> source)
            {
                return new(source.Select(kvp => new JsonObjectProperty(kvp.Key, kvp.Value)).ToImmutableList());
            }

            /// <inheritdoc/>
            public static ScriptExecutionFailureUnsuitableOutputReference FromProperties(params (JsonPropertyName Name, JsonAny Value)[] source)
            {
            ...
            public static ScriptExecutionFailureUnsuitableOutputReference FromProperties(ImmutableList<JsonObjectProperty> source)
            {
                return new(source);
            }

            /// <summary>
            /// Creates an instance of a <see cref="ScriptExecutionFailureUnsuitableOutputReference"/>.
            /// </summary>
            public static ScriptExecutionFailureUnsuitableOutputReference Create(
                in Generated.Ogmios.ScriptExecutionFailure.ScriptExecutionFailureUnsuitableOutputReference.CodeEntity code,
                in Generated.Ogmios.ScriptExecutionFailure.ScriptExecutionFailureUnsuitableOutputReference.RequiredUnsuitableOutputReference data,
            ...
            public ScriptExecutionFailureUnsuitableOutputReference WithCode(in Generated.Ogmios.ScriptExecutionFailure.ScriptExecutionFailureUnsuitableOutputReference.CodeEntity value)
            {
            ...
            /// <param name="value">The new property value</param>
            /// <returns>The instance with the property set.</returns>
            public ScriptExecutionFailureUnsuitableOutputReference WithData(in Generated.Ogmios.ScriptExecutionFailure.ScriptExecutionFailureUnsuitableOutputReference.RequiredUnsuitableOutputReference value)
            {
            ...
            /// <param name="value">The new property value</param>
            /// <returns>The instance with the property set.</returns>
            public ScriptExecutionFailureUnsuitableOutputReference WithMessage(in Corvus.Json.JsonString value)
            {
            ...
            /// <inheritdoc />
            public ScriptExecutionFailureUnsuitableOutputReference SetProperty<TValue>(in JsonPropertyName name, TValue value)
            ...
            /// <inheritdoc />
            public ScriptExecutionFailureUnsuitableOutputReference RemoveProperty(in JsonPropertyName name)
            {
                return new(__CorvusObjectHelpers.GetPropertyBackingWithout(this, name));
            }

            /// <inheritdoc />
            public ScriptExecutionFailureUnsuitableOutputReference RemoveProperty(string name)
            {
                return new(__CorvusObjectHelpers.GetPropertyBackingWithout(this, name));
            }

            /// <inheritdoc />
            public ScriptExecutionFailureUnsuitableOutputReference RemoveProperty(ReadOnlySpan<char> name)
            {
                return new(__CorvusObjectHelpers.GetPropertyBackingWithout(this, name));
            }

            /// <inheritdoc />
            public ScriptExecutionFailureUnsuitableOutputReference RemoveProperty(ReadOnlySpan<byte> name)
            {
                return new(__CorvusObjectHelpers.GetPropertyBackingWithout(this, name));
            }
            ...
            private static class __CorvusObjectHelpers
            {
                ...
                /// <exception cref="InvalidOperationException">The value is not an object.</exception>
                public static ImmutableList<JsonObjectProperty> GetPropertyBacking(in ScriptExecutionFailureUnsuitableOutputReference that)
                {
                ...
                /// <exception cref="InvalidOperationException">The value is not an object.</exception>
                public static ImmutableList<JsonObjectProperty> GetPropertyBackingWithout(in ScriptExecutionFailureUnsuitableOutputReference that, in JsonPropertyName name)
                {
                    if ((that.backing & Backing.Object) != 0)
                    {
                ...
                /// <returns>An immutable list of <see cref="JsonObjectProperty"/>, built from the existing object, without the given property.</returns>
                /// <exception cref="InvalidOperationException">The value is not an object.</exception>
                public static ImmutableList<JsonObjectProperty> GetPropertyBackingWithout(in ScriptExecutionFailureUnsuitableOutputReference that, ReadOnlySpan<char> name)
                {
                    if ((that.backing & Backing.Object) != 0)
                    {
                        return that.objectBacking.Remove(name);
                ...
                /// <returns>An immutable list of <see cref="JsonObjectProperty"/>, built from the existing object, without the given property.</returns>
                /// <exception cref="InvalidOperationException">The value is not an object.</exception>
                public static ImmutableList<JsonObjectProperty> GetPropertyBackingWithout(in ScriptExecutionFailureUnsuitableOutputReference that, ReadOnlySpan<byte> name)
                {
                    if ((that.backing & Backing.Object) != 0)
                    {
                        return that.objectBacking.Remove(name);
                ...
                /// <returns>An immutable list of <see cref="JsonObjectProperty"/>, built from the existing object, without the given property.</returns>
                /// <exception cref="InvalidOperationException">The value is not an object.</exception>
                public static ImmutableList<JsonObjectProperty> GetPropertyBackingWithout(in ScriptExecutionFailureUnsuitableOutputReference that, string name)
                {
                    if ((that.backing & Backing.Object) != 0)
                    {
                        return that.objectBacking.Remove(name);
                ...
                /// <exception cref="InvalidOperationException">The value is not an object.</exception>
                public static ImmutableList<JsonObjectProperty> GetPropertyBackingWith(in ScriptExecutionFailureUnsuitableOutputReference that, in JsonPropertyName name, in JsonAny value)
                {
                    if ((that.backing & Backing.Object) != 0)
                    {
