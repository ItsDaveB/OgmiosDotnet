...
public readonly partial struct Ogmios
{
    ...
    public readonly partial struct SubmitTransactionFailure
    {
        ...
        public readonly partial struct SubmitTransactionFailureExecutionUnitsTooLarge
            : IJsonObject<Generated.Ogmios.SubmitTransactionFailure.SubmitTransactionFailureExecutionUnitsTooLarge>
        {
            /// <summary>
            /// Conversion from <see cref="ImmutableList{JsonObjectProperty}"/>.
            /// </summary>
            /// <param name="value">The value from which to convert.</param>
            public static implicit operator SubmitTransactionFailureExecutionUnitsTooLarge(ImmutableList<JsonObjectProperty> value)
            {
                return new(value);
            }
            ...
            /// </summary>
            /// <param name="value">The value from which to convert.</param>
            public static implicit operator ImmutableList<JsonObjectProperty>(SubmitTransactionFailureExecutionUnitsTooLarge value)
            {
                return
            ...
            /// </summary>
            /// <param name="value">The value from which to convert.</param>
            public static implicit operator SubmitTransactionFailureExecutionUnitsTooLarge(JsonObject value)
            {
            ...
            /// </summary>
            /// <param name="value">The value from which to convert.</param>
            public static implicit operator JsonObject(SubmitTransactionFailureExecutionUnitsTooLarge value)
            {
                return
                    value.AsObject;
            }
            ...
            /// </para>
            /// </remarks>
            public Generated.Ogmios.SubmitTransactionFailure.SubmitTransactionFailureExecutionUnitsTooLarge.CodeEntity Code
            {
                get
                {
                    if ((this.backing & Backing.JsonElement) != 0)
                    ...
                    if ((this.backing & Backing.Object) != 0)
                    {
                        ...
                        {
                            return result.As<Generated.Ogmios.SubmitTransactionFailure.SubmitTransactionFailureExecutionUnitsTooLarge.CodeEntity>();
                        }
                    }
            ...
            /// </para>
            /// </remarks>
            public Generated.Ogmios.SubmitTransactionFailure.SubmitTransactionFailureExecutionUnitsTooLarge.RequiredMaximumExecutionUnitsAndProvidedExecutionUnits Data
            {
                get
                {
                    if ((this.backing & Backing.JsonElement) != 0)
                    ...
                    if ((this.backing & Backing.Object) != 0)
                    {
                        ...
                        {
                            return result.As<Generated.Ogmios.SubmitTransactionFailure.SubmitTransactionFailureExecutionUnitsTooLarge.RequiredMaximumExecutionUnitsAndProvidedExecutionUnits>();
                        }
                    }
            ...
            /// <inheritdoc/>
            public static SubmitTransactionFailureExecutionUnitsTooLarge FromProperties(IDictionary<JsonPropertyName, JsonAny> source)
            {
                return new(source.Select(kvp => new JsonObjectProperty(kvp.Key, kvp.Value)).ToImmutableList());
            }

            /// <inheritdoc/>
            public static SubmitTransactionFailureExecutionUnitsTooLarge FromProperties(params (JsonPropertyName Name, JsonAny Value)[] source)
            {
            ...
            public static SubmitTransactionFailureExecutionUnitsTooLarge FromProperties(ImmutableList<JsonObjectProperty> source)
            {
                return new(source);
            }

            /// <summary>
            /// Creates an instance of a <see cref="SubmitTransactionFailureExecutionUnitsTooLarge"/>.
            /// </summary>
            public static SubmitTransactionFailureExecutionUnitsTooLarge Create(
                in Generated.Ogmios.SubmitTransactionFailure.SubmitTransactionFailureExecutionUnitsTooLarge.CodeEntity code,
                in Generated.Ogmios.SubmitTransactionFailure.SubmitTransactionFailureExecutionUnitsTooLarge.RequiredMaximumExecutionUnitsAndProvidedExecutionUnits data,
            ...
            public SubmitTransactionFailureExecutionUnitsTooLarge WithCode(in Generated.Ogmios.SubmitTransactionFailure.SubmitTransactionFailureExecutionUnitsTooLarge.CodeEntity value)
            {
            ...
            /// <param name="value">The new property value</param>
            /// <returns>The instance with the property set.</returns>
            public SubmitTransactionFailureExecutionUnitsTooLarge WithData(in Generated.Ogmios.SubmitTransactionFailure.SubmitTransactionFailureExecutionUnitsTooLarge.RequiredMaximumExecutionUnitsAndProvidedExecutionUnits value)
            {
            ...
            /// <param name="value">The new property value</param>
            /// <returns>The instance with the property set.</returns>
            public SubmitTransactionFailureExecutionUnitsTooLarge WithMessage(in Corvus.Json.JsonString value)
            {
            ...
            /// <inheritdoc />
            public SubmitTransactionFailureExecutionUnitsTooLarge SetProperty<TValue>(in JsonPropertyName name, TValue value)
            ...
            /// <inheritdoc />
            public SubmitTransactionFailureExecutionUnitsTooLarge RemoveProperty(in JsonPropertyName name)
            {
                return new(__CorvusObjectHelpers.GetPropertyBackingWithout(this, name));
            }

            /// <inheritdoc />
            public SubmitTransactionFailureExecutionUnitsTooLarge RemoveProperty(string name)
            {
                return new(__CorvusObjectHelpers.GetPropertyBackingWithout(this, name));
            }

            /// <inheritdoc />
            public SubmitTransactionFailureExecutionUnitsTooLarge RemoveProperty(ReadOnlySpan<char> name)
            {
                return new(__CorvusObjectHelpers.GetPropertyBackingWithout(this, name));
            }

            /// <inheritdoc />
            public SubmitTransactionFailureExecutionUnitsTooLarge RemoveProperty(ReadOnlySpan<byte> name)
            {
                return new(__CorvusObjectHelpers.GetPropertyBackingWithout(this, name));
            }
            ...
            private static class __CorvusObjectHelpers
            {
                ...
                /// <exception cref="InvalidOperationException">The value is not an object.</exception>
                public static ImmutableList<JsonObjectProperty> GetPropertyBacking(in SubmitTransactionFailureExecutionUnitsTooLarge that)
                {
                ...
                /// <exception cref="InvalidOperationException">The value is not an object.</exception>
                public static ImmutableList<JsonObjectProperty> GetPropertyBackingWithout(in SubmitTransactionFailureExecutionUnitsTooLarge that, in JsonPropertyName name)
                {
                    if ((that.backing & Backing.Object) != 0)
                    {
                ...
                /// <returns>An immutable list of <see cref="JsonObjectProperty"/>, built from the existing object, without the given property.</returns>
                /// <exception cref="InvalidOperationException">The value is not an object.</exception>
                public static ImmutableList<JsonObjectProperty> GetPropertyBackingWithout(in SubmitTransactionFailureExecutionUnitsTooLarge that, ReadOnlySpan<char> name)
                {
                    if ((that.backing & Backing.Object) != 0)
                    {
                        return that.objectBacking.Remove(name);
                ...
                /// <returns>An immutable list of <see cref="JsonObjectProperty"/>, built from the existing object, without the given property.</returns>
                /// <exception cref="InvalidOperationException">The value is not an object.</exception>
                public static ImmutableList<JsonObjectProperty> GetPropertyBackingWithout(in SubmitTransactionFailureExecutionUnitsTooLarge that, ReadOnlySpan<byte> name)
                {
                    if ((that.backing & Backing.Object) != 0)
                    {
                        return that.objectBacking.Remove(name);
                ...
                /// <returns>An immutable list of <see cref="JsonObjectProperty"/>, built from the existing object, without the given property.</returns>
                /// <exception cref="InvalidOperationException">The value is not an object.</exception>
                public static ImmutableList<JsonObjectProperty> GetPropertyBackingWithout(in SubmitTransactionFailureExecutionUnitsTooLarge that, string name)
                {
                    if ((that.backing & Backing.Object) != 0)
                    {
                        return that.objectBacking.Remove(name);
                ...
                /// <exception cref="InvalidOperationException">The value is not an object.</exception>
                public static ImmutableList<JsonObjectProperty> GetPropertyBackingWith(in SubmitTransactionFailureExecutionUnitsTooLarge that, in JsonPropertyName name, in JsonAny value)
                {
                    if ((that.backing & Backing.Object) != 0)
                    {
