    ...
    : IJsonObject<Generated.CertifiedVrf>
{
    ...
    /// <summary>
    /// Sets the (optional) <c>output</c> property.
    /// </summary>
    /// <param name="value">The new property value</param>
    /// <returns>The instance with the property set.</returns>
    public CertifiedVrf WithOutput(in Corvus.Json.JsonString value)
    {
        return this.SetProperty(JsonPropertyNames.Output, value);
    }

    /// <summary>
    /// Sets the (optional) <c>proof</c> property.
    /// </summary>
    /// <param name="value">The new property value</param>
    /// <returns>The instance with the property set.</returns>
    public CertifiedVrf WithProof(in Corvus.Json.JsonString value)
    {
        return this.SetProperty(JsonPropertyNames.Proof, value);
    }
