    ...
    public readonly partial struct ScriptPurposeWithdraw
    {
        ...
        public ValidationContext Validate(in ValidationContext validationContext, ValidationLevel level = ValidationLevel.Flag)
        {
            ...
            if (level > ValidationLevel.Basic)
            {
                ...
                result = result.PushSchemaLocation("https://endjin.com/Users/davebeaumont/source/cardano-public/OgmiosDotnet/src/Ogmios.Schema/Ogmios/v6.10/Source/cardano.json#/definitions/ScriptPurpose/oneOf/3");
            }
        ...
        public static partial class CorvusValidation
        {
            ...
            internal static ValidationContext ObjectValidationHandler(
                in ScriptPurposeWithdraw value,
                JsonValueKind valueKind,
                in ValidationContext validationContext,
                ValidationLevel level = ValidationLevel.Flag)
            {
                ...
                foreach (JsonObjectProperty property in value.EnumerateObject())
                {
                    ...
                    if (property.NameEquals(JsonPropertyNames.PurposeUtf8, JsonPropertyNames.Purpose))
                    {
                        hasSeenPurpose = true;
                        ...
                        ValidationContext propertyResult = property.Value.As<Generated.ScriptPurpose.ScriptPurposeWithdraw.PurposeEntity>().Validate(result.CreateChildContext(), level);
