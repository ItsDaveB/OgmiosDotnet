    ...
    public readonly partial struct ClauseAny
    {
        ...
        public ValidationContext Validate(in ValidationContext validationContext, ValidationLevel level = ValidationLevel.Flag)
        {
            ...
            if (level > ValidationLevel.Basic)
            {
                ...
                result = result.PushSchemaLocation("https://endjin.com/Users/davebeaumont/source/cardano-public/OgmiosDotnet/src/Ogmios.Schema/Ogmios/v6.10/Source/cardano.json#/definitions/Script<Native>/oneOf/1");
            }
                ...
                ValidationLevel level = ValidationLevel.Flag)
            {
                ...
                foreach (JsonObjectProperty property in value.EnumerateObject())
                {
                    ...
                    if (property.NameEquals(JsonPropertyNames.ClauseUtf8, JsonPropertyNames.Clause))
                    {
                        ...
                        ValidationContext propertyResult = property.Value.As<Generated.ScriptNative.ClauseAny.ClauseEntity>().Validate(result.CreateChildContext(), level);
                    ...
                    else if (property.NameEquals(JsonPropertyNames.FromUtf8, JsonPropertyNames.From))
                    {
                        ...
                        ValidationContext propertyResult = property.Value.As<Generated.ScriptNative.ClauseAny.ScriptNativeArray>().Validate(result.CreateChildContext(), level);
                        if (level == ValidationLevel.Flag && !propertyResult.IsValid)
                        {
                            return propertyResult;
                        }
