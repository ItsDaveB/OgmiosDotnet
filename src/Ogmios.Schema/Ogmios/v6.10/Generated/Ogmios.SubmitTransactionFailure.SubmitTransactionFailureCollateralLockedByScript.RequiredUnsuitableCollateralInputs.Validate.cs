            ...
            public readonly partial struct RequiredUnsuitableCollateralInputs
            {
                ...
                public ValidationContext Validate(in ValidationContext validationContext, ValidationLevel level = ValidationLevel.Flag)
                {
                    ...
                    if (level > ValidationLevel.Basic)
                    {
                        ...
                        result = result.PushSchemaLocation("https://endjin.com/Users/davebeaumont/source/cardano-public/OgmiosDotnet/src/Ogmios.Schema/Ogmios/v6.10/Source/ogmios.json#/definitions/SubmitTransactionFailure/oneOf/30/properties/data");
                    }
                ...
                public static partial class CorvusValidation
                {
                    ...
                    internal static ValidationContext ObjectValidationHandler(
                        in RequiredUnsuitableCollateralInputs value,
                        JsonValueKind valueKind,
                        in ValidationContext validationContext,
                        ValidationLevel level = ValidationLevel.Flag)
                    {
                        ...
                        bool hasSeenUnsuitableCollateralInputs = false;
                        ...
                        foreach (JsonObjectProperty property in value.EnumerateObject())
                        {
                            ...
                            if (property.NameEquals(JsonPropertyNames.UnsuitableCollateralInputsUtf8, JsonPropertyNames.UnsuitableCollateralInputs))
                            {
                                hasSeenUnsuitableCollateralInputs = true;
                                result = result.WithLocalProperty(propertyCount);
                                if (level > ValidationLevel.Basic)
                                {
                                    result = result.PushValidationLocationReducedPathModifierAndProperty(new("#/properties/unsuitableCollateralInputs"), JsonPropertyNames.UnsuitableCollateralInputs);
                                }

                                ValidationContext propertyResult = property.Value.As<Generated.Ogmios.SubmitTransactionFailure.SubmitTransactionFailureCollateralLockedByScript.RequiredUnsuitableCollateralInputs.TransactionOutputReferenceArray>().Validate(result.CreateChildContext(), level);
                        ...
                        if (!hasSeenUnsuitableCollateralInputs)
                        {
                            if (level >= ValidationLevel.Basic)
                            {
                                result = result.WithResult(isValid: false, "Validation properties - the required property 'unsuitableCollateralInputs' was not present.");
                            }
                            else
                            {
                        ...
                        {
                            result = result.WithResult(isValid: true, "Validation properties - the required property 'unsuitableCollateralInputs' was present.");
                        }
