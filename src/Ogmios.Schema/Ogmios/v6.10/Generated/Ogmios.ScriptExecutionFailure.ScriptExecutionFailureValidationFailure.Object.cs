...
public readonly partial struct Ogmios
{
    ...
    public readonly partial struct ScriptExecutionFailure
    {
        ...
        public readonly partial struct ScriptExecutionFailureValidationFailure
            : IJsonObject<Generated.Ogmios.ScriptExecutionFailure.ScriptExecutionFailureValidationFailure>
        {
            /// <summary>
            /// Conversion from <see cref="ImmutableList{JsonObjectProperty}"/>.
            /// </summary>
            /// <param name="value">The value from which to convert.</param>
            public static implicit operator ScriptExecutionFailureValidationFailure(ImmutableList<JsonObjectProperty> value)
            {
                return new(value);
            }
            ...
            /// </summary>
            /// <param name="value">The value from which to convert.</param>
            public static implicit operator ImmutableList<JsonObjectProperty>(ScriptExecutionFailureValidationFailure value)
            {
                return
            ...
            /// </summary>
            /// <param name="value">The value from which to convert.</param>
            public static implicit operator ScriptExecutionFailureValidationFailure(JsonObject value)
            {
            ...
            /// </summary>
            /// <param name="value">The value from which to convert.</param>
            public static implicit operator JsonObject(ScriptExecutionFailureValidationFailure value)
            {
                return
                    value.AsObject;
            }
            ...
            /// </para>
            /// </remarks>
            public Generated.Ogmios.ScriptExecutionFailure.ScriptExecutionFailureValidationFailure.CodeEntity Code
            {
                get
                {
                    if ((this.backing & Backing.JsonElement) != 0)
                    ...
                    if ((this.backing & Backing.Object) != 0)
                    {
                        ...
                        {
                            return result.As<Generated.Ogmios.ScriptExecutionFailure.ScriptExecutionFailureValidationFailure.CodeEntity>();
                        }
                    }
            ...
            /// </para>
            /// </remarks>
            public Generated.Ogmios.ScriptExecutionFailure.ScriptExecutionFailureValidationFailure.RequiredTracesAndValidationError Data
            {
                get
                {
                    if ((this.backing & Backing.JsonElement) != 0)
                    ...
                    if ((this.backing & Backing.Object) != 0)
                    {
                        ...
                        {
                            return result.As<Generated.Ogmios.ScriptExecutionFailure.ScriptExecutionFailureValidationFailure.RequiredTracesAndValidationError>();
                        }
                    }
            ...
            /// <inheritdoc/>
            public static ScriptExecutionFailureValidationFailure FromProperties(IDictionary<JsonPropertyName, JsonAny> source)
            {
                return new(source.Select(kvp => new JsonObjectProperty(kvp.Key, kvp.Value)).ToImmutableList());
            }

            /// <inheritdoc/>
            public static ScriptExecutionFailureValidationFailure FromProperties(params (JsonPropertyName Name, JsonAny Value)[] source)
            {
            ...
            public static ScriptExecutionFailureValidationFailure FromProperties(ImmutableList<JsonObjectProperty> source)
            {
                return new(source);
            }

            /// <summary>
            /// Creates an instance of a <see cref="ScriptExecutionFailureValidationFailure"/>.
            /// </summary>
            public static ScriptExecutionFailureValidationFailure Create(
                in Generated.Ogmios.ScriptExecutionFailure.ScriptExecutionFailureValidationFailure.CodeEntity code,
                in Generated.Ogmios.ScriptExecutionFailure.ScriptExecutionFailureValidationFailure.RequiredTracesAndValidationError data,
            ...
            public ScriptExecutionFailureValidationFailure WithCode(in Generated.Ogmios.ScriptExecutionFailure.ScriptExecutionFailureValidationFailure.CodeEntity value)
            {
            ...
            /// <param name="value">The new property value</param>
            /// <returns>The instance with the property set.</returns>
            public ScriptExecutionFailureValidationFailure WithData(in Generated.Ogmios.ScriptExecutionFailure.ScriptExecutionFailureValidationFailure.RequiredTracesAndValidationError value)
            {
            ...
            /// <param name="value">The new property value</param>
            /// <returns>The instance with the property set.</returns>
            public ScriptExecutionFailureValidationFailure WithMessage(in Corvus.Json.JsonString value)
            {
            ...
            /// <inheritdoc />
            public ScriptExecutionFailureValidationFailure SetProperty<TValue>(in JsonPropertyName name, TValue value)
            ...
            /// <inheritdoc />
            public ScriptExecutionFailureValidationFailure RemoveProperty(in JsonPropertyName name)
            {
                return new(__CorvusObjectHelpers.GetPropertyBackingWithout(this, name));
            }

            /// <inheritdoc />
            public ScriptExecutionFailureValidationFailure RemoveProperty(string name)
            {
                return new(__CorvusObjectHelpers.GetPropertyBackingWithout(this, name));
            }

            /// <inheritdoc />
            public ScriptExecutionFailureValidationFailure RemoveProperty(ReadOnlySpan<char> name)
            {
                return new(__CorvusObjectHelpers.GetPropertyBackingWithout(this, name));
            }

            /// <inheritdoc />
            public ScriptExecutionFailureValidationFailure RemoveProperty(ReadOnlySpan<byte> name)
            {
                return new(__CorvusObjectHelpers.GetPropertyBackingWithout(this, name));
            }
            ...
            private static class __CorvusObjectHelpers
            {
                ...
                /// <exception cref="InvalidOperationException">The value is not an object.</exception>
                public static ImmutableList<JsonObjectProperty> GetPropertyBacking(in ScriptExecutionFailureValidationFailure that)
                {
                ...
                /// <exception cref="InvalidOperationException">The value is not an object.</exception>
                public static ImmutableList<JsonObjectProperty> GetPropertyBackingWithout(in ScriptExecutionFailureValidationFailure that, in JsonPropertyName name)
                {
                    if ((that.backing & Backing.Object) != 0)
                    {
                ...
                /// <returns>An immutable list of <see cref="JsonObjectProperty"/>, built from the existing object, without the given property.</returns>
                /// <exception cref="InvalidOperationException">The value is not an object.</exception>
                public static ImmutableList<JsonObjectProperty> GetPropertyBackingWithout(in ScriptExecutionFailureValidationFailure that, ReadOnlySpan<char> name)
                {
                    if ((that.backing & Backing.Object) != 0)
                    {
                        return that.objectBacking.Remove(name);
                ...
                /// <returns>An immutable list of <see cref="JsonObjectProperty"/>, built from the existing object, without the given property.</returns>
                /// <exception cref="InvalidOperationException">The value is not an object.</exception>
                public static ImmutableList<JsonObjectProperty> GetPropertyBackingWithout(in ScriptExecutionFailureValidationFailure that, ReadOnlySpan<byte> name)
                {
                    if ((that.backing & Backing.Object) != 0)
                    {
                        return that.objectBacking.Remove(name);
                ...
                /// <returns>An immutable list of <see cref="JsonObjectProperty"/>, built from the existing object, without the given property.</returns>
                /// <exception cref="InvalidOperationException">The value is not an object.</exception>
                public static ImmutableList<JsonObjectProperty> GetPropertyBackingWithout(in ScriptExecutionFailureValidationFailure that, string name)
                {
                    if ((that.backing & Backing.Object) != 0)
                    {
                        return that.objectBacking.Remove(name);
                ...
                /// <exception cref="InvalidOperationException">The value is not an object.</exception>
                public static ImmutableList<JsonObjectProperty> GetPropertyBackingWith(in ScriptExecutionFailureValidationFailure that, in JsonPropertyName name, in JsonAny value)
                {
                    if ((that.backing & Backing.Object) != 0)
                    {
