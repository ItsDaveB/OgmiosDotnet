...
public readonly partial struct ScriptNative
{
    ...
    public ValidationContext Validate(in ValidationContext validationContext, ValidationLevel level = ValidationLevel.Flag)
    {
        ...
        if (level > ValidationLevel.Basic)
        {
            ...
            result = result.PushSchemaLocation("https://endjin.com/Users/davebeaumont/source/cardano-public/OgmiosDotnet/src/Ogmios.Schema/Ogmios/v6.10/Source/cardano.json#/definitions/Script<Native>");
        }
    ...
    public static partial class CorvusValidation
    {
            ...
            ValidationLevel level = ValidationLevel.Flag)
        {
            ...
            ValidationContext oneOfResult0 = value.As<Generated.ScriptNative.ClauseSignature>().Validate(oneOfChildContext0, level);
            ...
            ValidationContext oneOfResult1 = value.As<Generated.ScriptNative.ClauseAny>().Validate(oneOfChildContext1, level);
            ...
            ValidationContext oneOfResult2 = value.As<Generated.ScriptNative.ClauseAll>().Validate(oneOfChildContext2, level);
            ...
            ValidationContext oneOfResult3 = value.As<Generated.ScriptNative.ClauseSome>().Validate(oneOfChildContext3, level);
            ...
            ValidationContext oneOfResult4 = value.As<Generated.ScriptNative.ClauseBefore>().Validate(oneOfChildContext4, level);
            ...
            ValidationContext oneOfResult5 = value.As<Generated.ScriptNative.ClauseAfter>().Validate(oneOfChildContext5, level);
