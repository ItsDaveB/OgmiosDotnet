    ...
    public readonly partial struct SizeOfMempool
    {
        ...
        public ValidationContext Validate(in ValidationContext validationContext, ValidationLevel level = ValidationLevel.Flag)
        {
            ...
            if (level > ValidationLevel.Basic)
            {
                ...
                result = result.PushSchemaLocation("https://endjin.com/Users/davebeaumont/source/cardano-public/OgmiosDotnet/src/Ogmios.Schema/Ogmios/v6.10/Source/ogmios.json#/properties/SizeOfMempool");
            }
                ...
                ValidationLevel level = ValidationLevel.Flag)
            {
                ...
                foreach (JsonObjectProperty property in value.EnumerateObject())
                {
                    ...
                    else if (property.NameEquals(JsonPropertyNames.JsonrpcUtf8, JsonPropertyNames.Jsonrpc))
                    {
                        ...
                        ValidationContext propertyResult = property.Value.As<Generated.Ogmios.SizeOfMempool.JsonrpcEntity>().Validate(result.CreateChildContext(), level);
                        if (level == ValidationLevel.Flag && !propertyResult.IsValid)
                        {
                            return propertyResult;
                        }
                    ...
                    else if (property.NameEquals(JsonPropertyNames.MethodUtf8, JsonPropertyNames.Method))
                    {
                        ...
                        ValidationContext propertyResult = property.Value.As<Generated.Ogmios.SizeOfMempool.MethodEntity>().Validate(result.CreateChildContext(), level);
                        if (level == ValidationLevel.Flag && !propertyResult.IsValid)
                        {
                            return propertyResult;
                        }
