...
public readonly partial struct ConstitutionalCommitteeMember
{
    ...
    public ValidationContext Validate(in ValidationContext validationContext, ValidationLevel level = ValidationLevel.Flag)
    {
        ...
        if (level > ValidationLevel.Basic)
        {
            ...
            result = result.PushSchemaLocation("https://endjin.com/Users/davebeaumont/source/cardano-public/OgmiosDotnet/src/Ogmios.Schema/Ogmios/v6.10/Source/cardano.json#/definitions/ConstitutionalCommitteeMember");
        }
    ...
    public static partial class CorvusValidation
    {
        ...
        internal static ValidationContext ObjectValidationHandler(
            in ConstitutionalCommitteeMember value,
            JsonValueKind valueKind,
            in ValidationContext validationContext,
            ValidationLevel level = ValidationLevel.Flag)
        {
            ...
            foreach (JsonObjectProperty property in value.EnumerateObject())
            {
                ...
                if (property.NameEquals(JsonPropertyNames.DelegateUtf8, JsonPropertyNames.Delegate))
                {
                    hasSeenDelegate = true;
                    result = result.WithLocalProperty(propertyCount);
                    if (level > ValidationLevel.Basic)
                    {
                        result = result.PushValidationLocationReducedPathModifierAndProperty(new("#/properties/delegate/$ref"), JsonPropertyNames.Delegate);
                    }

                    ValidationContext propertyResult = property.Value.As<Generated.ConstitutionalCommitteeDelegate>().Validate(result.CreateChildContext(), level);
                ...
                else if (property.NameEquals(JsonPropertyNames.NextUtf8, JsonPropertyNames.Next))
                {
                    result = result.WithLocalProperty(propertyCount);
                    if (level > ValidationLevel.Basic)
                    {
                        result = result.PushValidationLocationReducedPathModifierAndProperty(new("#/properties/next"), JsonPropertyNames.Next);
                    }

                    ValidationContext propertyResult = property.Value.As<Generated.ConstitutionalCommitteeMember.NextEntity>().Validate(result.CreateChildContext(), level);
                    if (level == ValidationLevel.Flag && !propertyResult.IsValid)
                    {
                        return propertyResult;
                    }
                ...
                else if (property.NameEquals(JsonPropertyNames.StatusUtf8, JsonPropertyNames.Status))
                {
                    ...
                    ValidationContext propertyResult = property.Value.As<Generated.ConstitutionalCommitteeMember.StatusEntity>().Validate(result.CreateChildContext(), level);
                    if (level == ValidationLevel.Flag && !propertyResult.IsValid)
                    {
                        return propertyResult;
                    }
            ...
            if (!hasSeenStatus)
            {
                if (level >= ValidationLevel.Basic)
                {
                    result = result.WithResult(isValid: false, "Validation properties - the required property 'status' was not present.");
                }
                else
                {
                    return ValidationContext.InvalidContext;
            ...
            {
                result = result.WithResult(isValid: true, "Validation properties - the required property 'status' was present.");
            }
