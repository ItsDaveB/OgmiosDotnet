...
public readonly partial struct BootstrapOperationalCertificate
{
    ...
    public ValidationContext Validate(in ValidationContext validationContext, ValidationLevel level = ValidationLevel.Flag)
    {
        ...
        if (level > ValidationLevel.Basic)
        {
            ...
            result = result.PushSchemaLocation("https://endjin.com/Users/davebeaumont/source/cardano-public/OgmiosDotnet/src/Ogmios.Schema/Ogmios/v6.10/Source/cardano.json#/definitions/BootstrapOperationalCertificate");
        }
    ...
    public static partial class CorvusValidation
    {
        ...
        internal static ValidationContext ObjectValidationHandler(
            in BootstrapOperationalCertificate value,
            JsonValueKind valueKind,
            in ValidationContext validationContext,
            ValidationLevel level = ValidationLevel.Flag)
        {
            ...
            foreach (JsonObjectProperty property in value.EnumerateObject())
            {
                ...
                if (property.NameEquals(JsonPropertyNames.DelegateUtf8, JsonPropertyNames.Delegate))
                {
                    ...
                    ValidationContext propertyResult = property.Value.As<Generated.BootstrapOperationalCertificate.RequiredVerificationKey>().Validate(result.CreateChildContext(), level);
                ...
                else if (property.NameEquals(JsonPropertyNames.IssuerUtf8, JsonPropertyNames.Issuer))
                {
                    ...
                    ValidationContext propertyResult = property.Value.As<Generated.BootstrapOperationalCertificate.BootstrapOperationalCertificateRequiredVerificationKey>().Validate(result.CreateChildContext(), level);
                    if (level == ValidationLevel.Flag && !propertyResult.IsValid)
                    {
                        return propertyResult;
                    }
