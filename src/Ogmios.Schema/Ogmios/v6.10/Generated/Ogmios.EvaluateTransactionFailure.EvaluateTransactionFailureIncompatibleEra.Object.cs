...
public readonly partial struct Ogmios
{
    ...
    public readonly partial struct EvaluateTransactionFailure
    {
        ...
        public readonly partial struct EvaluateTransactionFailureIncompatibleEra
            : IJsonObject<Generated.Ogmios.EvaluateTransactionFailure.EvaluateTransactionFailureIncompatibleEra>
        {
            /// <summary>
            /// Conversion from <see cref="ImmutableList{JsonObjectProperty}"/>.
            /// </summary>
            /// <param name="value">The value from which to convert.</param>
            public static implicit operator EvaluateTransactionFailureIncompatibleEra(ImmutableList<JsonObjectProperty> value)
            {
                return new(value);
            }
            ...
            /// </summary>
            /// <param name="value">The value from which to convert.</param>
            public static implicit operator ImmutableList<JsonObjectProperty>(EvaluateTransactionFailureIncompatibleEra value)
            {
                return
            ...
            /// </summary>
            /// <param name="value">The value from which to convert.</param>
            public static implicit operator EvaluateTransactionFailureIncompatibleEra(JsonObject value)
            {
            ...
            /// </summary>
            /// <param name="value">The value from which to convert.</param>
            public static implicit operator JsonObject(EvaluateTransactionFailureIncompatibleEra value)
            {
                return
                    value.AsObject;
            }
            ...
            /// </para>
            /// </remarks>
            public Generated.Ogmios.EvaluateTransactionFailure.EvaluateTransactionFailureIncompatibleEra.CodeEntity Code
            {
                get
                {
                    if ((this.backing & Backing.JsonElement) != 0)
                    ...
                    if ((this.backing & Backing.Object) != 0)
                    {
                        ...
                        {
                            return result.As<Generated.Ogmios.EvaluateTransactionFailure.EvaluateTransactionFailureIncompatibleEra.CodeEntity>();
                        }
                    }
            ...
            /// </para>
            /// </remarks>
            public Generated.Ogmios.EvaluateTransactionFailure.EvaluateTransactionFailureIncompatibleEra.TheEraInWhichTheTransactionHasBeenIdentified Data
            {
                get
                {
                    if ((this.backing & Backing.JsonElement) != 0)
                    ...
                    if ((this.backing & Backing.Object) != 0)
                    {
                        ...
                        {
                            return result.As<Generated.Ogmios.EvaluateTransactionFailure.EvaluateTransactionFailureIncompatibleEra.TheEraInWhichTheTransactionHasBeenIdentified>();
                        }
                    }
            ...
            /// <inheritdoc/>
            public static EvaluateTransactionFailureIncompatibleEra FromProperties(IDictionary<JsonPropertyName, JsonAny> source)
            {
                return new(source.Select(kvp => new JsonObjectProperty(kvp.Key, kvp.Value)).ToImmutableList());
            }

            /// <inheritdoc/>
            public static EvaluateTransactionFailureIncompatibleEra FromProperties(params (JsonPropertyName Name, JsonAny Value)[] source)
            {
            ...
            public static EvaluateTransactionFailureIncompatibleEra FromProperties(ImmutableList<JsonObjectProperty> source)
            {
                return new(source);
            }

            /// <summary>
            /// Creates an instance of a <see cref="EvaluateTransactionFailureIncompatibleEra"/>.
            /// </summary>
            public static EvaluateTransactionFailureIncompatibleEra Create(
                in Generated.Ogmios.EvaluateTransactionFailure.EvaluateTransactionFailureIncompatibleEra.CodeEntity code,
                in Generated.Ogmios.EvaluateTransactionFailure.EvaluateTransactionFailureIncompatibleEra.TheEraInWhichTheTransactionHasBeenIdentified data,
            ...
            public EvaluateTransactionFailureIncompatibleEra WithCode(in Generated.Ogmios.EvaluateTransactionFailure.EvaluateTransactionFailureIncompatibleEra.CodeEntity value)
            {
            ...
            /// </para>
            /// </remarks>
            public EvaluateTransactionFailureIncompatibleEra WithData(in Generated.Ogmios.EvaluateTransactionFailure.EvaluateTransactionFailureIncompatibleEra.TheEraInWhichTheTransactionHasBeenIdentified value)
            {
            ...
            /// <param name="value">The new property value</param>
            /// <returns>The instance with the property set.</returns>
            public EvaluateTransactionFailureIncompatibleEra WithMessage(in Corvus.Json.JsonString value)
            {
            ...
            /// <inheritdoc />
            public EvaluateTransactionFailureIncompatibleEra SetProperty<TValue>(in JsonPropertyName name, TValue value)
            ...
            /// <inheritdoc />
            public EvaluateTransactionFailureIncompatibleEra RemoveProperty(in JsonPropertyName name)
            {
                return new(__CorvusObjectHelpers.GetPropertyBackingWithout(this, name));
            }

            /// <inheritdoc />
            public EvaluateTransactionFailureIncompatibleEra RemoveProperty(string name)
            {
                return new(__CorvusObjectHelpers.GetPropertyBackingWithout(this, name));
            }

            /// <inheritdoc />
            public EvaluateTransactionFailureIncompatibleEra RemoveProperty(ReadOnlySpan<char> name)
            {
                return new(__CorvusObjectHelpers.GetPropertyBackingWithout(this, name));
            }

            /// <inheritdoc />
            public EvaluateTransactionFailureIncompatibleEra RemoveProperty(ReadOnlySpan<byte> name)
            {
                return new(__CorvusObjectHelpers.GetPropertyBackingWithout(this, name));
            }
            ...
            private static class __CorvusObjectHelpers
            {
                ...
                /// <exception cref="InvalidOperationException">The value is not an object.</exception>
                public static ImmutableList<JsonObjectProperty> GetPropertyBacking(in EvaluateTransactionFailureIncompatibleEra that)
                {
                ...
                /// <exception cref="InvalidOperationException">The value is not an object.</exception>
                public static ImmutableList<JsonObjectProperty> GetPropertyBackingWithout(in EvaluateTransactionFailureIncompatibleEra that, in JsonPropertyName name)
                {
                    if ((that.backing & Backing.Object) != 0)
                    {
                ...
                /// <returns>An immutable list of <see cref="JsonObjectProperty"/>, built from the existing object, without the given property.</returns>
                /// <exception cref="InvalidOperationException">The value is not an object.</exception>
                public static ImmutableList<JsonObjectProperty> GetPropertyBackingWithout(in EvaluateTransactionFailureIncompatibleEra that, ReadOnlySpan<char> name)
                {
                    if ((that.backing & Backing.Object) != 0)
                    {
                        return that.objectBacking.Remove(name);
                ...
                /// <returns>An immutable list of <see cref="JsonObjectProperty"/>, built from the existing object, without the given property.</returns>
                /// <exception cref="InvalidOperationException">The value is not an object.</exception>
                public static ImmutableList<JsonObjectProperty> GetPropertyBackingWithout(in EvaluateTransactionFailureIncompatibleEra that, ReadOnlySpan<byte> name)
                {
                    if ((that.backing & Backing.Object) != 0)
                    {
                        return that.objectBacking.Remove(name);
                ...
                /// <returns>An immutable list of <see cref="JsonObjectProperty"/>, built from the existing object, without the given property.</returns>
                /// <exception cref="InvalidOperationException">The value is not an object.</exception>
                public static ImmutableList<JsonObjectProperty> GetPropertyBackingWithout(in EvaluateTransactionFailureIncompatibleEra that, string name)
                {
                    if ((that.backing & Backing.Object) != 0)
                    {
                        return that.objectBacking.Remove(name);
                ...
                /// <exception cref="InvalidOperationException">The value is not an object.</exception>
                public static ImmutableList<JsonObjectProperty> GetPropertyBackingWith(in EvaluateTransactionFailureIncompatibleEra that, in JsonPropertyName name, in JsonAny value)
                {
                    if ((that.backing & Backing.Object) != 0)
                    {
