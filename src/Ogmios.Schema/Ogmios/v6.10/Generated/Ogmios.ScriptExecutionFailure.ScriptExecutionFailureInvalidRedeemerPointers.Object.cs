...
public readonly partial struct Ogmios
{
    ...
    public readonly partial struct ScriptExecutionFailure
    {
        ...
        public readonly partial struct ScriptExecutionFailureInvalidRedeemerPointers
            : IJsonObject<Generated.Ogmios.ScriptExecutionFailure.ScriptExecutionFailureInvalidRedeemerPointers>
        {
            /// <summary>
            /// Conversion from <see cref="ImmutableList{JsonObjectProperty}"/>.
            /// </summary>
            /// <param name="value">The value from which to convert.</param>
            public static implicit operator ScriptExecutionFailureInvalidRedeemerPointers(ImmutableList<JsonObjectProperty> value)
            {
                return new(value);
            }
            ...
            /// </summary>
            /// <param name="value">The value from which to convert.</param>
            public static implicit operator ImmutableList<JsonObjectProperty>(ScriptExecutionFailureInvalidRedeemerPointers value)
            {
                return
            ...
            /// </summary>
            /// <param name="value">The value from which to convert.</param>
            public static implicit operator ScriptExecutionFailureInvalidRedeemerPointers(JsonObject value)
            {
            ...
            /// </summary>
            /// <param name="value">The value from which to convert.</param>
            public static implicit operator JsonObject(ScriptExecutionFailureInvalidRedeemerPointers value)
            {
                return
                    value.AsObject;
            }
            ...
            /// </para>
            /// </remarks>
            public Generated.Ogmios.ScriptExecutionFailure.ScriptExecutionFailureInvalidRedeemerPointers.CodeEntity Code
            {
                get
                {
                    if ((this.backing & Backing.JsonElement) != 0)
                    ...
                    if ((this.backing & Backing.Object) != 0)
                    {
                        ...
                        {
                            return result.As<Generated.Ogmios.ScriptExecutionFailure.ScriptExecutionFailureInvalidRedeemerPointers.CodeEntity>();
                        }
                    }
            ...
            /// </para>
            /// </remarks>
            public Generated.Ogmios.ScriptExecutionFailure.ScriptExecutionFailureInvalidRedeemerPointers.RequiredMissingScripts Data
            {
                get
                {
                    if ((this.backing & Backing.JsonElement) != 0)
                    ...
                    if ((this.backing & Backing.Object) != 0)
                    {
                        ...
                        {
                            return result.As<Generated.Ogmios.ScriptExecutionFailure.ScriptExecutionFailureInvalidRedeemerPointers.RequiredMissingScripts>();
                        }
                    }
            ...
            /// <inheritdoc/>
            public static ScriptExecutionFailureInvalidRedeemerPointers FromProperties(IDictionary<JsonPropertyName, JsonAny> source)
            {
                return new(source.Select(kvp => new JsonObjectProperty(kvp.Key, kvp.Value)).ToImmutableList());
            }

            /// <inheritdoc/>
            public static ScriptExecutionFailureInvalidRedeemerPointers FromProperties(params (JsonPropertyName Name, JsonAny Value)[] source)
            {
            ...
            public static ScriptExecutionFailureInvalidRedeemerPointers FromProperties(ImmutableList<JsonObjectProperty> source)
            {
                return new(source);
            }

            /// <summary>
            /// Creates an instance of a <see cref="ScriptExecutionFailureInvalidRedeemerPointers"/>.
            /// </summary>
            public static ScriptExecutionFailureInvalidRedeemerPointers Create(
                in Generated.Ogmios.ScriptExecutionFailure.ScriptExecutionFailureInvalidRedeemerPointers.CodeEntity code,
                in Generated.Ogmios.ScriptExecutionFailure.ScriptExecutionFailureInvalidRedeemerPointers.RequiredMissingScripts data,
            ...
            public ScriptExecutionFailureInvalidRedeemerPointers WithCode(in Generated.Ogmios.ScriptExecutionFailure.ScriptExecutionFailureInvalidRedeemerPointers.CodeEntity value)
            {
            ...
            /// <param name="value">The new property value</param>
            /// <returns>The instance with the property set.</returns>
            public ScriptExecutionFailureInvalidRedeemerPointers WithData(in Generated.Ogmios.ScriptExecutionFailure.ScriptExecutionFailureInvalidRedeemerPointers.RequiredMissingScripts value)
            {
            ...
            /// <param name="value">The new property value</param>
            /// <returns>The instance with the property set.</returns>
            public ScriptExecutionFailureInvalidRedeemerPointers WithMessage(in Corvus.Json.JsonString value)
            {
            ...
            /// <inheritdoc />
            public ScriptExecutionFailureInvalidRedeemerPointers SetProperty<TValue>(in JsonPropertyName name, TValue value)
            ...
            /// <inheritdoc />
            public ScriptExecutionFailureInvalidRedeemerPointers RemoveProperty(in JsonPropertyName name)
            {
                return new(__CorvusObjectHelpers.GetPropertyBackingWithout(this, name));
            }

            /// <inheritdoc />
            public ScriptExecutionFailureInvalidRedeemerPointers RemoveProperty(string name)
            {
                return new(__CorvusObjectHelpers.GetPropertyBackingWithout(this, name));
            }

            /// <inheritdoc />
            public ScriptExecutionFailureInvalidRedeemerPointers RemoveProperty(ReadOnlySpan<char> name)
            {
                return new(__CorvusObjectHelpers.GetPropertyBackingWithout(this, name));
            }

            /// <inheritdoc />
            public ScriptExecutionFailureInvalidRedeemerPointers RemoveProperty(ReadOnlySpan<byte> name)
            {
                return new(__CorvusObjectHelpers.GetPropertyBackingWithout(this, name));
            }
            ...
            private static class __CorvusObjectHelpers
            {
                ...
                /// <exception cref="InvalidOperationException">The value is not an object.</exception>
                public static ImmutableList<JsonObjectProperty> GetPropertyBacking(in ScriptExecutionFailureInvalidRedeemerPointers that)
                {
                ...
                /// <exception cref="InvalidOperationException">The value is not an object.</exception>
                public static ImmutableList<JsonObjectProperty> GetPropertyBackingWithout(in ScriptExecutionFailureInvalidRedeemerPointers that, in JsonPropertyName name)
                {
                    if ((that.backing & Backing.Object) != 0)
                    {
                ...
                /// <returns>An immutable list of <see cref="JsonObjectProperty"/>, built from the existing object, without the given property.</returns>
                /// <exception cref="InvalidOperationException">The value is not an object.</exception>
                public static ImmutableList<JsonObjectProperty> GetPropertyBackingWithout(in ScriptExecutionFailureInvalidRedeemerPointers that, ReadOnlySpan<char> name)
                {
                    if ((that.backing & Backing.Object) != 0)
                    {
                        return that.objectBacking.Remove(name);
                ...
                /// <returns>An immutable list of <see cref="JsonObjectProperty"/>, built from the existing object, without the given property.</returns>
                /// <exception cref="InvalidOperationException">The value is not an object.</exception>
                public static ImmutableList<JsonObjectProperty> GetPropertyBackingWithout(in ScriptExecutionFailureInvalidRedeemerPointers that, ReadOnlySpan<byte> name)
                {
                    if ((that.backing & Backing.Object) != 0)
                    {
                        return that.objectBacking.Remove(name);
                ...
                /// <returns>An immutable list of <see cref="JsonObjectProperty"/>, built from the existing object, without the given property.</returns>
                /// <exception cref="InvalidOperationException">The value is not an object.</exception>
                public static ImmutableList<JsonObjectProperty> GetPropertyBackingWithout(in ScriptExecutionFailureInvalidRedeemerPointers that, string name)
                {
                    if ((that.backing & Backing.Object) != 0)
                    {
                        return that.objectBacking.Remove(name);
                ...
                /// <exception cref="InvalidOperationException">The value is not an object.</exception>
                public static ImmutableList<JsonObjectProperty> GetPropertyBackingWith(in ScriptExecutionFailureInvalidRedeemerPointers that, in JsonPropertyName name, in JsonAny value)
                {
                    if ((that.backing & Backing.Object) != 0)
                    {
