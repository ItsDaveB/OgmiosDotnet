                ...
                public readonly partial struct RequiredMembersAndQuorum
                {
                    ...
                    public ValidationContext Validate(in ValidationContext validationContext, ValidationLevel level = ValidationLevel.Flag)
                    {
                        ...
                        if (level > ValidationLevel.Basic)
                        {
                            ...
                            result = result.PushSchemaLocation("https://endjin.com/Users/davebeaumont/source/cardano-public/OgmiosDotnet/src/Ogmios.Schema/Ogmios/v6.10/Source/ogmios.json#/properties/QueryLedgerStateConstitutionalCommitteeResponse/oneOf/0/properties/result/oneOf/1");
                        }
                            ...
                            ValidationLevel level = ValidationLevel.Flag)
                        {
                            ...
                            foreach (JsonObjectProperty property in value.EnumerateObject())
                            {
                                ...
                                if (property.NameEquals(JsonPropertyNames.MembersUtf8, JsonPropertyNames.Members))
                                {
                                    ...
                                    ValidationContext propertyResult = property.Value.As<Generated.Ogmios.QueryLedgerStateConstitutionalCommitteeResponseEntity.QueryLedgerStateConstitutionalCommitteeResponse.ResultEntity.RequiredMembersAndQuorum.ConstitutionalCommitteeMemberArray>().Validate(result.CreateChildContext(), level);
                                ...
                                else if (property.NameEquals(JsonPropertyNames.QuorumUtf8, JsonPropertyNames.Quorum))
                                {
                                    ...
                                    if (level > ValidationLevel.Basic)
                                    {
                                        result = result.PushValidationLocationReducedPathModifierAndProperty(new("#/properties/quorum"), JsonPropertyNames.Quorum);
                                    }

                                    ValidationContext propertyResult = property.Value.As<Generated.Ogmios.QueryLedgerStateConstitutionalCommitteeResponseEntity.QueryLedgerStateConstitutionalCommitteeResponse.ResultEntity.RequiredMembersAndQuorum.QuorumEntity>().Validate(result.CreateChildContext(), level);
                                    if (level == ValidationLevel.Flag && !propertyResult.IsValid)
                                    {
                                        return propertyResult;
                                    }
