...
public readonly partial struct Ogmios
{
    ...
    public readonly partial struct EvaluateTransactionFailure
    {
        ...
        public readonly partial struct EvaluateTransactionFailureNodeTipTooOld
            : IJsonObject<Generated.Ogmios.EvaluateTransactionFailure.EvaluateTransactionFailureNodeTipTooOld>
        {
            /// <summary>
            /// Conversion from <see cref="ImmutableList{JsonObjectProperty}"/>.
            /// </summary>
            /// <param name="value">The value from which to convert.</param>
            public static implicit operator EvaluateTransactionFailureNodeTipTooOld(ImmutableList<JsonObjectProperty> value)
            {
                return new(value);
            }
            ...
            /// </summary>
            /// <param name="value">The value from which to convert.</param>
            public static implicit operator ImmutableList<JsonObjectProperty>(EvaluateTransactionFailureNodeTipTooOld value)
            {
                return
            ...
            /// </summary>
            /// <param name="value">The value from which to convert.</param>
            public static implicit operator EvaluateTransactionFailureNodeTipTooOld(JsonObject value)
            {
            ...
            /// </summary>
            /// <param name="value">The value from which to convert.</param>
            public static implicit operator JsonObject(EvaluateTransactionFailureNodeTipTooOld value)
            {
                return
                    value.AsObject;
            }
            ...
            /// </para>
            /// </remarks>
            public Generated.Ogmios.EvaluateTransactionFailure.EvaluateTransactionFailureNodeTipTooOld.CodeEntity Code
            {
                get
                {
                    if ((this.backing & Backing.JsonElement) != 0)
                    ...
                    if ((this.backing & Backing.Object) != 0)
                    {
                        ...
                        {
                            return result.As<Generated.Ogmios.EvaluateTransactionFailure.EvaluateTransactionFailureNodeTipTooOld.CodeEntity>();
                        }
                    }
            ...
            /// </para>
            /// </remarks>
            public Generated.Ogmios.EvaluateTransactionFailure.EvaluateTransactionFailureNodeTipTooOld.RequiredCurrentNodeEraAndMinimumRequiredEra Data
            {
                get
                {
                    if ((this.backing & Backing.JsonElement) != 0)
                    ...
                    if ((this.backing & Backing.Object) != 0)
                    {
                        ...
                        {
                            return result.As<Generated.Ogmios.EvaluateTransactionFailure.EvaluateTransactionFailureNodeTipTooOld.RequiredCurrentNodeEraAndMinimumRequiredEra>();
                        }
                    }
            ...
            /// <inheritdoc/>
            public static EvaluateTransactionFailureNodeTipTooOld FromProperties(IDictionary<JsonPropertyName, JsonAny> source)
            {
                return new(source.Select(kvp => new JsonObjectProperty(kvp.Key, kvp.Value)).ToImmutableList());
            }

            /// <inheritdoc/>
            public static EvaluateTransactionFailureNodeTipTooOld FromProperties(params (JsonPropertyName Name, JsonAny Value)[] source)
            {
            ...
            public static EvaluateTransactionFailureNodeTipTooOld FromProperties(ImmutableList<JsonObjectProperty> source)
            {
                return new(source);
            }

            /// <summary>
            /// Creates an instance of a <see cref="EvaluateTransactionFailureNodeTipTooOld"/>.
            /// </summary>
            public static EvaluateTransactionFailureNodeTipTooOld Create(
                in Generated.Ogmios.EvaluateTransactionFailure.EvaluateTransactionFailureNodeTipTooOld.CodeEntity code,
                in Generated.Ogmios.EvaluateTransactionFailure.EvaluateTransactionFailureNodeTipTooOld.RequiredCurrentNodeEraAndMinimumRequiredEra data,
            ...
            public EvaluateTransactionFailureNodeTipTooOld WithCode(in Generated.Ogmios.EvaluateTransactionFailure.EvaluateTransactionFailureNodeTipTooOld.CodeEntity value)
            {
            ...
            /// <param name="value">The new property value</param>
            /// <returns>The instance with the property set.</returns>
            public EvaluateTransactionFailureNodeTipTooOld WithData(in Generated.Ogmios.EvaluateTransactionFailure.EvaluateTransactionFailureNodeTipTooOld.RequiredCurrentNodeEraAndMinimumRequiredEra value)
            {
            ...
            /// <param name="value">The new property value</param>
            /// <returns>The instance with the property set.</returns>
            public EvaluateTransactionFailureNodeTipTooOld WithMessage(in Corvus.Json.JsonString value)
            {
            ...
            /// <inheritdoc />
            public EvaluateTransactionFailureNodeTipTooOld SetProperty<TValue>(in JsonPropertyName name, TValue value)
            ...
            /// <inheritdoc />
            public EvaluateTransactionFailureNodeTipTooOld RemoveProperty(in JsonPropertyName name)
            {
                return new(__CorvusObjectHelpers.GetPropertyBackingWithout(this, name));
            }

            /// <inheritdoc />
            public EvaluateTransactionFailureNodeTipTooOld RemoveProperty(string name)
            {
                return new(__CorvusObjectHelpers.GetPropertyBackingWithout(this, name));
            }

            /// <inheritdoc />
            public EvaluateTransactionFailureNodeTipTooOld RemoveProperty(ReadOnlySpan<char> name)
            {
                return new(__CorvusObjectHelpers.GetPropertyBackingWithout(this, name));
            }

            /// <inheritdoc />
            public EvaluateTransactionFailureNodeTipTooOld RemoveProperty(ReadOnlySpan<byte> name)
            {
                return new(__CorvusObjectHelpers.GetPropertyBackingWithout(this, name));
            }
            ...
            private static class __CorvusObjectHelpers
            {
                ...
                /// <exception cref="InvalidOperationException">The value is not an object.</exception>
                public static ImmutableList<JsonObjectProperty> GetPropertyBacking(in EvaluateTransactionFailureNodeTipTooOld that)
                {
                ...
                /// <exception cref="InvalidOperationException">The value is not an object.</exception>
                public static ImmutableList<JsonObjectProperty> GetPropertyBackingWithout(in EvaluateTransactionFailureNodeTipTooOld that, in JsonPropertyName name)
                {
                    if ((that.backing & Backing.Object) != 0)
                    {
                ...
                /// <returns>An immutable list of <see cref="JsonObjectProperty"/>, built from the existing object, without the given property.</returns>
                /// <exception cref="InvalidOperationException">The value is not an object.</exception>
                public static ImmutableList<JsonObjectProperty> GetPropertyBackingWithout(in EvaluateTransactionFailureNodeTipTooOld that, ReadOnlySpan<char> name)
                {
                    if ((that.backing & Backing.Object) != 0)
                    {
                        return that.objectBacking.Remove(name);
                ...
                /// <returns>An immutable list of <see cref="JsonObjectProperty"/>, built from the existing object, without the given property.</returns>
                /// <exception cref="InvalidOperationException">The value is not an object.</exception>
                public static ImmutableList<JsonObjectProperty> GetPropertyBackingWithout(in EvaluateTransactionFailureNodeTipTooOld that, ReadOnlySpan<byte> name)
                {
                    if ((that.backing & Backing.Object) != 0)
                    {
                        return that.objectBacking.Remove(name);
                ...
                /// <returns>An immutable list of <see cref="JsonObjectProperty"/>, built from the existing object, without the given property.</returns>
                /// <exception cref="InvalidOperationException">The value is not an object.</exception>
                public static ImmutableList<JsonObjectProperty> GetPropertyBackingWithout(in EvaluateTransactionFailureNodeTipTooOld that, string name)
                {
                    if ((that.backing & Backing.Object) != 0)
                    {
                        return that.objectBacking.Remove(name);
                ...
                /// <exception cref="InvalidOperationException">The value is not an object.</exception>
                public static ImmutableList<JsonObjectProperty> GetPropertyBackingWith(in EvaluateTransactionFailureNodeTipTooOld that, in JsonPropertyName name, in JsonAny value)
                {
                    if ((that.backing & Backing.Object) != 0)
                    {
