...
public readonly partial struct ScriptNative
{
    ...
    public readonly partial struct ClauseSome
    {
...

        {
            ...
            /// </summary>
            public static string SchemaLocation { get; } = "OgmiosDotnet/src/Ogmios.Schema/Ogmios/v6.11/Source/cardano.json#/definitions/Script<Native>/oneOf/3/properties/clause";
