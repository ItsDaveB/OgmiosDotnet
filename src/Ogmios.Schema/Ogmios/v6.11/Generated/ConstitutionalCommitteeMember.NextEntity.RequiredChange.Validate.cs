        ...
        public readonly partial struct RequiredChange
        {
            ...
            public ValidationContext Validate(in ValidationContext validationContext, ValidationLevel level = ValidationLevel.Flag)
            {
                ...
                if (level > ValidationLevel.Basic)
                {
                    ...
                    result = result.PushSchemaLocation("https://endjin.com/Users/davebeaumont/source/cardano-public/OgmiosDotnet/src/Ogmios.Schema/Ogmios/v6.11/Source/cardano.json#/definitions/ConstitutionalCommitteeMember/properties/next/oneOf/0");
                }
                    ...
                    ValidationLevel level = ValidationLevel.Flag)
                {
                    ...
                    foreach (JsonObjectProperty property in value.EnumerateObject())
                    {
                        ...
                        if (property.NameEquals(JsonPropertyNames.ChangeUtf8, JsonPropertyNames.Change))
                        {
                            ...
                            ValidationContext propertyResult = property.Value.As<Generated.ConstitutionalCommitteeMember.NextEntity.RequiredChange.ChangeEntity>().Validate(result.CreateChildContext(), level);
