                ...
                public readonly partial struct RequiredMetadataAndTypeArray
                {
                    ...
                    public readonly partial struct RequiredMetadataAndType
                    {
...

                        {
                            ...
                            /// </summary>
                            public static string SchemaLocation { get; } = "https://endjin.com/Users/davebeaumont/source/cardano-public/OgmiosDotnet/src/Ogmios.Schema/Ogmios/v6.11/Source/ogmios.json#/definitions/SubmitTransactionFailure/oneOf/60/properties/data/properties/invalidOrMissingPreviousProposals/items/properties/type";
                            ...
                            /// <param name="matchHardForkInitiation">Match 1st item.</param>
                            /// <param name="matchProtocolParametersUpdate">Match 2nd item.</param>
                            /// <param name="matchConstitutionalCommittee">Match 3rd item.</param>
                            /// <param name="matchConstitution">Match 4th item.</param>
                            /// <param name="defaultMatch">Match any other value.</param>
                            /// <returns>An instance of the value returned by the match function.</returns>
                            public TOut Match<TIn, TOut>(
                                in TIn context,
                                Func<TIn, TOut> matchHardForkInitiation,
                                Func<TIn, TOut> matchProtocolParametersUpdate,
                                Func<TIn, TOut> matchConstitutionalCommittee,
                                Func<TIn, TOut> matchConstitution,
                                Func<TIn, TOut> defaultMatch)
                            {
                                if (this.Equals(CorvusValidation.Enum1))
                                {
                                    return matchHardForkInitiation(context);
                                }

                                if (this.Equals(CorvusValidation.Enum2))
                                {
                                    return matchProtocolParametersUpdate(context);
                                }

                                if (this.Equals(CorvusValidation.Enum3))
                                {
                                    return matchConstitutionalCommittee(context);
                                }

                                if (this.Equals(CorvusValidation.Enum4))
                                {
                                    return matchConstitution(context);
                                }
                            ...
                            public TOut Match<TOut>(
                                Func<TOut> matchHardForkInitiation,
                                Func<TOut> matchProtocolParametersUpdate,
                                Func<TOut> matchConstitutionalCommittee,
                                Func<TOut> matchConstitution,
                                Func<TOut> defaultMatch)
                            {
                                if (this.Equals(CorvusValidation.Enum1))
                                {
                                    return matchHardForkInitiation();
                                }

                                if (this.Equals(CorvusValidation.Enum2))
                                {
                                    return matchProtocolParametersUpdate();
                                }

                                if (this.Equals(CorvusValidation.Enum3))
                                {
                                    return matchConstitutionalCommittee();
                                }

                                if (this.Equals(CorvusValidation.Enum4))
                                {
                                    return matchConstitution();
                                }
