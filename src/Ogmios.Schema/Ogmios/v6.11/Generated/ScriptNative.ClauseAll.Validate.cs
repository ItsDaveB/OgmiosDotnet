    ...
    public readonly partial struct ClauseAll
    {
        ...
        public ValidationContext Validate(in ValidationContext validationContext, ValidationLevel level = ValidationLevel.Flag)
        {
            ...
            if (level > ValidationLevel.Basic)
            {
                ...
                result = result.PushSchemaLocation("https://endjin.com/Users/davebeaumont/source/cardano-public/OgmiosDotnet/src/Ogmios.Schema/Ogmios/v6.11/Source/cardano.json#/definitions/Script<Native>/oneOf/2");
            }
                ...
                ValidationLevel level = ValidationLevel.Flag)
            {
                ...
                foreach (JsonObjectProperty property in value.EnumerateObject())
                {
                    ...
                    if (property.NameEquals(JsonPropertyNames.ClauseUtf8, JsonPropertyNames.Clause))
                    {
                        ...
                        ValidationContext propertyResult = property.Value.As<Generated.ScriptNative.ClauseAll.ClauseEntity>().Validate(result.CreateChildContext(), level);
                    ...
                    else if (property.NameEquals(JsonPropertyNames.FromUtf8, JsonPropertyNames.From))
                    {
                        ...
                        ValidationContext propertyResult = property.Value.As<Generated.ScriptNative.ClauseAll.ScriptNativeArray>().Validate(result.CreateChildContext(), level);
                        if (level == ValidationLevel.Flag && !propertyResult.IsValid)
                        {
                            return propertyResult;
                        }
