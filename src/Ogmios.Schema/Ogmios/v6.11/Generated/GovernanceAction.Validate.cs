...
public readonly partial struct GovernanceAction
{
    ...
    public ValidationContext Validate(in ValidationContext validationContext, ValidationLevel level = ValidationLevel.Flag)
    {
        ...
        if (level > ValidationLevel.Basic)
        {
            ...
            result = result.PushSchemaLocation("https://endjin.com/Users/davebeaumont/source/cardano-public/OgmiosDotnet/src/Ogmios.Schema/Ogmios/v6.11/Source/cardano.json#/definitions/GovernanceAction");
        }
    ...
    public static partial class CorvusValidation
    {
            ...
            ValidationLevel level = ValidationLevel.Flag)
        {
            ...
            ValidationContext oneOfResult0 = value.As<Generated.GovernanceAction.GovernanceActionProtocolParametersUpdate>().Validate(oneOfChildContext0, level);
            ...
            ValidationContext oneOfResult1 = value.As<Generated.GovernanceAction.GovernanceActionHardForkInitiation>().Validate(oneOfChildContext1, level);
            ...
            ValidationContext oneOfResult2 = value.As<Generated.GovernanceAction.GovernanceActionTreasuryTransfer>().Validate(oneOfChildContext2, level);
            ...
            ValidationContext oneOfResult3 = value.As<Generated.GovernanceAction.GovernanceActionTreasuryWithdrawals>().Validate(oneOfChildContext3, level);
            ...
            ValidationContext oneOfResult4 = value.As<Generated.GovernanceAction.GovernanceActionConstitutionalCommittee>().Validate(oneOfChildContext4, level);
            ...
            ValidationContext oneOfResult5 = value.As<Generated.GovernanceAction.GovernanceActionConstitution>().Validate(oneOfChildContext5, level);
            ...
            ValidationContext oneOfResult6 = value.As<Generated.GovernanceAction.GovernanceActionNoConfidence>().Validate(oneOfChildContext6, level);
            ...
            ValidationContext oneOfResult7 = value.As<Generated.GovernanceAction.GovernanceActionInformation>().Validate(oneOfChildContext7, level);
