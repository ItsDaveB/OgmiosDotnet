...
public readonly partial struct GovernanceVote
    : IJsonObject<Generated.GovernanceVote>
{
    /// <summary>
    /// Conversion from <see cref="ImmutableList{JsonObjectProperty}"/>.
    /// </summary>
    /// <param name="value">The value from which to convert.</param>
    public static implicit operator GovernanceVote(ImmutableList<JsonObjectProperty> value)
    {
        return new(value);
    }
    ...
    /// </summary>
    /// <param name="value">The value from which to convert.</param>
    public static implicit operator ImmutableList<JsonObjectProperty>(GovernanceVote value)
    {
        return
    ...
    /// </summary>
    /// <param name="value">The value from which to convert.</param>
    public static implicit operator GovernanceVote(JsonObject value)
    {
    ...
    /// </summary>
    /// <param name="value">The value from which to convert.</param>
    public static implicit operator JsonObject(GovernanceVote value)
    {
        return
            value.AsObject;
    }
    ...
    /// </para>
    /// </remarks>
    public Generated.GovernanceVoter Issuer
    {
        get
        {
            if ((this.backing & Backing.JsonElement) != 0)
            ...
            if ((this.backing & Backing.Object) != 0)
            {
                ...
                {
                    return result.As<Generated.GovernanceVoter>();
                }
            }
    ...
    /// <summary>
    /// Gets the (optional) <c>proposal</c> property.
    /// </summary>
    ...
    /// </para>
    /// </remarks>
    public Generated.GovernanceVote.VoteEntity Vote
    {
        get
        {
            if ((this.backing & Backing.JsonElement) != 0)
            {
                ...
                if (this.jsonElementBacking.TryGetProperty(JsonPropertyNames.VoteUtf8, out JsonElement result))
                {
                    return new(result);
                }
            }
            ...
            if ((this.backing & Backing.Object) != 0)
            {
                if (this.objectBacking.TryGetValue(JsonPropertyNames.Vote, out JsonAny result))
                {
                    return result.As<Generated.GovernanceVote.VoteEntity>();
                }
            }
    ...
    /// <inheritdoc/>
    public static GovernanceVote FromProperties(IDictionary<JsonPropertyName, JsonAny> source)
    {
        return new(source.Select(kvp => new JsonObjectProperty(kvp.Key, kvp.Value)).ToImmutableList());
    }

    /// <inheritdoc/>
    public static GovernanceVote FromProperties(params (JsonPropertyName Name, JsonAny Value)[] source)
    {
    ...
    public static GovernanceVote FromProperties(ImmutableList<JsonObjectProperty> source)
    {
        return new(source);
    }

    /// <summary>
    /// Creates an instance of a <see cref="GovernanceVote"/>.
    /// </summary>
    public static GovernanceVote Create(
        in Generated.GovernanceVoter issuer,
        in Generated.GovernanceVote.VoteEntity vote,
        in Generated.Anchor? metadata = null,
        in Generated.GovernanceProposalReference? proposal = null)
    {
        var builder = ImmutableList.CreateBuilder<JsonObjectProperty>();
        builder.Add(JsonPropertyNames.Issuer, issuer.AsAny);
        builder.Add(JsonPropertyNames.Vote, vote.AsAny);
        ...
        {
            builder.Add(JsonPropertyNames.Proposal, proposal.Value.AsAny);
        }
    ...
    public GovernanceVote WithIssuer(in Generated.GovernanceVoter value)
    {
    ...
    /// <param name="value">The new property value</param>
    /// <returns>The instance with the property set.</returns>
    public GovernanceVote WithMetadata(in Generated.Anchor value)
    {
        return this.SetProperty(JsonPropertyNames.Metadata, value);
    }

    /// <summary>
    /// Sets the (optional) <c>proposal</c> property.
    /// </summary>
    /// <param name="value">The new property value</param>
    /// <returns>The instance with the property set.</returns>
    public GovernanceVote WithProposal(in Generated.GovernanceProposalReference value)
    {
        return this.SetProperty(JsonPropertyNames.Proposal, value);
    }

    /// <summary>
    /// Sets the <c>vote</c> property.
    /// </summary>
    /// <param name="value">The new property value</param>
    /// <returns>The instance with the property set.</returns>
    public GovernanceVote WithVote(in Generated.GovernanceVote.VoteEntity value)
    {
        return this.SetProperty(JsonPropertyNames.Vote, value);
    }
    ...
    /// <inheritdoc />
    public GovernanceVote SetProperty<TValue>(in JsonPropertyName name, TValue value)
    ...
    /// <inheritdoc />
    public GovernanceVote RemoveProperty(in JsonPropertyName name)
    {
        return new(__CorvusObjectHelpers.GetPropertyBackingWithout(this, name));
    }

    /// <inheritdoc />
    public GovernanceVote RemoveProperty(string name)
    {
        return new(__CorvusObjectHelpers.GetPropertyBackingWithout(this, name));
    }

    /// <inheritdoc />
    public GovernanceVote RemoveProperty(ReadOnlySpan<char> name)
    {
        return new(__CorvusObjectHelpers.GetPropertyBackingWithout(this, name));
    }

    /// <inheritdoc />
    public GovernanceVote RemoveProperty(ReadOnlySpan<byte> name)
    {
        return new(__CorvusObjectHelpers.GetPropertyBackingWithout(this, name));
    }
    ...
    public static class JsonPropertyNames
    {
        ...
        /// <summary>
        /// Gets the JSON property name for <see cref="Vote"/>.
        /// </summary>
        ...
        /// Gets the JSON property name for <see cref="Vote"/>.
        /// </summary>
        public static ReadOnlySpan<byte> VoteUtf8 => "vote"u8;
    }
    ...
    private static class __CorvusObjectHelpers
    {
        ...
        /// <exception cref="InvalidOperationException">The value is not an object.</exception>
        public static ImmutableList<JsonObjectProperty> GetPropertyBacking(in GovernanceVote that)
        {
        ...
        /// <exception cref="InvalidOperationException">The value is not an object.</exception>
        public static ImmutableList<JsonObjectProperty> GetPropertyBackingWithout(in GovernanceVote that, in JsonPropertyName name)
        {
            if ((that.backing & Backing.Object) != 0)
            {
        ...
        /// <returns>An immutable list of <see cref="JsonObjectProperty"/>, built from the existing object, without the given property.</returns>
        /// <exception cref="InvalidOperationException">The value is not an object.</exception>
        public static ImmutableList<JsonObjectProperty> GetPropertyBackingWithout(in GovernanceVote that, ReadOnlySpan<char> name)
        {
            if ((that.backing & Backing.Object) != 0)
            {
                return that.objectBacking.Remove(name);
        ...
        /// <returns>An immutable list of <see cref="JsonObjectProperty"/>, built from the existing object, without the given property.</returns>
        /// <exception cref="InvalidOperationException">The value is not an object.</exception>
        public static ImmutableList<JsonObjectProperty> GetPropertyBackingWithout(in GovernanceVote that, ReadOnlySpan<byte> name)
        {
            if ((that.backing & Backing.Object) != 0)
            {
                return that.objectBacking.Remove(name);
        ...
        /// <returns>An immutable list of <see cref="JsonObjectProperty"/>, built from the existing object, without the given property.</returns>
        /// <exception cref="InvalidOperationException">The value is not an object.</exception>
        public static ImmutableList<JsonObjectProperty> GetPropertyBackingWithout(in GovernanceVote that, string name)
        {
            if ((that.backing & Backing.Object) != 0)
            {
                return that.objectBacking.Remove(name);
        ...
        /// <exception cref="InvalidOperationException">The value is not an object.</exception>
        public static ImmutableList<JsonObjectProperty> GetPropertyBackingWith(in GovernanceVote that, in JsonPropertyName name, in JsonAny value)
        {
            if ((that.backing & Backing.Object) != 0)
            {
