...
public readonly partial struct Ogmios
{
    ...
    public readonly partial struct AcquireLedgerStateFailure
    {
        ...
        public readonly partial struct UnableToAcquireTheLedgerStateAtTheRequestPoint
            : IJsonObject<Generated.Ogmios.AcquireLedgerStateFailure.UnableToAcquireTheLedgerStateAtTheRequestPoint>
        {
            /// <summary>
            /// Conversion from <see cref="ImmutableList{JsonObjectProperty}"/>.
            /// </summary>
            /// <param name="value">The value from which to convert.</param>
            public static implicit operator UnableToAcquireTheLedgerStateAtTheRequestPoint(ImmutableList<JsonObjectProperty> value)
            {
                return new(value);
            }
            ...
            /// </summary>
            /// <param name="value">The value from which to convert.</param>
            public static implicit operator ImmutableList<JsonObjectProperty>(UnableToAcquireTheLedgerStateAtTheRequestPoint value)
            {
                return
            ...
            /// </summary>
            /// <param name="value">The value from which to convert.</param>
            public static implicit operator UnableToAcquireTheLedgerStateAtTheRequestPoint(JsonObject value)
            {
            ...
            /// </summary>
            /// <param name="value">The value from which to convert.</param>
            public static implicit operator JsonObject(UnableToAcquireTheLedgerStateAtTheRequestPoint value)
            {
                return
                    value.AsObject;
            }
            ...
            /// </para>
            /// </remarks>
            public Generated.Ogmios.AcquireLedgerStateFailure.UnableToAcquireTheLedgerStateAtTheRequestPoint.CodeEntity Code
            {
                get
                {
                    if ((this.backing & Backing.JsonElement) != 0)
                    ...
                    if ((this.backing & Backing.Object) != 0)
                    {
                        ...
                        {
                            return result.As<Generated.Ogmios.AcquireLedgerStateFailure.UnableToAcquireTheLedgerStateAtTheRequestPoint.CodeEntity>();
                        }
                    }
            ...
            /// <inheritdoc/>
            public static UnableToAcquireTheLedgerStateAtTheRequestPoint FromProperties(IDictionary<JsonPropertyName, JsonAny> source)
            {
                return new(source.Select(kvp => new JsonObjectProperty(kvp.Key, kvp.Value)).ToImmutableList());
            }

            /// <inheritdoc/>
            public static UnableToAcquireTheLedgerStateAtTheRequestPoint FromProperties(params (JsonPropertyName Name, JsonAny Value)[] source)
            {
            ...
            public static UnableToAcquireTheLedgerStateAtTheRequestPoint FromProperties(ImmutableList<JsonObjectProperty> source)
            {
                return new(source);
            }

            /// <summary>
            /// Creates an instance of a <see cref="UnableToAcquireTheLedgerStateAtTheRequestPoint"/>.
            /// </summary>
            public static UnableToAcquireTheLedgerStateAtTheRequestPoint Create(
                in Generated.Ogmios.AcquireLedgerStateFailure.UnableToAcquireTheLedgerStateAtTheRequestPoint.CodeEntity code,
            ...
            public UnableToAcquireTheLedgerStateAtTheRequestPoint WithCode(in Generated.Ogmios.AcquireLedgerStateFailure.UnableToAcquireTheLedgerStateAtTheRequestPoint.CodeEntity value)
            {
            ...
            /// </para>
            /// </remarks>
            public UnableToAcquireTheLedgerStateAtTheRequestPoint WithData(in Corvus.Json.JsonString value)
            {
            ...
            /// <param name="value">The new property value</param>
            /// <returns>The instance with the property set.</returns>
            public UnableToAcquireTheLedgerStateAtTheRequestPoint WithMessage(in Corvus.Json.JsonString value)
            {
            ...
            /// <inheritdoc />
            public UnableToAcquireTheLedgerStateAtTheRequestPoint SetProperty<TValue>(in JsonPropertyName name, TValue value)
            ...
            /// <inheritdoc />
            public UnableToAcquireTheLedgerStateAtTheRequestPoint RemoveProperty(in JsonPropertyName name)
            {
                return new(__CorvusObjectHelpers.GetPropertyBackingWithout(this, name));
            }

            /// <inheritdoc />
            public UnableToAcquireTheLedgerStateAtTheRequestPoint RemoveProperty(string name)
            {
                return new(__CorvusObjectHelpers.GetPropertyBackingWithout(this, name));
            }

            /// <inheritdoc />
            public UnableToAcquireTheLedgerStateAtTheRequestPoint RemoveProperty(ReadOnlySpan<char> name)
            {
                return new(__CorvusObjectHelpers.GetPropertyBackingWithout(this, name));
            }

            /// <inheritdoc />
            public UnableToAcquireTheLedgerStateAtTheRequestPoint RemoveProperty(ReadOnlySpan<byte> name)
            {
                return new(__CorvusObjectHelpers.GetPropertyBackingWithout(this, name));
            }
            ...
            private static class __CorvusObjectHelpers
            {
                ...
                /// <exception cref="InvalidOperationException">The value is not an object.</exception>
                public static ImmutableList<JsonObjectProperty> GetPropertyBacking(in UnableToAcquireTheLedgerStateAtTheRequestPoint that)
                {
                ...
                /// <exception cref="InvalidOperationException">The value is not an object.</exception>
                public static ImmutableList<JsonObjectProperty> GetPropertyBackingWithout(in UnableToAcquireTheLedgerStateAtTheRequestPoint that, in JsonPropertyName name)
                {
                    if ((that.backing & Backing.Object) != 0)
                    {
                ...
                /// <returns>An immutable list of <see cref="JsonObjectProperty"/>, built from the existing object, without the given property.</returns>
                /// <exception cref="InvalidOperationException">The value is not an object.</exception>
                public static ImmutableList<JsonObjectProperty> GetPropertyBackingWithout(in UnableToAcquireTheLedgerStateAtTheRequestPoint that, ReadOnlySpan<char> name)
                {
                    if ((that.backing & Backing.Object) != 0)
                    {
                        return that.objectBacking.Remove(name);
                ...
                /// <returns>An immutable list of <see cref="JsonObjectProperty"/>, built from the existing object, without the given property.</returns>
                /// <exception cref="InvalidOperationException">The value is not an object.</exception>
                public static ImmutableList<JsonObjectProperty> GetPropertyBackingWithout(in UnableToAcquireTheLedgerStateAtTheRequestPoint that, ReadOnlySpan<byte> name)
                {
                    if ((that.backing & Backing.Object) != 0)
                    {
                        return that.objectBacking.Remove(name);
                ...
                /// <returns>An immutable list of <see cref="JsonObjectProperty"/>, built from the existing object, without the given property.</returns>
                /// <exception cref="InvalidOperationException">The value is not an object.</exception>
                public static ImmutableList<JsonObjectProperty> GetPropertyBackingWithout(in UnableToAcquireTheLedgerStateAtTheRequestPoint that, string name)
                {
                    if ((that.backing & Backing.Object) != 0)
                    {
                        return that.objectBacking.Remove(name);
                ...
                /// <exception cref="InvalidOperationException">The value is not an object.</exception>
                public static ImmutableList<JsonObjectProperty> GetPropertyBackingWith(in UnableToAcquireTheLedgerStateAtTheRequestPoint that, in JsonPropertyName name, in JsonAny value)
                {
                    if ((that.backing & Backing.Object) != 0)
                    {
