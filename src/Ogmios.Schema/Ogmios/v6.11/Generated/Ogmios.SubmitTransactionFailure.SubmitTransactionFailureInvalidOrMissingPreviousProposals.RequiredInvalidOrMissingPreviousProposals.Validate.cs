            ...
            public readonly partial struct RequiredInvalidOrMissingPreviousProposals
            {
                ...
                public ValidationContext Validate(in ValidationContext validationContext, ValidationLevel level = ValidationLevel.Flag)
                {
                    ...
                    if (level > ValidationLevel.Basic)
                    {
                        ...
                        result = result.PushSchemaLocation("https://endjin.com/Users/davebeaumont/source/cardano-public/OgmiosDotnet/src/Ogmios.Schema/Ogmios/v6.11/Source/ogmios.json#/definitions/SubmitTransactionFailure/oneOf/60/properties/data");
                    }
                ...
                public static partial class CorvusValidation
                {
                    ...
                    internal static ValidationContext ObjectValidationHandler(
                        in RequiredInvalidOrMissingPreviousProposals value,
                        JsonValueKind valueKind,
                        in ValidationContext validationContext,
                        ValidationLevel level = ValidationLevel.Flag)
                    {
                        ...
                        bool hasSeenInvalidOrMissingPreviousProposals = false;
                        ...
                        foreach (JsonObjectProperty property in value.EnumerateObject())
                        {
                            ...
                            if (property.NameEquals(JsonPropertyNames.InvalidOrMissingPreviousProposalsUtf8, JsonPropertyNames.InvalidOrMissingPreviousProposals))
                            {
                                hasSeenInvalidOrMissingPreviousProposals = true;
                                result = result.WithLocalProperty(propertyCount);
                                if (level > ValidationLevel.Basic)
                                {
                                    result = result.PushValidationLocationReducedPathModifierAndProperty(new("#/properties/invalidOrMissingPreviousProposals"), JsonPropertyNames.InvalidOrMissingPreviousProposals);
                                }

                                ValidationContext propertyResult = property.Value.As<Generated.Ogmios.SubmitTransactionFailure.SubmitTransactionFailureInvalidOrMissingPreviousProposals.RequiredInvalidOrMissingPreviousProposals.RequiredMetadataAndTypeArray>().Validate(result.CreateChildContext(), level);
                        ...
                        if (!hasSeenInvalidOrMissingPreviousProposals)
                        {
                            if (level >= ValidationLevel.Basic)
                            {
                                result = result.WithResult(isValid: false, "Validation properties - the required property 'invalidOrMissingPreviousProposals' was not present.");
                            }
                            else
                            {
                        ...
                        {
                            result = result.WithResult(isValid: true, "Validation properties - the required property 'invalidOrMissingPreviousProposals' was present.");
                        }
