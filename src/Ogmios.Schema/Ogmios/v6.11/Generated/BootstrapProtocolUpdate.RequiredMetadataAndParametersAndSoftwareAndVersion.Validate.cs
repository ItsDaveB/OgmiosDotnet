    ...
    public readonly partial struct RequiredMetadataAndParametersAndSoftwareAndVersion
    {
        ...
        public ValidationContext Validate(in ValidationContext validationContext, ValidationLevel level = ValidationLevel.Flag)
        {
            ...
            if (level > ValidationLevel.Basic)
            {
                ...
                result = result.PushSchemaLocation("https://endjin.com/Users/davebeaumont/source/cardano-public/OgmiosDotnet/src/Ogmios.Schema/Ogmios/v6.11/Source/cardano.json#/definitions/BootstrapProtocolUpdate/properties/proposal");
            }
        ...
        public static partial class CorvusValidation
        {
            ...
            internal static ValidationContext ObjectValidationHandler(
                in RequiredMetadataAndParametersAndSoftwareAndVersion value,
                JsonValueKind valueKind,
                in ValidationContext validationContext,
                ValidationLevel level = ValidationLevel.Flag)
            {
                ...
                foreach (JsonObjectProperty property in value.EnumerateObject())
                {
                    ...
                    if (property.NameEquals(JsonPropertyNames.MetadataUtf8, JsonPropertyNames.Metadata))
                    {
                        ...
                        ValidationContext propertyResult = property.Value.As<Generated.BootstrapProtocolUpdate.RequiredMetadataAndParametersAndSoftwareAndVersion.MetadataEntity>().Validate(result.CreateChildContext(), level);
                    ...
                    else if (property.NameEquals(JsonPropertyNames.ParametersUtf8, JsonPropertyNames.Parameters))
                    {
                        ...
                        ValidationContext propertyResult = property.Value.As<Generated.BootstrapProtocolParameters>().Validate(result.CreateChildContext(), level);
                        if (level == ValidationLevel.Flag && !propertyResult.IsValid)
                        {
                            return propertyResult;
                        }
