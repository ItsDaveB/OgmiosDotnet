    ...
    public readonly partial struct ScriptPurposePropose
    {
        ...
        public ValidationContext Validate(in ValidationContext validationContext, ValidationLevel level = ValidationLevel.Flag)
        {
            ...
            if (level > ValidationLevel.Basic)
            {
                ...
                result = result.PushSchemaLocation("https://endjin.com/Users/davebeaumont/source/cardano-public/OgmiosDotnet/src/Ogmios.Schema/Ogmios/v6.11/Source/cardano.json#/definitions/ScriptPurpose/oneOf/4");
            }
                ...
                ValidationLevel level = ValidationLevel.Flag)
            {
                ...
                foreach (JsonObjectProperty property in value.EnumerateObject())
                {
                    ...
                    if (property.NameEquals(JsonPropertyNames.ProposalUtf8, JsonPropertyNames.Proposal))
                    {
                        ...
                        ValidationContext propertyResult = property.Value.As<Generated.GovernanceProposal>().Validate(result.CreateChildContext(), level);
                    ...
                    else if (property.NameEquals(JsonPropertyNames.PurposeUtf8, JsonPropertyNames.Purpose))
                    {
                        ...
                        ValidationContext propertyResult = property.Value.As<Generated.ScriptPurpose.ScriptPurposePropose.PurposeEntity>().Validate(result.CreateChildContext(), level);
                        if (level == ValidationLevel.Flag && !propertyResult.IsValid)
                        {
                            return propertyResult;
                        }
