...
/// </summary>
#if NET8_0_OR_GREATER
[CollectionBuilder(typeof(CostModel), "Create")]
#endif
public readonly partial struct CostModel
    : IJsonArray<Generated.CostModel>,
      IReadOnlyCollection<Generated.Int64>
{
    /// <summary>
    /// Gets an empty array.
    /// </summary>
    public static CostModel EmptyArray { get; } = From(ImmutableList<JsonAny>.Empty);
    ...
    /// <inheritdoc/>
    Corvus.Json.JsonAny IJsonArray<CostModel>.this[int index]
    {
        get
        {
    ...
    public Generated.Int64 this[int index]
    {
        get
        {
            if ((this.backing & Backing.JsonElement) != 0)
            ...
            if ((this.backing & Backing.Array) != 0)
            {
                try
                {
                    return this.arrayBacking[index].As<Generated.Int64>();
                }
                catch (ArgumentOutOfRangeException ex)
                {
                    throw new IndexOutOfRangeException(ex.Message, ex);
    ...
    public static implicit operator CostModel(ImmutableList<JsonAny> value)
    {
        return new(value);
    }
    ...
    /// </summary>
    /// <param name="value">The value from which to convert.</param>
    public static implicit operator ImmutableList<JsonAny>(CostModel value)
    {
        return
    ...
    /// </summary>
    /// <param name="value">The value from which to convert.</param>
    public static implicit operator CostModel(JsonArray value)
    {
    ...
    /// </summary>
    /// <param name="value">The value from which to convert.</param>
    public static implicit operator JsonArray(CostModel value)
    {
        return
            value.AsArray;
    }
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="CostModel"/> struct.
    /// </summary>
    ...
    public static CostModel From(ImmutableList<JsonAny> items)
    {
        return new(items);
    }

    /// <summary>
    /// Create an new instance of the <see cref="CostModel"/>" struct from a span of items.
    /// </summary>
    ...
    public static CostModel Create(ReadOnlySpan<Generated.Int64> items)
    {
        return new([..items]);
    }
    ...
    public static CostModel FromItems(params Generated.Int64[] items)
    {
        return new([..items]);
    }
    ...
    public static CostModel FromItems(in Generated.Int64 item1)
    {
    ...
    /// <returns>An instance of the array constructed from the values.</returns>
    public static CostModel FromItems(in Generated.Int64 item1, in Generated.Int64 item2)
    {
    ...
    /// <returns>An instance of the array constructed from the values.</returns>
    public static CostModel FromItems(in Generated.Int64 item1, in Generated.Int64 item2, in Generated.Int64 item3)
    {
    ...
    /// <returns>An instance of the array constructed from the values.</returns>
    public static CostModel FromItems(in Generated.Int64 item1, in Generated.Int64 item2, in Generated.Int64 item3, in Generated.Int64 item4)
    {
    ...
    /// <returns>An instance of the array constructed from the values.</returns>
    public static CostModel FromItems(in Generated.Int64 item1, in Generated.Int64 item2, in Generated.Int64 item3, in Generated.Int64 item4, in Generated.Int64 item5)
    {
    ...
    /// <returns>An instance of the array constructed from the values.</returns>
    public static CostModel FromItems(in Generated.Int64 item1, in Generated.Int64 item2, in Generated.Int64 item3, in Generated.Int64 item4, in Generated.Int64 item5, in Generated.Int64 item6)
    {
    ...
    /// <returns>An instance of the array constructed from the values.</returns>
    public static CostModel FromItems(in Generated.Int64 item1, in Generated.Int64 item2, in Generated.Int64 item3, in Generated.Int64 item4, in Generated.Int64 item5, in Generated.Int64 item6, in Generated.Int64 item7)
    {
    ...
    public static CostModel FromRange(IEnumerable<Generated.Int64> items)
    {
        return new([..items]);
    }
    ...
    /// <param name="items">The items from which to construct the instance.</param>
    /// <returns>An instance of the array constructed from the items .</returns>
    static CostModel IJsonArray<CostModel>.FromRange(IEnumerable<JsonAny> items)
    {
        return new([..items]);
    }
    ...
    /// <param name="items">The items from which to construct the instance.</param>
    /// <returns>An instance of the array constructed from the items.</returns>
    static CostModel IJsonArray<CostModel>.FromRange<T>(IEnumerable<T> items)
    {
    ...
    /// <inheritdoc/>
    IEnumerator<Generated.Int64> IEnumerable<Generated.Int64>.GetEnumerator() => this.EnumerateArray();

    /// <inheritdoc/>
    IEnumerator IEnumerable.GetEnumerator() => this.EnumerateArray();

    /// <inheritdoc/>
    int IReadOnlyCollection<Generated.Int64>.Count => this.GetArrayLength();
    ...
    /// <inheritdoc/>
    public JsonArrayEnumerator<Generated.Int64> EnumerateArray()
    {
        if ((this.backing & Backing.JsonElement) != 0)
        {
    ...
    /// <inheritdoc/>
    JsonArrayEnumerator IJsonArray<CostModel>.EnumerateArray()
    {
        if ((this.backing & Backing.JsonElement) != 0)
        {
            return new(this.jsonElementBacking);
    ...
    /// <inheritdoc/>
    JsonArrayEnumerator<TItem> IJsonArray<CostModel>.EnumerateArray<TItem>()
    {
        if ((this.backing & Backing.JsonElement) != 0)
        {
            return new(this.jsonElementBacking);
    ...
    /// <inheritdoc/>
    CostModel IJsonArray<CostModel>.Add(in JsonAny item1)
    {
    ...
    /// <inheritdoc/>
    CostModel IJsonArray<CostModel>.Add(params JsonAny[] items)
    {
        ImmutableList<JsonAny>.Builder builder = __CorvusArrayHelpers.GetImmutableListBuilder(this);
    ...
    /// <inheritdoc/>
    CostModel IJsonArray<CostModel>.AddRange<TArray>(in TArray items)
    {
        ImmutableList<JsonAny>.Builder builder = __CorvusArrayHelpers.GetImmutableListBuilder(this);
    ...
    /// <inheritdoc/>
    CostModel IJsonArray<CostModel>.AddRange<TItem>(IEnumerable<TItem> items)
    {
        ImmutableList<JsonAny>.Builder builder = __CorvusArrayHelpers.GetImmutableListBuilder(this);
    ...
    /// <inheritdoc/>
    CostModel IJsonArray<CostModel>.AddRange(IEnumerable<JsonAny> items)
    {
        ImmutableList<JsonAny>.Builder builder = __CorvusArrayHelpers.GetImmutableListBuilder(this);
    ...
    /// <inheritdoc/>
    CostModel IJsonArray<CostModel>.Insert(int index, in JsonAny item1)
    {
        return new(__CorvusArrayHelpers.GetImmutableListWith(this, index, item1));
    }

    /// <inheritdoc/>
    CostModel IJsonArray<CostModel>.InsertRange<TArray>(int index, in TArray items)
    {
        return new(__CorvusArrayHelpers.GetImmutableListWith(this, index, items.EnumerateArray()));
    }

    /// <inheritdoc/>
    CostModel IJsonArray<CostModel>.InsertRange<TItem>(int index, IEnumerable<TItem> items)
    {
        return new(__CorvusArrayHelpers.GetImmutableListWith(this, index, items.Select(item => item.AsAny)));
    }

    /// <inheritdoc/>
    CostModel IJsonArray<CostModel>.InsertRange(int index, IEnumerable<JsonAny> items)
    {
        return new(__CorvusArrayHelpers.GetImmutableListWith(this, index, items));
    }

    /// <inheritdoc/>
    CostModel IJsonArray<CostModel>.Replace(in JsonAny oldValue, in JsonAny newValue)
    {
        return new(__CorvusArrayHelpers.GetImmutableListReplacing(this, oldValue, newValue));
    }

    /// <inheritdoc/>
    CostModel IJsonArray<CostModel>.SetItem(int index, in JsonAny value)
    {
        return new(__CorvusArrayHelpers.GetImmutableListSetting(this, index, value));
    }

    /// <inheritdoc/>
    public CostModel Add(in Generated.Int64 item1)
    {
        ImmutableList<JsonAny>.Builder builder = __CorvusArrayHelpers.GetImmutableListBuilder(this);
    ...
    /// <inheritdoc/>
    public CostModel Add(params Generated.Int64[] items)
    {
        ImmutableList<JsonAny>.Builder builder = __CorvusArrayHelpers.GetImmutableListBuilder(this);
        foreach (Generated.Int64 item in items)
        {
            builder.Add(item.AsAny);
        }
    ...
    /// <inheritdoc/>
    public CostModel AddRange(IEnumerable<Generated.Int64> items)
    {
        ImmutableList<JsonAny>.Builder builder = __CorvusArrayHelpers.GetImmutableListBuilder(this);
        foreach (Generated.Int64 item in items)
        {
    ...
    /// <inheritdoc/>
    public CostModel Insert(int index, in Generated.Int64 item1)
    {
        return new(__CorvusArrayHelpers.GetImmutableListWith(this, index, item1));
    }

    /// <inheritdoc/>
    public CostModel InsertRange(int index, IEnumerable<Generated.Int64> items)
    {
        return new(__CorvusArrayHelpers.GetImmutableListWith(this, index, items.Select(item => item.AsAny)));
    }

    /// <inheritdoc/>
    public CostModel Replace(in Generated.Int64 oldValue, in Generated.Int64 newValue)
    {
        return new(__CorvusArrayHelpers.GetImmutableListReplacing(this, oldValue, newValue));
    }

    /// <inheritdoc/>
    public CostModel SetItem(int index, in Generated.Int64 value)
    {
        return new(__CorvusArrayHelpers.GetImmutableListSetting(this, index, value));
    }

    /// <inheritdoc/>
    CostModel IJsonArray<CostModel>.Remove(in JsonAny oldValue)
    {
        return new(__CorvusArrayHelpers.GetImmutableListWithout(this, oldValue));
    }

    /// <inheritdoc/>
    CostModel IJsonArray<CostModel>.RemoveAt(int index)
    {
        return new(__CorvusArrayHelpers.GetImmutableListWithoutRange(this, index, 1));
    }

    /// <inheritdoc/>
    CostModel IJsonArray<CostModel>.RemoveRange(int index, int count)
    {
        return new(__CorvusArrayHelpers.GetImmutableListWithoutRange(this, index, count));
    }

    /// <inheritdoc/>
    public CostModel Remove(in Generated.Int64 oldValue)
    {
        return new(__CorvusArrayHelpers.GetImmutableListWithout(this, oldValue));
    }
    ...
    private static class __CorvusArrayHelpers
    {
        ...
        /// <exception cref = "InvalidOperationException">The value is not an array.</exception>
        public static ImmutableList<JsonAny> GetImmutableList(in CostModel arrayInstance)
        {
        ...
        /// <exception cref = "InvalidOperationException">The value is not an array.</exception>
        public static ImmutableList<JsonAny>.Builder GetImmutableListBuilder(in CostModel arrayInstance)
        {
        ...
        public static ImmutableList<JsonAny> GetImmutableListSetting(in CostModel arrayInstance, int index, in JsonAny value)
        {
            if ((arrayInstance.backing & Backing.JsonElement) != 0)
            {
                if (arrayInstance.jsonElementBacking.ValueKind == JsonValueKind.Array)
        ...
        /// <exception cref = "InvalidOperationException">The value is not an array.</exception>
        public static ImmutableList<JsonAny> GetImmutableListReplacing(in CostModel arrayInstance, in JsonAny oldItem, in JsonAny newItem)
        {
            if ((arrayInstance.backing & Backing.JsonElement) != 0)
            {
                if (arrayInstance.jsonElementBacking.ValueKind == JsonValueKind.Array)
        ...
        /// <exception cref = "InvalidOperationException">The value is not an array.</exception>
        public static ImmutableList<JsonAny> GetImmutableListWithout(in CostModel arrayInstance, in JsonAny item)
        {
            if ((arrayInstance.backing & Backing.JsonElement) != 0)
            {
                if (arrayInstance.jsonElementBacking.ValueKind == JsonValueKind.Array)
        ...
        /// <exception cref = "InvalidOperationException">The value is not an array.</exception>
        /// <exception cref = "IndexOutOfRangeException">Thrown if the range is beyond the bounds of the array.</exception>
        public static ImmutableList<JsonAny> GetImmutableListWithoutRange(in CostModel arrayInstance, int index, int count)
        {
            if ((arrayInstance.backing & Backing.JsonElement) != 0)
            {
                if (arrayInstance.jsonElementBacking.ValueKind == JsonValueKind.Array)
        ...
        // <exception cref = "InvalidOperationException">The value is not an array.</exception>
        // <exception cref = "IndexOutOfRangeException">Thrown if the range is beyond the bounds of the array.</exception>
        public static ImmutableList<JsonAny> GetImmutableListWith(in CostModel arrayInstance, int index, in JsonAny value)
        {
            if ((arrayInstance.backing & Backing.JsonElement) != 0)
            {
                if (arrayInstance.jsonElementBacking.ValueKind == JsonValueKind.Array)
        ...
        /// <exception cref = "InvalidOperationException">The value is not an array.</exception>
        /// <exception cref = "IndexOutOfRangeException">Thrown if the range is beyond the bounds of the array.</exception>
        public static ImmutableList<JsonAny> GetImmutableListWith<TEnumerable>(in CostModel arrayInstance, int index, TEnumerable values)
