    ...
    public readonly partial struct AdditionalPropertiesEntity
    {
        ...
        public ValidationContext Validate(in ValidationContext validationContext, ValidationLevel level = ValidationLevel.Flag)
        {
            ...
            if (level > ValidationLevel.Basic)
            {
                ...
                result = result.PushSchemaLocation("https://endjin.com/Users/davebeaumont/source/cardano-public/OgmiosDotnet/src/Ogmios.Schema/Ogmios/v6.11/Source/cardano.json#/definitions/MetadataLabels/additionalProperties");
            }
                ...
                ValidationLevel level = ValidationLevel.Flag)
            {
                ...
                foreach (JsonObjectProperty property in value.EnumerateObject())
                {
                    ...
                    if (property.NameEquals(JsonPropertyNames.CborUtf8, JsonPropertyNames.Cbor))
                    {
                        ...
                        ValidationContext propertyResult = property.Value.As<Generated.MetadataLabels.AdditionalPropertiesEntity.CborEntity>().Validate(result.CreateChildContext(), level);
                    ...
                    else if (property.NameEquals(JsonPropertyNames.JsonUtf8, JsonPropertyNames.Json))
                    {
                        ...
                        ValidationContext propertyResult = property.Value.As<Generated.Metadatum>().Validate(result.CreateChildContext(), level);
                        if (level == ValidationLevel.Flag && !propertyResult.IsValid)
                        {
                            return propertyResult;
                        }
