...
public readonly partial struct Ogmios
{
    ...
    {
        /// <summary>
        /// SubmitTransactionFailure<InvalidSignatories>
        /// </summary>
        /// <remarks>
        /// <para>
        ...
        /// </para>
        /// </remarks>
        public readonly partial struct SubmitTransactionFailureInvalidSignatories
        {
            /// <summary>
            /// Generated from JSON Schema.
            /// </summary>
            public readonly partial struct RequiredInvalidSignatories
            {
                /// <summary>
                /// Generated from JSON Schema.
                /// </summary>
#if NET8_0_OR_GREATER
                [CollectionBuilder(typeof(VerificationKeyArray), "Create")]
#endif
                public readonly partial struct VerificationKeyArray
                    : IJsonArray<Generated.Ogmios.SubmitTransactionFailure.SubmitTransactionFailureInvalidSignatories.RequiredInvalidSignatories.VerificationKeyArray>,
                      IReadOnlyCollection<Generated.VerificationKey>
                {
                    /// <summary>
                    /// Gets an empty array.
                    /// </summary>
                    public static VerificationKeyArray EmptyArray { get; } = From(ImmutableList<JsonAny>.Empty);
                    ...
                    /// <inheritdoc/>
                    Corvus.Json.JsonAny IJsonArray<VerificationKeyArray>.this[int index]
                    {
                        get
                        {
                    ...
                    public Generated.VerificationKey this[int index]
                    {
                        get
                        {
                            if ((this.backing & Backing.JsonElement) != 0)
                            ...
                            if ((this.backing & Backing.Array) != 0)
                            {
                                try
                                {
                                    return this.arrayBacking[index].As<Generated.VerificationKey>();
                                }
                                catch (ArgumentOutOfRangeException ex)
                                {
                                    throw new IndexOutOfRangeException(ex.Message, ex);
                    ...
                    public static implicit operator VerificationKeyArray(ImmutableList<JsonAny> value)
                    {
                        return new(value);
                    }
                    ...
                    /// </summary>
                    /// <param name="value">The value from which to convert.</param>
                    public static implicit operator ImmutableList<JsonAny>(VerificationKeyArray value)
                    {
                        return
                    ...
                    /// </summary>
                    /// <param name="value">The value from which to convert.</param>
                    public static implicit operator VerificationKeyArray(JsonArray value)
                    {
                    ...
                    /// </summary>
                    /// <param name="value">The value from which to convert.</param>
                    public static implicit operator JsonArray(VerificationKeyArray value)
                    {
                        return
                            value.AsArray;
                    }
                    ...
                    /// <summary>
                    /// Initializes a new instance of the <see cref="VerificationKeyArray"/> struct.
                    /// </summary>
                    ...
                    public static VerificationKeyArray From(ImmutableList<JsonAny> items)
                    {
                        return new(items);
                    }

                    /// <summary>
                    /// Create an new instance of the <see cref="VerificationKeyArray"/>" struct from a span of items.
                    /// </summary>
                    ...
                    public static VerificationKeyArray Create(ReadOnlySpan<Generated.VerificationKey> items)
                    {
                        return new([..items]);
                    }
                    ...
                    public static VerificationKeyArray FromItems(params Generated.VerificationKey[] items)
                    {
                        return new([..items]);
                    }
                    ...
                    public static VerificationKeyArray FromItems(in Generated.VerificationKey item1)
                    {
                    ...
                    /// <returns>An instance of the array constructed from the values.</returns>
                    public static VerificationKeyArray FromItems(in Generated.VerificationKey item1, in Generated.VerificationKey item2)
                    {
                    ...
                    /// <returns>An instance of the array constructed from the values.</returns>
                    public static VerificationKeyArray FromItems(in Generated.VerificationKey item1, in Generated.VerificationKey item2, in Generated.VerificationKey item3)
                    {
                    ...
                    /// <returns>An instance of the array constructed from the values.</returns>
                    public static VerificationKeyArray FromItems(in Generated.VerificationKey item1, in Generated.VerificationKey item2, in Generated.VerificationKey item3, in Generated.VerificationKey item4)
                    {
                    ...
                    /// <returns>An instance of the array constructed from the values.</returns>
                    public static VerificationKeyArray FromItems(in Generated.VerificationKey item1, in Generated.VerificationKey item2, in Generated.VerificationKey item3, in Generated.VerificationKey item4, in Generated.VerificationKey item5)
                    {
                    ...
                    /// <returns>An instance of the array constructed from the values.</returns>
                    public static VerificationKeyArray FromItems(in Generated.VerificationKey item1, in Generated.VerificationKey item2, in Generated.VerificationKey item3, in Generated.VerificationKey item4, in Generated.VerificationKey item5, in Generated.VerificationKey item6)
                    {
                    ...
                    /// <returns>An instance of the array constructed from the values.</returns>
                    public static VerificationKeyArray FromItems(in Generated.VerificationKey item1, in Generated.VerificationKey item2, in Generated.VerificationKey item3, in Generated.VerificationKey item4, in Generated.VerificationKey item5, in Generated.VerificationKey item6, in Generated.VerificationKey item7)
                    {
                    ...
                    public static VerificationKeyArray FromRange(IEnumerable<Generated.VerificationKey> items)
                    {
                        return new([..items]);
                    }
                    ...
                    /// <param name="items">The items from which to construct the instance.</param>
                    /// <returns>An instance of the array constructed from the items .</returns>
                    static VerificationKeyArray IJsonArray<VerificationKeyArray>.FromRange(IEnumerable<JsonAny> items)
                    {
                        return new([..items]);
                    }
                    ...
                    /// <param name="items">The items from which to construct the instance.</param>
                    /// <returns>An instance of the array constructed from the items.</returns>
                    static VerificationKeyArray IJsonArray<VerificationKeyArray>.FromRange<T>(IEnumerable<T> items)
                    {
                    ...
                    /// <inheritdoc/>
                    IEnumerator<Generated.VerificationKey> IEnumerable<Generated.VerificationKey>.GetEnumerator() => this.EnumerateArray();

                    /// <inheritdoc/>
                    IEnumerator IEnumerable.GetEnumerator() => this.EnumerateArray();

                    /// <inheritdoc/>
                    int IReadOnlyCollection<Generated.VerificationKey>.Count => this.GetArrayLength();
                    ...
                    /// <inheritdoc/>
                    public JsonArrayEnumerator<Generated.VerificationKey> EnumerateArray()
                    {
                        if ((this.backing & Backing.JsonElement) != 0)
                        {
                    ...
                    /// <inheritdoc/>
                    JsonArrayEnumerator IJsonArray<VerificationKeyArray>.EnumerateArray()
                    {
                        if ((this.backing & Backing.JsonElement) != 0)
                        {
                            return new(this.jsonElementBacking);
                    ...
                    /// <inheritdoc/>
                    JsonArrayEnumerator<TItem> IJsonArray<VerificationKeyArray>.EnumerateArray<TItem>()
                    {
                        if ((this.backing & Backing.JsonElement) != 0)
                        {
                            return new(this.jsonElementBacking);
                    ...
                    /// <inheritdoc/>
                    VerificationKeyArray IJsonArray<VerificationKeyArray>.Add(in JsonAny item1)
                    {
                    ...
                    /// <inheritdoc/>
                    VerificationKeyArray IJsonArray<VerificationKeyArray>.Add(params JsonAny[] items)
                    {
                        ImmutableList<JsonAny>.Builder builder = __CorvusArrayHelpers.GetImmutableListBuilder(this);
                    ...
                    /// <inheritdoc/>
                    VerificationKeyArray IJsonArray<VerificationKeyArray>.AddRange<TArray>(in TArray items)
                    {
                        ImmutableList<JsonAny>.Builder builder = __CorvusArrayHelpers.GetImmutableListBuilder(this);
                    ...
                    /// <inheritdoc/>
                    VerificationKeyArray IJsonArray<VerificationKeyArray>.AddRange<TItem>(IEnumerable<TItem> items)
                    {
                        ImmutableList<JsonAny>.Builder builder = __CorvusArrayHelpers.GetImmutableListBuilder(this);
                    ...
                    /// <inheritdoc/>
                    VerificationKeyArray IJsonArray<VerificationKeyArray>.AddRange(IEnumerable<JsonAny> items)
                    {
                        ImmutableList<JsonAny>.Builder builder = __CorvusArrayHelpers.GetImmutableListBuilder(this);
                    ...
                    /// <inheritdoc/>
                    VerificationKeyArray IJsonArray<VerificationKeyArray>.Insert(int index, in JsonAny item1)
                    {
                        return new(__CorvusArrayHelpers.GetImmutableListWith(this, index, item1));
                    }

                    /// <inheritdoc/>
                    VerificationKeyArray IJsonArray<VerificationKeyArray>.InsertRange<TArray>(int index, in TArray items)
                    {
                        return new(__CorvusArrayHelpers.GetImmutableListWith(this, index, items.EnumerateArray()));
                    }

                    /// <inheritdoc/>
                    VerificationKeyArray IJsonArray<VerificationKeyArray>.InsertRange<TItem>(int index, IEnumerable<TItem> items)
                    {
                        return new(__CorvusArrayHelpers.GetImmutableListWith(this, index, items.Select(item => item.AsAny)));
                    }

                    /// <inheritdoc/>
                    VerificationKeyArray IJsonArray<VerificationKeyArray>.InsertRange(int index, IEnumerable<JsonAny> items)
                    {
                        return new(__CorvusArrayHelpers.GetImmutableListWith(this, index, items));
                    }

                    /// <inheritdoc/>
                    VerificationKeyArray IJsonArray<VerificationKeyArray>.Replace(in JsonAny oldValue, in JsonAny newValue)
                    {
                        return new(__CorvusArrayHelpers.GetImmutableListReplacing(this, oldValue, newValue));
                    }

                    /// <inheritdoc/>
                    VerificationKeyArray IJsonArray<VerificationKeyArray>.SetItem(int index, in JsonAny value)
                    {
                        return new(__CorvusArrayHelpers.GetImmutableListSetting(this, index, value));
                    }

                    /// <inheritdoc/>
                    public VerificationKeyArray Add(in Generated.VerificationKey item1)
                    {
                        ImmutableList<JsonAny>.Builder builder = __CorvusArrayHelpers.GetImmutableListBuilder(this);
                    ...
                    /// <inheritdoc/>
                    public VerificationKeyArray Add(params Generated.VerificationKey[] items)
                    {
                        ImmutableList<JsonAny>.Builder builder = __CorvusArrayHelpers.GetImmutableListBuilder(this);
                        foreach (Generated.VerificationKey item in items)
                        {
                            builder.Add(item.AsAny);
                        }
                    ...
                    /// <inheritdoc/>
                    public VerificationKeyArray AddRange(IEnumerable<Generated.VerificationKey> items)
                    {
                        ImmutableList<JsonAny>.Builder builder = __CorvusArrayHelpers.GetImmutableListBuilder(this);
                        foreach (Generated.VerificationKey item in items)
                        {
                    ...
                    /// <inheritdoc/>
                    public VerificationKeyArray Insert(int index, in Generated.VerificationKey item1)
                    {
                        return new(__CorvusArrayHelpers.GetImmutableListWith(this, index, item1));
                    }

                    /// <inheritdoc/>
                    public VerificationKeyArray InsertRange(int index, IEnumerable<Generated.VerificationKey> items)
                    {
                        return new(__CorvusArrayHelpers.GetImmutableListWith(this, index, items.Select(item => item.AsAny)));
                    }

                    /// <inheritdoc/>
                    public VerificationKeyArray Replace(in Generated.VerificationKey oldValue, in Generated.VerificationKey newValue)
                    {
                        return new(__CorvusArrayHelpers.GetImmutableListReplacing(this, oldValue, newValue));
                    }

                    /// <inheritdoc/>
                    public VerificationKeyArray SetItem(int index, in Generated.VerificationKey value)
                    {
                        return new(__CorvusArrayHelpers.GetImmutableListSetting(this, index, value));
                    }

                    /// <inheritdoc/>
                    VerificationKeyArray IJsonArray<VerificationKeyArray>.Remove(in JsonAny oldValue)
                    {
                        return new(__CorvusArrayHelpers.GetImmutableListWithout(this, oldValue));
                    }

                    /// <inheritdoc/>
                    VerificationKeyArray IJsonArray<VerificationKeyArray>.RemoveAt(int index)
                    {
                        return new(__CorvusArrayHelpers.GetImmutableListWithoutRange(this, index, 1));
                    }

                    /// <inheritdoc/>
                    VerificationKeyArray IJsonArray<VerificationKeyArray>.RemoveRange(int index, int count)
                    {
                        return new(__CorvusArrayHelpers.GetImmutableListWithoutRange(this, index, count));
                    }

                    /// <inheritdoc/>
                    public VerificationKeyArray Remove(in Generated.VerificationKey oldValue)
                    {
                        return new(__CorvusArrayHelpers.GetImmutableListWithout(this, oldValue));
                    }
                    ...
                    private static class __CorvusArrayHelpers
                    {
                        ...
                        /// <exception cref = "InvalidOperationException">The value is not an array.</exception>
                        public static ImmutableList<JsonAny> GetImmutableList(in VerificationKeyArray arrayInstance)
                        {
                        ...
                        /// <exception cref = "InvalidOperationException">The value is not an array.</exception>
                        public static ImmutableList<JsonAny>.Builder GetImmutableListBuilder(in VerificationKeyArray arrayInstance)
                        {
                        ...
                        public static ImmutableList<JsonAny> GetImmutableListSetting(in VerificationKeyArray arrayInstance, int index, in JsonAny value)
                        {
                            if ((arrayInstance.backing & Backing.JsonElement) != 0)
                            {
                                if (arrayInstance.jsonElementBacking.ValueKind == JsonValueKind.Array)
                        ...
                        /// <exception cref = "InvalidOperationException">The value is not an array.</exception>
                        public static ImmutableList<JsonAny> GetImmutableListReplacing(in VerificationKeyArray arrayInstance, in JsonAny oldItem, in JsonAny newItem)
                        {
                            if ((arrayInstance.backing & Backing.JsonElement) != 0)
                            {
                                if (arrayInstance.jsonElementBacking.ValueKind == JsonValueKind.Array)
                        ...
                        /// <exception cref = "InvalidOperationException">The value is not an array.</exception>
                        public static ImmutableList<JsonAny> GetImmutableListWithout(in VerificationKeyArray arrayInstance, in JsonAny item)
                        {
                            if ((arrayInstance.backing & Backing.JsonElement) != 0)
                            {
                                if (arrayInstance.jsonElementBacking.ValueKind == JsonValueKind.Array)
                        ...
                        /// <exception cref = "InvalidOperationException">The value is not an array.</exception>
                        /// <exception cref = "IndexOutOfRangeException">Thrown if the range is beyond the bounds of the array.</exception>
                        public static ImmutableList<JsonAny> GetImmutableListWithoutRange(in VerificationKeyArray arrayInstance, int index, int count)
                        {
                            if ((arrayInstance.backing & Backing.JsonElement) != 0)
                            {
                                if (arrayInstance.jsonElementBacking.ValueKind == JsonValueKind.Array)
                        ...
                        // <exception cref = "InvalidOperationException">The value is not an array.</exception>
                        // <exception cref = "IndexOutOfRangeException">Thrown if the range is beyond the bounds of the array.</exception>
                        public static ImmutableList<JsonAny> GetImmutableListWith(in VerificationKeyArray arrayInstance, int index, in JsonAny value)
                        {
                            if ((arrayInstance.backing & Backing.JsonElement) != 0)
                            {
                                if (arrayInstance.jsonElementBacking.ValueKind == JsonValueKind.Array)
                        ...
                        /// <exception cref = "InvalidOperationException">The value is not an array.</exception>
                        /// <exception cref = "IndexOutOfRangeException">Thrown if the range is beyond the bounds of the array.</exception>
                        public static ImmutableList<JsonAny> GetImmutableListWith<TEnumerable>(in VerificationKeyArray arrayInstance, int index, TEnumerable values)
