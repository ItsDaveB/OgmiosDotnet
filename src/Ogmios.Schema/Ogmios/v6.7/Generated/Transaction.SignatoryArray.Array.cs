...
public readonly partial struct Transaction
{
    ...
    /// </summary>
#if NET8_0_OR_GREATER
    [CollectionBuilder(typeof(SignatoryArray), "Create")]
#endif
    public readonly partial struct SignatoryArray
        : IJsonArray<Generated.Transaction.SignatoryArray>,
          IReadOnlyCollection<Generated.Signatory>
    {
        /// <summary>
        /// Gets an empty array.
        /// </summary>
        public static SignatoryArray EmptyArray { get; } = From(ImmutableList<JsonAny>.Empty);
        ...
        /// <inheritdoc/>
        Corvus.Json.JsonAny IJsonArray<SignatoryArray>.this[int index]
        {
            get
            {
        ...
        public Generated.Signatory this[int index]
        {
            get
            {
                if ((this.backing & Backing.JsonElement) != 0)
                ...
                if ((this.backing & Backing.Array) != 0)
                {
                    try
                    {
                        return this.arrayBacking[index].As<Generated.Signatory>();
                    }
                    catch (ArgumentOutOfRangeException ex)
                    {
                        throw new IndexOutOfRangeException(ex.Message, ex);
        ...
        public static implicit operator SignatoryArray(ImmutableList<JsonAny> value)
        {
            return new(value);
        }
        ...
        /// </summary>
        /// <param name="value">The value from which to convert.</param>
        public static implicit operator ImmutableList<JsonAny>(SignatoryArray value)
        {
            return
        ...
        /// </summary>
        /// <param name="value">The value from which to convert.</param>
        public static implicit operator SignatoryArray(JsonArray value)
        {
        ...
        /// </summary>
        /// <param name="value">The value from which to convert.</param>
        public static implicit operator JsonArray(SignatoryArray value)
        {
            return
                value.AsArray;
        }
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="SignatoryArray"/> struct.
        /// </summary>
        ...
        public static SignatoryArray From(ImmutableList<JsonAny> items)
        {
            return new(items);
        }

        /// <summary>
        /// Create an new instance of the <see cref="SignatoryArray"/>" struct from a span of items.
        /// </summary>
        ...
        public static SignatoryArray Create(ReadOnlySpan<Generated.Signatory> items)
        {
            return new([..items]);
        }
        ...
        public static SignatoryArray FromItems(params Generated.Signatory[] items)
        {
            return new([..items]);
        }
        ...
        public static SignatoryArray FromItems(in Generated.Signatory item1)
        {
        ...
        /// <returns>An instance of the array constructed from the values.</returns>
        public static SignatoryArray FromItems(in Generated.Signatory item1, in Generated.Signatory item2)
        {
        ...
        /// <returns>An instance of the array constructed from the values.</returns>
        public static SignatoryArray FromItems(in Generated.Signatory item1, in Generated.Signatory item2, in Generated.Signatory item3)
        {
        ...
        /// <returns>An instance of the array constructed from the values.</returns>
        public static SignatoryArray FromItems(in Generated.Signatory item1, in Generated.Signatory item2, in Generated.Signatory item3, in Generated.Signatory item4)
        {
        ...
        /// <returns>An instance of the array constructed from the values.</returns>
        public static SignatoryArray FromItems(in Generated.Signatory item1, in Generated.Signatory item2, in Generated.Signatory item3, in Generated.Signatory item4, in Generated.Signatory item5)
        {
        ...
        /// <returns>An instance of the array constructed from the values.</returns>
        public static SignatoryArray FromItems(in Generated.Signatory item1, in Generated.Signatory item2, in Generated.Signatory item3, in Generated.Signatory item4, in Generated.Signatory item5, in Generated.Signatory item6)
        {
        ...
        /// <returns>An instance of the array constructed from the values.</returns>
        public static SignatoryArray FromItems(in Generated.Signatory item1, in Generated.Signatory item2, in Generated.Signatory item3, in Generated.Signatory item4, in Generated.Signatory item5, in Generated.Signatory item6, in Generated.Signatory item7)
        {
        ...
        public static SignatoryArray FromRange(IEnumerable<Generated.Signatory> items)
        {
            return new([..items]);
        }
        ...
        /// <param name="items">The items from which to construct the instance.</param>
        /// <returns>An instance of the array constructed from the items .</returns>
        static SignatoryArray IJsonArray<SignatoryArray>.FromRange(IEnumerable<JsonAny> items)
        {
            return new([..items]);
        }
        ...
        /// <param name="items">The items from which to construct the instance.</param>
        /// <returns>An instance of the array constructed from the items.</returns>
        static SignatoryArray IJsonArray<SignatoryArray>.FromRange<T>(IEnumerable<T> items)
        {
        ...
        /// <inheritdoc/>
        IEnumerator<Generated.Signatory> IEnumerable<Generated.Signatory>.GetEnumerator() => this.EnumerateArray();

        /// <inheritdoc/>
        IEnumerator IEnumerable.GetEnumerator() => this.EnumerateArray();

        /// <inheritdoc/>
        int IReadOnlyCollection<Generated.Signatory>.Count => this.GetArrayLength();
        ...
        /// <inheritdoc/>
        public JsonArrayEnumerator<Generated.Signatory> EnumerateArray()
        {
            if ((this.backing & Backing.JsonElement) != 0)
            {
        ...
        /// <inheritdoc/>
        JsonArrayEnumerator IJsonArray<SignatoryArray>.EnumerateArray()
        {
            if ((this.backing & Backing.JsonElement) != 0)
            {
                return new(this.jsonElementBacking);
        ...
        /// <inheritdoc/>
        JsonArrayEnumerator<TItem> IJsonArray<SignatoryArray>.EnumerateArray<TItem>()
        {
            if ((this.backing & Backing.JsonElement) != 0)
            {
                return new(this.jsonElementBacking);
        ...
        /// <inheritdoc/>
        SignatoryArray IJsonArray<SignatoryArray>.Add(in JsonAny item1)
        {
        ...
        /// <inheritdoc/>
        SignatoryArray IJsonArray<SignatoryArray>.Add(params JsonAny[] items)
        {
            ImmutableList<JsonAny>.Builder builder = __CorvusArrayHelpers.GetImmutableListBuilder(this);
        ...
        /// <inheritdoc/>
        SignatoryArray IJsonArray<SignatoryArray>.AddRange<TArray>(in TArray items)
        {
            ImmutableList<JsonAny>.Builder builder = __CorvusArrayHelpers.GetImmutableListBuilder(this);
        ...
        /// <inheritdoc/>
        SignatoryArray IJsonArray<SignatoryArray>.AddRange<TItem>(IEnumerable<TItem> items)
        {
            ImmutableList<JsonAny>.Builder builder = __CorvusArrayHelpers.GetImmutableListBuilder(this);
        ...
        /// <inheritdoc/>
        SignatoryArray IJsonArray<SignatoryArray>.AddRange(IEnumerable<JsonAny> items)
        {
            ImmutableList<JsonAny>.Builder builder = __CorvusArrayHelpers.GetImmutableListBuilder(this);
        ...
        /// <inheritdoc/>
        SignatoryArray IJsonArray<SignatoryArray>.Insert(int index, in JsonAny item1)
        {
            return new(__CorvusArrayHelpers.GetImmutableListWith(this, index, item1));
        }

        /// <inheritdoc/>
        SignatoryArray IJsonArray<SignatoryArray>.InsertRange<TArray>(int index, in TArray items)
        {
            return new(__CorvusArrayHelpers.GetImmutableListWith(this, index, items.EnumerateArray()));
        }

        /// <inheritdoc/>
        SignatoryArray IJsonArray<SignatoryArray>.InsertRange<TItem>(int index, IEnumerable<TItem> items)
        {
            return new(__CorvusArrayHelpers.GetImmutableListWith(this, index, items.Select(item => item.AsAny)));
        }

        /// <inheritdoc/>
        SignatoryArray IJsonArray<SignatoryArray>.InsertRange(int index, IEnumerable<JsonAny> items)
        {
            return new(__CorvusArrayHelpers.GetImmutableListWith(this, index, items));
        }

        /// <inheritdoc/>
        SignatoryArray IJsonArray<SignatoryArray>.Replace(in JsonAny oldValue, in JsonAny newValue)
        {
            return new(__CorvusArrayHelpers.GetImmutableListReplacing(this, oldValue, newValue));
        }

        /// <inheritdoc/>
        SignatoryArray IJsonArray<SignatoryArray>.SetItem(int index, in JsonAny value)
        {
            return new(__CorvusArrayHelpers.GetImmutableListSetting(this, index, value));
        }

        /// <inheritdoc/>
        public SignatoryArray Add(in Generated.Signatory item1)
        {
            ImmutableList<JsonAny>.Builder builder = __CorvusArrayHelpers.GetImmutableListBuilder(this);
        ...
        /// <inheritdoc/>
        public SignatoryArray Add(params Generated.Signatory[] items)
        {
            ImmutableList<JsonAny>.Builder builder = __CorvusArrayHelpers.GetImmutableListBuilder(this);
            foreach (Generated.Signatory item in items)
            {
                builder.Add(item.AsAny);
            }
        ...
        /// <inheritdoc/>
        public SignatoryArray AddRange(IEnumerable<Generated.Signatory> items)
        {
            ImmutableList<JsonAny>.Builder builder = __CorvusArrayHelpers.GetImmutableListBuilder(this);
            foreach (Generated.Signatory item in items)
            {
        ...
        /// <inheritdoc/>
        public SignatoryArray Insert(int index, in Generated.Signatory item1)
        {
            return new(__CorvusArrayHelpers.GetImmutableListWith(this, index, item1));
        }

        /// <inheritdoc/>
        public SignatoryArray InsertRange(int index, IEnumerable<Generated.Signatory> items)
        {
            return new(__CorvusArrayHelpers.GetImmutableListWith(this, index, items.Select(item => item.AsAny)));
        }

        /// <inheritdoc/>
        public SignatoryArray Replace(in Generated.Signatory oldValue, in Generated.Signatory newValue)
        {
            return new(__CorvusArrayHelpers.GetImmutableListReplacing(this, oldValue, newValue));
        }

        /// <inheritdoc/>
        public SignatoryArray SetItem(int index, in Generated.Signatory value)
        {
            return new(__CorvusArrayHelpers.GetImmutableListSetting(this, index, value));
        }

        /// <inheritdoc/>
        SignatoryArray IJsonArray<SignatoryArray>.Remove(in JsonAny oldValue)
        {
            return new(__CorvusArrayHelpers.GetImmutableListWithout(this, oldValue));
        }

        /// <inheritdoc/>
        SignatoryArray IJsonArray<SignatoryArray>.RemoveAt(int index)
        {
            return new(__CorvusArrayHelpers.GetImmutableListWithoutRange(this, index, 1));
        }

        /// <inheritdoc/>
        SignatoryArray IJsonArray<SignatoryArray>.RemoveRange(int index, int count)
        {
            return new(__CorvusArrayHelpers.GetImmutableListWithoutRange(this, index, count));
        }

        /// <inheritdoc/>
        public SignatoryArray Remove(in Generated.Signatory oldValue)
        {
            return new(__CorvusArrayHelpers.GetImmutableListWithout(this, oldValue));
        }
        ...
        private static class __CorvusArrayHelpers
        {
            ...
            /// <exception cref = "InvalidOperationException">The value is not an array.</exception>
            public static ImmutableList<JsonAny> GetImmutableList(in SignatoryArray arrayInstance)
            {
            ...
            /// <exception cref = "InvalidOperationException">The value is not an array.</exception>
            public static ImmutableList<JsonAny>.Builder GetImmutableListBuilder(in SignatoryArray arrayInstance)
            {
            ...
            public static ImmutableList<JsonAny> GetImmutableListSetting(in SignatoryArray arrayInstance, int index, in JsonAny value)
            {
                if ((arrayInstance.backing & Backing.JsonElement) != 0)
                {
                    if (arrayInstance.jsonElementBacking.ValueKind == JsonValueKind.Array)
            ...
            /// <exception cref = "InvalidOperationException">The value is not an array.</exception>
            public static ImmutableList<JsonAny> GetImmutableListReplacing(in SignatoryArray arrayInstance, in JsonAny oldItem, in JsonAny newItem)
            {
                if ((arrayInstance.backing & Backing.JsonElement) != 0)
                {
                    if (arrayInstance.jsonElementBacking.ValueKind == JsonValueKind.Array)
            ...
            /// <exception cref = "InvalidOperationException">The value is not an array.</exception>
            public static ImmutableList<JsonAny> GetImmutableListWithout(in SignatoryArray arrayInstance, in JsonAny item)
            {
                if ((arrayInstance.backing & Backing.JsonElement) != 0)
                {
                    if (arrayInstance.jsonElementBacking.ValueKind == JsonValueKind.Array)
            ...
            /// <exception cref = "InvalidOperationException">The value is not an array.</exception>
            /// <exception cref = "IndexOutOfRangeException">Thrown if the range is beyond the bounds of the array.</exception>
            public static ImmutableList<JsonAny> GetImmutableListWithoutRange(in SignatoryArray arrayInstance, int index, int count)
            {
                if ((arrayInstance.backing & Backing.JsonElement) != 0)
                {
                    if (arrayInstance.jsonElementBacking.ValueKind == JsonValueKind.Array)
            ...
            // <exception cref = "InvalidOperationException">The value is not an array.</exception>
            // <exception cref = "IndexOutOfRangeException">Thrown if the range is beyond the bounds of the array.</exception>
            public static ImmutableList<JsonAny> GetImmutableListWith(in SignatoryArray arrayInstance, int index, in JsonAny value)
            {
                if ((arrayInstance.backing & Backing.JsonElement) != 0)
                {
                    if (arrayInstance.jsonElementBacking.ValueKind == JsonValueKind.Array)
            ...
            /// <exception cref = "InvalidOperationException">The value is not an array.</exception>
            /// <exception cref = "IndexOutOfRangeException">Thrown if the range is beyond the bounds of the array.</exception>
            public static ImmutableList<JsonAny> GetImmutableListWith<TEnumerable>(in SignatoryArray arrayInstance, int index, TEnumerable values)
