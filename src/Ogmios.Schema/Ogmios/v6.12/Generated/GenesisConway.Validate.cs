...
public readonly partial struct GenesisConway
{
    ...
    public ValidationContext Validate(in ValidationContext validationContext, ValidationLevel level = ValidationLevel.Flag)
    {
        ...
        if (level > ValidationLevel.Basic)
        {
            ...
            result = result.PushSchemaLocation("https://endjin.com/Users/davebeaumont/source/cardano-public/OgmiosDotnet/src/Ogmios.Schema/Ogmios/v6.12/Source/cardano.json#/definitions/Genesis<Conway>");
        }
    ...
    public static partial class CorvusValidation
    {
            ...
            ValidationLevel level = ValidationLevel.Flag)
        {
            ...
            bool hasSeenUpdatableParameters = false;
            ...
            foreach (JsonObjectProperty property in value.EnumerateObject())
            {
                ...
                if (property.NameEquals(JsonPropertyNames.ConstitutionUtf8, JsonPropertyNames.Constitution))
                {
                    ...
                    ValidationContext propertyResult = property.Value.As<Generated.Constitution>().Validate(result.CreateChildContext(), level);
                ...
                else if (property.NameEquals(JsonPropertyNames.ConstitutionalCommitteeUtf8, JsonPropertyNames.ConstitutionalCommittee))
                {
                    ...
                    ValidationContext propertyResult = property.Value.As<Generated.GenesisConway.RequiredMembersAndQuorum>().Validate(result.CreateChildContext(), level);
                    if (level == ValidationLevel.Flag && !propertyResult.IsValid)
                    {
                        return propertyResult;
                    }
                ...
                else if (property.NameEquals(JsonPropertyNames.EraUtf8, JsonPropertyNames.Era))
                {
                    ...
                    ValidationContext propertyResult = property.Value.As<Generated.GenesisConway.EraEntity>().Validate(result.CreateChildContext(), level);
                    if (level == ValidationLevel.Flag && !propertyResult.IsValid)
                    {
                        return propertyResult;
                    }
                ...
                {
                    hasSeenUpdatableParameters = true;
                    result = result.WithLocalProperty(propertyCount);
                    if (level > ValidationLevel.Basic)
                    {
                        result = result.PushValidationLocationReducedPathModifierAndProperty(new("#/properties/updatableParameters"), JsonPropertyNames.UpdatableParameters);
                    }

                    ValidationContext propertyResult = property.Value.As<Generated.GenesisConway.UpdatableParametersEntity>().Validate(result.CreateChildContext(), level);
                    if (level == ValidationLevel.Flag && !propertyResult.IsValid)
                    {
                        return propertyResult;
                    }
            ...
            if (!hasSeenUpdatableParameters)
            {
                if (level >= ValidationLevel.Basic)
                {
                    result = result.WithResult(isValid: false, "Validation properties - the required property 'updatableParameters' was not present.");
                }
                else
                {
                    return ValidationContext.InvalidContext;
            ...
            {
                result = result.WithResult(isValid: true, "Validation properties - the required property 'updatableParameters' was present.");
            }
