        ...
        public readonly partial struct QueryLedgerStateDelegateRepresentativesResponse
        {
            ...
            public ValidationContext Validate(in ValidationContext validationContext, ValidationLevel level = ValidationLevel.Flag)
            {
                ...
                if (level > ValidationLevel.Basic)
                {
                    ...
                    result = result.PushSchemaLocation("OgmiosDotnet/src/Ogmios.Schema/Ogmios/v6.12/Source/ogmios.json#/properties/QueryLedgerStateDelegateRepresentativesResponse/oneOf/0");
                }
