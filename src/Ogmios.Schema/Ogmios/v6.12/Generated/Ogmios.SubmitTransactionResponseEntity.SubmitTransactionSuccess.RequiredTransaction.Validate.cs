            ...
            public readonly partial struct RequiredTransaction
            {
                ...
                public ValidationContext Validate(in ValidationContext validationContext, ValidationLevel level = ValidationLevel.Flag)
                {
                    ...
                    if (level > ValidationLevel.Basic)
                    {
                        ...
                        result = result.PushSchemaLocation("https://endjin.com/Users/davebeaumont/source/cardano-public/OgmiosDotnet/src/Ogmios.Schema/Ogmios/v6.12/Source/ogmios.json#/properties/SubmitTransactionResponse/oneOf/0/properties/result");
                    }
                        ...
                        ValidationLevel level = ValidationLevel.Flag)
                    {
                        ...
                        foreach (JsonObjectProperty property in value.EnumerateObject())
                        {
                            ...
                            if (property.NameEquals(JsonPropertyNames.TransactionUtf8, JsonPropertyNames.Transaction))
                            {
                                ...
                                ValidationContext propertyResult = property.Value.As<Generated.Ogmios.SubmitTransactionResponseEntity.SubmitTransactionSuccess.RequiredTransaction.RequiredId>().Validate(result.CreateChildContext(), level);
