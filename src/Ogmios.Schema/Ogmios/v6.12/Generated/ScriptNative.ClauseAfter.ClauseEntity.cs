...
public readonly partial struct ScriptNative
{
    ...
    public readonly partial struct ClauseAfter
    {
...

        {
            ...
            /// </summary>
            public static string SchemaLocation { get; } = "OgmiosDotnet/src/Ogmios.Schema/Ogmios/v6.12/Source/cardano.json#/definitions/Script<Native>/oneOf/5/properties/clause";
