    ...
    public readonly partial struct QueryLedgerStateGovernanceProposals
    {
        ...
        public readonly partial struct ParamsEntity
        {
            ...
            public readonly partial struct GovernanceProposalsByReferences
                : IJsonObject<Generated.Ogmios.QueryLedgerStateGovernanceProposals.ParamsEntity.GovernanceProposalsByReferences>
            {
                /// <summary>
                /// Conversion from <see cref="ImmutableList{JsonObjectProperty}"/>.
                /// </summary>
                /// <param name="value">The value from which to convert.</param>
                public static implicit operator GovernanceProposalsByReferences(ImmutableList<JsonObjectProperty> value)
                {
                    return new(value);
                }
                ...
                /// </summary>
                /// <param name="value">The value from which to convert.</param>
                public static implicit operator ImmutableList<JsonObjectProperty>(GovernanceProposalsByReferences value)
                {
                    return
                ...
                /// </summary>
                /// <param name="value">The value from which to convert.</param>
                public static implicit operator GovernanceProposalsByReferences(JsonObject value)
                {
                ...
                /// </summary>
                /// <param name="value">The value from which to convert.</param>
                public static implicit operator JsonObject(GovernanceProposalsByReferences value)
                {
                    return
                        value.AsObject;
                }
                ...
                /// <summary>
                /// Gets the <c>proposals</c> property.
                /// </summary>
                /// <remarks>
                /// <para>
                ...
                /// </para>
                /// </remarks>
                public Generated.Ogmios.QueryLedgerStateGovernanceProposals.ParamsEntity.GovernanceProposalsByReferences.GovernanceProposalReferenceArray Proposals
                {
                    get
                    {
                        if ((this.backing & Backing.JsonElement) != 0)
                        ...
                        if ((this.backing & Backing.Object) != 0)
                        {
                            ...
                            {
                                return result.As<Generated.Ogmios.QueryLedgerStateGovernanceProposals.ParamsEntity.GovernanceProposalsByReferences.GovernanceProposalReferenceArray>();
                            }
                        }
                ...
                /// <inheritdoc/>
                public static GovernanceProposalsByReferences FromProperties(IDictionary<JsonPropertyName, JsonAny> source)
                {
                    return new(source.Select(kvp => new JsonObjectProperty(kvp.Key, kvp.Value)).ToImmutableList());
                }

                /// <inheritdoc/>
                public static GovernanceProposalsByReferences FromProperties(params (JsonPropertyName Name, JsonAny Value)[] source)
                {
                ...
                public static GovernanceProposalsByReferences FromProperties(ImmutableList<JsonObjectProperty> source)
                {
                    return new(source);
                }

                /// <summary>
                /// Creates an instance of a <see cref="GovernanceProposalsByReferences"/>.
                /// </summary>
                public static GovernanceProposalsByReferences Create(in Generated.Ogmios.QueryLedgerStateGovernanceProposals.ParamsEntity.GovernanceProposalsByReferences.GovernanceProposalReferenceArray proposals)
                {
                    var builder = ImmutableList.CreateBuilder<JsonObjectProperty>();
                    builder.Add(JsonPropertyNames.Proposals, proposals.AsAny);
                ...
                /// <summary>
                /// Sets the <c>proposals</c> property.
                /// </summary>
                /// <param name="value">The new property value</param>
                /// <returns>The instance with the property set.</returns>
                public GovernanceProposalsByReferences WithProposals(in Generated.Ogmios.QueryLedgerStateGovernanceProposals.ParamsEntity.GovernanceProposalsByReferences.GovernanceProposalReferenceArray value)
                {
                ...
                /// <inheritdoc />
                public GovernanceProposalsByReferences SetProperty<TValue>(in JsonPropertyName name, TValue value)
                ...
                /// <inheritdoc />
                public GovernanceProposalsByReferences RemoveProperty(in JsonPropertyName name)
                {
                    return new(__CorvusObjectHelpers.GetPropertyBackingWithout(this, name));
                }

                /// <inheritdoc />
                public GovernanceProposalsByReferences RemoveProperty(string name)
                {
                    return new(__CorvusObjectHelpers.GetPropertyBackingWithout(this, name));
                }

                /// <inheritdoc />
                public GovernanceProposalsByReferences RemoveProperty(ReadOnlySpan<char> name)
                {
                    return new(__CorvusObjectHelpers.GetPropertyBackingWithout(this, name));
                }

                /// <inheritdoc />
                public GovernanceProposalsByReferences RemoveProperty(ReadOnlySpan<byte> name)
                {
                    return new(__CorvusObjectHelpers.GetPropertyBackingWithout(this, name));
                }
                ...
                private static class __CorvusObjectHelpers
                {
                    ...
                    /// <exception cref="InvalidOperationException">The value is not an object.</exception>
                    public static ImmutableList<JsonObjectProperty> GetPropertyBacking(in GovernanceProposalsByReferences that)
                    {
                    ...
                    /// <exception cref="InvalidOperationException">The value is not an object.</exception>
                    public static ImmutableList<JsonObjectProperty> GetPropertyBackingWithout(in GovernanceProposalsByReferences that, in JsonPropertyName name)
                    {
                        if ((that.backing & Backing.Object) != 0)
                        {
                    ...
                    /// <returns>An immutable list of <see cref="JsonObjectProperty"/>, built from the existing object, without the given property.</returns>
                    /// <exception cref="InvalidOperationException">The value is not an object.</exception>
                    public static ImmutableList<JsonObjectProperty> GetPropertyBackingWithout(in GovernanceProposalsByReferences that, ReadOnlySpan<char> name)
                    {
                        if ((that.backing & Backing.Object) != 0)
                        {
                            return that.objectBacking.Remove(name);
                    ...
                    /// <returns>An immutable list of <see cref="JsonObjectProperty"/>, built from the existing object, without the given property.</returns>
                    /// <exception cref="InvalidOperationException">The value is not an object.</exception>
                    public static ImmutableList<JsonObjectProperty> GetPropertyBackingWithout(in GovernanceProposalsByReferences that, ReadOnlySpan<byte> name)
                    {
                        if ((that.backing & Backing.Object) != 0)
                        {
                            return that.objectBacking.Remove(name);
                    ...
                    /// <returns>An immutable list of <see cref="JsonObjectProperty"/>, built from the existing object, without the given property.</returns>
                    /// <exception cref="InvalidOperationException">The value is not an object.</exception>
                    public static ImmutableList<JsonObjectProperty> GetPropertyBackingWithout(in GovernanceProposalsByReferences that, string name)
                    {
                        if ((that.backing & Backing.Object) != 0)
                        {
                            return that.objectBacking.Remove(name);
                    ...
                    /// <exception cref="InvalidOperationException">The value is not an object.</exception>
                    public static ImmutableList<JsonObjectProperty> GetPropertyBackingWith(in GovernanceProposalsByReferences that, in JsonPropertyName name, in JsonAny value)
                    {
                        if ((that.backing & Backing.Object) != 0)
                        {
