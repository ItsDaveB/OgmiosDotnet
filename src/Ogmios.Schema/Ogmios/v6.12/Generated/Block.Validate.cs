...
public readonly partial struct Block
{
    ...
    public ValidationContext Validate(in ValidationContext validationContext, ValidationLevel level = ValidationLevel.Flag)
    {
        ...
        if (level > ValidationLevel.Basic)
        {
            ...
            result = result.PushSchemaLocation("https://endjin.com/Users/davebeaumont/source/cardano-public/OgmiosDotnet/src/Ogmios.Schema/Ogmios/v6.12/Source/cardano.json#/definitions/Block");
        }
    ...
    public static partial class CorvusValidation
    {
            ...
            ValidationLevel level = ValidationLevel.Flag)
        {
            ...
            ValidationContext oneOfResult0 = value.As<Generated.BlockEbb>().Validate(oneOfChildContext0, level);
            ...
            ValidationContext oneOfResult1 = value.As<Generated.BlockBft>().Validate(oneOfChildContext1, level);
            ...
            ValidationContext oneOfResult2 = value.As<Generated.BlockPraos>().Validate(oneOfChildContext2, level);
