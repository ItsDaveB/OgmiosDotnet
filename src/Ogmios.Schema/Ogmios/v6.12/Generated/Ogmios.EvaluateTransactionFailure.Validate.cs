    ...
    public readonly partial struct EvaluateTransactionFailure
    {
        ...
        public ValidationContext Validate(in ValidationContext validationContext, ValidationLevel level = ValidationLevel.Flag)
        {
            ...
            if (level > ValidationLevel.Basic)
            {
                ...
                result = result.PushSchemaLocation("https://endjin.com/Users/davebeaumont/source/cardano-public/OgmiosDotnet/src/Ogmios.Schema/Ogmios/v6.12/Source/ogmios.json#/definitions/EvaluateTransactionFailure");
            }
        ...
        public static partial class CorvusValidation
        {
            ...
            internal static ValidationContext CompositionOneOfValidationHandler(
                in EvaluateTransactionFailure value,
                ...
                ValidationLevel level = ValidationLevel.Flag)
            {
                ...
                ValidationContext oneOfResult0 = value.As<Generated.Ogmios.EvaluateTransactionFailure.EvaluateTransactionFailureIncompatibleEra>().Validate(oneOfChildContext0, level);
                ...
                ValidationContext oneOfResult1 = value.As<Generated.Ogmios.EvaluateTransactionFailure.EvaluateTransactionFailureUnsupportedEra>().Validate(oneOfChildContext1, level);
                ...
                ValidationContext oneOfResult2 = value.As<Generated.Ogmios.EvaluateTransactionFailure.EvaluateTransactionFailureOverlappingAdditionalUtxo>().Validate(oneOfChildContext2, level);
                ...
                ValidationContext oneOfResult3 = value.As<Generated.Ogmios.EvaluateTransactionFailure.EvaluateTransactionFailureNodeTipTooOld>().Validate(oneOfChildContext3, level);
                ...
                ValidationContext oneOfResult4 = value.As<Generated.Ogmios.EvaluateTransactionFailure.EvaluateTransactionFailureCannotCreateEvaluationContext>().Validate(oneOfChildContext4, level);
                ...
                ValidationContext oneOfResult5 = value.As<Generated.Ogmios.EvaluateTransactionFailure.EvaluateTransactionFailureScriptExecutionFailure>().Validate(oneOfChildContext5, level);
