...
public readonly partial struct Ogmios
{
    ...
    public readonly partial struct MustAcquireMempoolFirst
    {
        ...
        public readonly partial struct MustAcquireAMempoolSnapshotPriorToPerformingAnyQuery
            : IJsonObject<Generated.Ogmios.MustAcquireMempoolFirst.MustAcquireAMempoolSnapshotPriorToPerformingAnyQuery>
        {
            /// <summary>
            /// Conversion from <see cref="ImmutableList{JsonObjectProperty}"/>.
            /// </summary>
            /// <param name="value">The value from which to convert.</param>
            public static implicit operator MustAcquireAMempoolSnapshotPriorToPerformingAnyQuery(ImmutableList<JsonObjectProperty> value)
            {
                return new(value);
            }
            ...
            /// </summary>
            /// <param name="value">The value from which to convert.</param>
            public static implicit operator ImmutableList<JsonObjectProperty>(MustAcquireAMempoolSnapshotPriorToPerformingAnyQuery value)
            {
                return
            ...
            /// </summary>
            /// <param name="value">The value from which to convert.</param>
            public static implicit operator MustAcquireAMempoolSnapshotPriorToPerformingAnyQuery(JsonObject value)
            {
            ...
            /// </summary>
            /// <param name="value">The value from which to convert.</param>
            public static implicit operator JsonObject(MustAcquireAMempoolSnapshotPriorToPerformingAnyQuery value)
            {
                return
                    value.AsObject;
            }
            ...
            /// </para>
            /// </remarks>
            public Generated.Ogmios.MustAcquireMempoolFirst.MustAcquireAMempoolSnapshotPriorToPerformingAnyQuery.CodeEntity Code
            {
                get
                {
                    if ((this.backing & Backing.JsonElement) != 0)
                    ...
                    if ((this.backing & Backing.Object) != 0)
                    {
                        ...
                        {
                            return result.As<Generated.Ogmios.MustAcquireMempoolFirst.MustAcquireAMempoolSnapshotPriorToPerformingAnyQuery.CodeEntity>();
                        }
                    }
            ...
            /// <inheritdoc/>
            public static MustAcquireAMempoolSnapshotPriorToPerformingAnyQuery FromProperties(IDictionary<JsonPropertyName, JsonAny> source)
            {
                return new(source.Select(kvp => new JsonObjectProperty(kvp.Key, kvp.Value)).ToImmutableList());
            }

            /// <inheritdoc/>
            public static MustAcquireAMempoolSnapshotPriorToPerformingAnyQuery FromProperties(params (JsonPropertyName Name, JsonAny Value)[] source)
            {
            ...
            public static MustAcquireAMempoolSnapshotPriorToPerformingAnyQuery FromProperties(ImmutableList<JsonObjectProperty> source)
            {
                return new(source);
            }

            /// <summary>
            /// Creates an instance of a <see cref="MustAcquireAMempoolSnapshotPriorToPerformingAnyQuery"/>.
            /// </summary>
            public static MustAcquireAMempoolSnapshotPriorToPerformingAnyQuery Create(in Generated.Ogmios.MustAcquireMempoolFirst.MustAcquireAMempoolSnapshotPriorToPerformingAnyQuery.CodeEntity code, in Corvus.Json.JsonString message)
            {
            ...
            public MustAcquireAMempoolSnapshotPriorToPerformingAnyQuery WithCode(in Generated.Ogmios.MustAcquireMempoolFirst.MustAcquireAMempoolSnapshotPriorToPerformingAnyQuery.CodeEntity value)
            {
            ...
            /// <param name="value">The new property value</param>
            /// <returns>The instance with the property set.</returns>
            public MustAcquireAMempoolSnapshotPriorToPerformingAnyQuery WithMessage(in Corvus.Json.JsonString value)
            {
            ...
            /// <inheritdoc />
            public MustAcquireAMempoolSnapshotPriorToPerformingAnyQuery SetProperty<TValue>(in JsonPropertyName name, TValue value)
            ...
            /// <inheritdoc />
            public MustAcquireAMempoolSnapshotPriorToPerformingAnyQuery RemoveProperty(in JsonPropertyName name)
            {
                return new(__CorvusObjectHelpers.GetPropertyBackingWithout(this, name));
            }

            /// <inheritdoc />
            public MustAcquireAMempoolSnapshotPriorToPerformingAnyQuery RemoveProperty(string name)
            {
                return new(__CorvusObjectHelpers.GetPropertyBackingWithout(this, name));
            }

            /// <inheritdoc />
            public MustAcquireAMempoolSnapshotPriorToPerformingAnyQuery RemoveProperty(ReadOnlySpan<char> name)
            {
                return new(__CorvusObjectHelpers.GetPropertyBackingWithout(this, name));
            }

            /// <inheritdoc />
            public MustAcquireAMempoolSnapshotPriorToPerformingAnyQuery RemoveProperty(ReadOnlySpan<byte> name)
            {
                return new(__CorvusObjectHelpers.GetPropertyBackingWithout(this, name));
            }
            ...
            private static class __CorvusObjectHelpers
            {
                ...
                /// <exception cref="InvalidOperationException">The value is not an object.</exception>
                public static ImmutableList<JsonObjectProperty> GetPropertyBacking(in MustAcquireAMempoolSnapshotPriorToPerformingAnyQuery that)
                {
                ...
                /// <exception cref="InvalidOperationException">The value is not an object.</exception>
                public static ImmutableList<JsonObjectProperty> GetPropertyBackingWithout(in MustAcquireAMempoolSnapshotPriorToPerformingAnyQuery that, in JsonPropertyName name)
                {
                    if ((that.backing & Backing.Object) != 0)
                    {
                ...
                /// <returns>An immutable list of <see cref="JsonObjectProperty"/>, built from the existing object, without the given property.</returns>
                /// <exception cref="InvalidOperationException">The value is not an object.</exception>
                public static ImmutableList<JsonObjectProperty> GetPropertyBackingWithout(in MustAcquireAMempoolSnapshotPriorToPerformingAnyQuery that, ReadOnlySpan<char> name)
                {
                    if ((that.backing & Backing.Object) != 0)
                    {
                        return that.objectBacking.Remove(name);
                ...
                /// <returns>An immutable list of <see cref="JsonObjectProperty"/>, built from the existing object, without the given property.</returns>
                /// <exception cref="InvalidOperationException">The value is not an object.</exception>
                public static ImmutableList<JsonObjectProperty> GetPropertyBackingWithout(in MustAcquireAMempoolSnapshotPriorToPerformingAnyQuery that, ReadOnlySpan<byte> name)
                {
                    if ((that.backing & Backing.Object) != 0)
                    {
                        return that.objectBacking.Remove(name);
                ...
                /// <returns>An immutable list of <see cref="JsonObjectProperty"/>, built from the existing object, without the given property.</returns>
                /// <exception cref="InvalidOperationException">The value is not an object.</exception>
                public static ImmutableList<JsonObjectProperty> GetPropertyBackingWithout(in MustAcquireAMempoolSnapshotPriorToPerformingAnyQuery that, string name)
                {
                    if ((that.backing & Backing.Object) != 0)
                    {
                        return that.objectBacking.Remove(name);
                ...
                /// <exception cref="InvalidOperationException">The value is not an object.</exception>
                public static ImmutableList<JsonObjectProperty> GetPropertyBackingWith(in MustAcquireAMempoolSnapshotPriorToPerformingAnyQuery that, in JsonPropertyName name, in JsonAny value)
                {
                    if ((that.backing & Backing.Object) != 0)
                    {
