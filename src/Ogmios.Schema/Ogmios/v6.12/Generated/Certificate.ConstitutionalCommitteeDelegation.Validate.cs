    ...
    public readonly partial struct ConstitutionalCommitteeDelegation
    {
        ...
        public ValidationContext Validate(in ValidationContext validationContext, ValidationLevel level = ValidationLevel.Flag)
        {
            ...
            if (level > ValidationLevel.Basic)
            {
                ...
                result = result.PushSchemaLocation("https://endjin.com/Users/davebeaumont/source/cardano-public/OgmiosDotnet/src/Ogmios.Schema/Ogmios/v6.12/Source/cardano.json#/definitions/Certificate/oneOf/6");
            }
        ...
        public static partial class CorvusValidation
        {
            ...
            internal static ValidationContext ObjectValidationHandler(
                in ConstitutionalCommitteeDelegation value,
                JsonValueKind valueKind,
                in ValidationContext validationContext,
                ValidationLevel level = ValidationLevel.Flag)
            {
                ...
                foreach (JsonObjectProperty property in value.EnumerateObject())
                {
                    ...
                    else if (property.NameEquals(JsonPropertyNames.MemberUtf8, JsonPropertyNames.Member))
                    {
                        hasSeenMember = true;
                        result = result.WithLocalProperty(propertyCount);
                        if (level > ValidationLevel.Basic)
                        {
                            result = result.PushValidationLocationReducedPathModifierAndProperty(new("#/properties/member"), JsonPropertyNames.Member);
                        }

                        ValidationContext propertyResult = property.Value.As<Generated.Certificate.ConstitutionalCommitteeDelegation.RequiredFromAndId>().Validate(result.CreateChildContext(), level);
                        if (level == ValidationLevel.Flag && !propertyResult.IsValid)
                        {
                            return propertyResult;
                        }
                    ...
                    else if (property.NameEquals(JsonPropertyNames.TypeUtf8, JsonPropertyNames.Type))
                    {
                        ...
                        ValidationContext propertyResult = property.Value.As<Generated.Certificate.ConstitutionalCommitteeDelegation.TypeEntity>().Validate(result.CreateChildContext(), level);
                        if (level == ValidationLevel.Flag && !propertyResult.IsValid)
                        {
                            return propertyResult;
                        }
                ...
                if (!hasSeenMember)
                {
                    if (level >= ValidationLevel.Basic)
                    {
                        result = result.WithResult(isValid: false, "Validation properties - the required property 'member' was not present.");
                    }
                    else
                    {
                        return ValidationContext.InvalidContext;
                ...
                {
                    result = result.WithResult(isValid: true, "Validation properties - the required property 'member' was present.");
                }
