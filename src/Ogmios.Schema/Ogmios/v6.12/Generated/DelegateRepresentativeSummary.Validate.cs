...
public readonly partial struct DelegateRepresentativeSummary
{
    ...
    public ValidationContext Validate(in ValidationContext validationContext, ValidationLevel level = ValidationLevel.Flag)
    {
        ...
        if (level > ValidationLevel.Basic)
        {
            ...
            result = result.PushSchemaLocation("https://endjin.com/Users/davebeaumont/source/cardano-public/OgmiosDotnet/src/Ogmios.Schema/Ogmios/v6.12/Source/cardano.json#/definitions/DelegateRepresentativeSummary");
        }
    ...
    public static partial class CorvusValidation
    {
        ...
        internal static ValidationContext CompositionOneOfValidationHandler(
            in DelegateRepresentativeSummary value,
            ...
            ValidationLevel level = ValidationLevel.Flag)
        {
            ...
            ValidationContext oneOfResult0 = value.As<Generated.DelegateRepresentativeSummary.DelegateRepresentativeSummaryRegistered>().Validate(oneOfChildContext0, level);
            ...
            ValidationContext oneOfResult1 = value.As<Generated.DelegateRepresentativeSummary.DelegateRepresentativeSummaryNoConfidence>().Validate(oneOfChildContext1, level);
            ...
            ValidationContext oneOfResult2 = value.As<Generated.DelegateRepresentativeSummary.DelegateRepresentativeAbstain>().Validate(oneOfChildContext2, level);
