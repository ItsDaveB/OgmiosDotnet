            ...
            public readonly partial struct RequiredCurrentNodeEraAndMinimumRequiredEra
            {
                ...
                public ValidationContext Validate(in ValidationContext validationContext, ValidationLevel level = ValidationLevel.Flag)
                {
                    ...
                    if (level > ValidationLevel.Basic)
                    {
                        ...
                        result = result.PushSchemaLocation("OgmiosDotnet/src/Ogmios.Schema/Ogmios/v6.12/Source/ogmios.json#/definitions/EvaluateTransactionFailure/oneOf/3/properties/data");
                    }
