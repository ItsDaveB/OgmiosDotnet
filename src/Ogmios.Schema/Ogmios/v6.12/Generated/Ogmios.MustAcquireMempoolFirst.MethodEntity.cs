...
public readonly partial struct Ogmios
{
    ...
    public readonly partial struct MustAcquireMempoolFirst
    {
...

        {
            ...
            /// </summary>
            public static string SchemaLocation { get; } = "https://endjin.com/Users/davebeaumont/source/cardano-public/OgmiosDotnet/src/Ogmios.Schema/Ogmios/v6.12/Source/ogmios.json#/properties/MustAcquireMempoolFirst/properties/method";
            ...
            /// <param name="matchHasTransaction">Match 1st item.</param>
            /// <param name="matchNextTransaction">Match 2nd item.</param>
            /// <param name="matchSizeOfMempool">Match 3rd item.</param>
            /// <param name="matchReleaseMempool">Match 4th item.</param>
            /// <param name="defaultMatch">Match any other value.</param>
            /// <returns>An instance of the value returned by the match function.</returns>
            public TOut Match<TIn, TOut>(
                in TIn context,
                Func<TIn, TOut> matchHasTransaction,
                Func<TIn, TOut> matchNextTransaction,
                Func<TIn, TOut> matchSizeOfMempool,
                Func<TIn, TOut> matchReleaseMempool,
                Func<TIn, TOut> defaultMatch)
            {
                if (this.Equals(CorvusValidation.Enum1))
                {
                    return matchHasTransaction(context);
                }

                if (this.Equals(CorvusValidation.Enum2))
                {
                    return matchNextTransaction(context);
                }

                if (this.Equals(CorvusValidation.Enum3))
                {
                    return matchSizeOfMempool(context);
                }

                if (this.Equals(CorvusValidation.Enum4))
                {
                    return matchReleaseMempool(context);
                }
            ...
            public TOut Match<TOut>(
                Func<TOut> matchHasTransaction,
                Func<TOut> matchNextTransaction,
                Func<TOut> matchSizeOfMempool,
                Func<TOut> matchReleaseMempool,
                Func<TOut> defaultMatch)
            {
                if (this.Equals(CorvusValidation.Enum1))
                {
                    return matchHasTransaction();
                }

                if (this.Equals(CorvusValidation.Enum2))
                {
                    return matchNextTransaction();
                }

                if (this.Equals(CorvusValidation.Enum3))
                {
                    return matchSizeOfMempool();
                }

                if (this.Equals(CorvusValidation.Enum4))
                {
                    return matchReleaseMempool();
                }
