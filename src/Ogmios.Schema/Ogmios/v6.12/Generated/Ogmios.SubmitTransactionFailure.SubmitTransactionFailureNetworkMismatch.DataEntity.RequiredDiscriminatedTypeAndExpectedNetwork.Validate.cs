                ...
                public readonly partial struct RequiredDiscriminatedTypeAndExpectedNetwork
                {
                    ...
                    public ValidationContext Validate(in ValidationContext validationContext, ValidationLevel level = ValidationLevel.Flag)
                    {
                        ...
                        if (level > ValidationLevel.Basic)
                        {
                            ...
                            result = result.PushSchemaLocation("https://endjin.com/Users/davebeaumont/source/cardano-public/OgmiosDotnet/src/Ogmios.Schema/Ogmios/v6.12/Source/ogmios.json#/definitions/SubmitTransactionFailure/oneOf/25/properties/data/oneOf/3");
                        }
                    ...
                    public static partial class CorvusValidation
                    {
                        ...
                        internal static ValidationContext ObjectValidationHandler(
                            in RequiredDiscriminatedTypeAndExpectedNetwork value,
                            JsonValueKind valueKind,
                            in ValidationContext validationContext,
                            ValidationLevel level = ValidationLevel.Flag)
                        {
                            ...
                            foreach (JsonObjectProperty property in value.EnumerateObject())
                            {
                                ...
                                if (property.NameEquals(JsonPropertyNames.DiscriminatedTypeUtf8, JsonPropertyNames.DiscriminatedType))
                                {
                                    ...
                                    ValidationContext propertyResult = property.Value.As<Generated.Ogmios.SubmitTransactionFailure.SubmitTransactionFailureNetworkMismatch.DataEntity.RequiredDiscriminatedTypeAndExpectedNetwork.DiscriminatedTypeEntity>().Validate(result.CreateChildContext(), level);
