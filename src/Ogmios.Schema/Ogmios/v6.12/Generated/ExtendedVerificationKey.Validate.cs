...
public readonly partial struct ExtendedVerificationKey
{
    ...
    public ValidationContext Validate(in ValidationContext validationContext, ValidationLevel level = ValidationLevel.Flag)
    {
        ...
        if (level > ValidationLevel.Basic)
        {
            ...
            result = result.PushSchemaLocation("https://endjin.com/Users/davebeaumont/source/cardano-public/OgmiosDotnet/src/Ogmios.Schema/Ogmios/v6.12/Source/cardano.json#/definitions/ExtendedVerificationKey");
        }
    ...
    public static partial class CorvusValidation
    {
        ...
        /// </summary>
        public static readonly long MaxLength = 128;

        /// <summary>
        /// A constant for the <c>minLength</c> keyword.
        /// </summary>
        public static readonly long MinLength = 128;
        ...
        internal static ValidationContext FormatValidationHandler(
            in ExtendedVerificationKey value,
            JsonValueKind valueKind,
            in ValidationContext validationContext,
            ValidationLevel level = ValidationLevel.Flag)
        {
