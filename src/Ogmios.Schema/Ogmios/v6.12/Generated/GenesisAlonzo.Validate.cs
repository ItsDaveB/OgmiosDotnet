...
public readonly partial struct GenesisAlonzo
{
    ...
    public ValidationContext Validate(in ValidationContext validationContext, ValidationLevel level = ValidationLevel.Flag)
    {
        ...
        if (level > ValidationLevel.Basic)
        {
            ...
            result = result.PushSchemaLocation("https://endjin.com/Users/davebeaumont/source/cardano-public/OgmiosDotnet/src/Ogmios.Schema/Ogmios/v6.12/Source/cardano.json#/definitions/Genesis<Alonzo>");
        }
            ...
            ValidationLevel level = ValidationLevel.Flag)
        {
            ...
            foreach (JsonObjectProperty property in value.EnumerateObject())
            {
                ...
                if (property.NameEquals(JsonPropertyNames.EraUtf8, JsonPropertyNames.Era))
                {
                    ...
                    ValidationContext propertyResult = property.Value.As<Generated.GenesisAlonzo.EraEntity>().Validate(result.CreateChildContext(), level);
                ...
                else if (property.NameEquals(JsonPropertyNames.UpdatableParametersUtf8, JsonPropertyNames.UpdatableParameters))
                {
                    ...
                    ValidationContext propertyResult = property.Value.As<Generated.GenesisAlonzo.UpdatableParametersEntity>().Validate(result.CreateChildContext(), level);
                    if (level == ValidationLevel.Flag && !propertyResult.IsValid)
                    {
                        return propertyResult;
                    }
