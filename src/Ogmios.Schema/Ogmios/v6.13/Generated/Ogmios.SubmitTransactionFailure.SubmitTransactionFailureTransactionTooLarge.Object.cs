...
public readonly partial struct Ogmios
{
    ...
    public readonly partial struct SubmitTransactionFailure
    {
        ...
        public readonly partial struct SubmitTransactionFailureTransactionTooLarge
            : IJsonObject<Generated.Ogmios.SubmitTransactionFailure.SubmitTransactionFailureTransactionTooLarge>
        {
            /// <summary>
            /// Conversion from <see cref="ImmutableList{JsonObjectProperty}"/>.
            /// </summary>
            /// <param name="value">The value from which to convert.</param>
            public static implicit operator SubmitTransactionFailureTransactionTooLarge(ImmutableList<JsonObjectProperty> value)
            {
                return new(value);
            }
            ...
            /// </summary>
            /// <param name="value">The value from which to convert.</param>
            public static implicit operator ImmutableList<JsonObjectProperty>(SubmitTransactionFailureTransactionTooLarge value)
            {
                return
            ...
            /// </summary>
            /// <param name="value">The value from which to convert.</param>
            public static implicit operator SubmitTransactionFailureTransactionTooLarge(JsonObject value)
            {
            ...
            /// </summary>
            /// <param name="value">The value from which to convert.</param>
            public static implicit operator JsonObject(SubmitTransactionFailureTransactionTooLarge value)
            {
                return
                    value.AsObject;
            }
            ...
            /// </para>
            /// </remarks>
            public Generated.Ogmios.SubmitTransactionFailure.SubmitTransactionFailureTransactionTooLarge.CodeEntity Code
            {
                get
                {
                    if ((this.backing & Backing.JsonElement) != 0)
                    ...
                    if ((this.backing & Backing.Object) != 0)
                    {
                        ...
                        {
                            return result.As<Generated.Ogmios.SubmitTransactionFailure.SubmitTransactionFailureTransactionTooLarge.CodeEntity>();
                        }
                    }
            ...
            /// </para>
            /// </remarks>
            public Generated.Ogmios.SubmitTransactionFailure.SubmitTransactionFailureTransactionTooLarge.RequiredMaximumTransactionSizeAndMeasuredTransactionSize Data
            {
                get
                {
                    if ((this.backing & Backing.JsonElement) != 0)
                    ...
                    if ((this.backing & Backing.Object) != 0)
                    {
                        ...
                        {
                            return result.As<Generated.Ogmios.SubmitTransactionFailure.SubmitTransactionFailureTransactionTooLarge.RequiredMaximumTransactionSizeAndMeasuredTransactionSize>();
                        }
                    }
            ...
            /// <inheritdoc/>
            public static SubmitTransactionFailureTransactionTooLarge FromProperties(IDictionary<JsonPropertyName, JsonAny> source)
            {
                return new(source.Select(kvp => new JsonObjectProperty(kvp.Key, kvp.Value)).ToImmutableList());
            }

            /// <inheritdoc/>
            public static SubmitTransactionFailureTransactionTooLarge FromProperties(params (JsonPropertyName Name, JsonAny Value)[] source)
            {
            ...
            public static SubmitTransactionFailureTransactionTooLarge FromProperties(ImmutableList<JsonObjectProperty> source)
            {
                return new(source);
            }

            /// <summary>
            /// Creates an instance of a <see cref="SubmitTransactionFailureTransactionTooLarge"/>.
            /// </summary>
            public static SubmitTransactionFailureTransactionTooLarge Create(
                in Generated.Ogmios.SubmitTransactionFailure.SubmitTransactionFailureTransactionTooLarge.CodeEntity code,
                in Generated.Ogmios.SubmitTransactionFailure.SubmitTransactionFailureTransactionTooLarge.RequiredMaximumTransactionSizeAndMeasuredTransactionSize data,
            ...
            public SubmitTransactionFailureTransactionTooLarge WithCode(in Generated.Ogmios.SubmitTransactionFailure.SubmitTransactionFailureTransactionTooLarge.CodeEntity value)
            {
            ...
            /// <param name="value">The new property value</param>
            /// <returns>The instance with the property set.</returns>
            public SubmitTransactionFailureTransactionTooLarge WithData(in Generated.Ogmios.SubmitTransactionFailure.SubmitTransactionFailureTransactionTooLarge.RequiredMaximumTransactionSizeAndMeasuredTransactionSize value)
            {
            ...
            /// <param name="value">The new property value</param>
            /// <returns>The instance with the property set.</returns>
            public SubmitTransactionFailureTransactionTooLarge WithMessage(in Corvus.Json.JsonString value)
            {
            ...
            /// <inheritdoc />
            public SubmitTransactionFailureTransactionTooLarge SetProperty<TValue>(in JsonPropertyName name, TValue value)
            ...
            /// <inheritdoc />
            public SubmitTransactionFailureTransactionTooLarge RemoveProperty(in JsonPropertyName name)
            {
                return new(__CorvusObjectHelpers.GetPropertyBackingWithout(this, name));
            }

            /// <inheritdoc />
            public SubmitTransactionFailureTransactionTooLarge RemoveProperty(string name)
            {
                return new(__CorvusObjectHelpers.GetPropertyBackingWithout(this, name));
            }

            /// <inheritdoc />
            public SubmitTransactionFailureTransactionTooLarge RemoveProperty(ReadOnlySpan<char> name)
            {
                return new(__CorvusObjectHelpers.GetPropertyBackingWithout(this, name));
            }

            /// <inheritdoc />
            public SubmitTransactionFailureTransactionTooLarge RemoveProperty(ReadOnlySpan<byte> name)
            {
                return new(__CorvusObjectHelpers.GetPropertyBackingWithout(this, name));
            }
            ...
            private static class __CorvusObjectHelpers
            {
                ...
                /// <exception cref="InvalidOperationException">The value is not an object.</exception>
                public static ImmutableList<JsonObjectProperty> GetPropertyBacking(in SubmitTransactionFailureTransactionTooLarge that)
                {
                ...
                /// <exception cref="InvalidOperationException">The value is not an object.</exception>
                public static ImmutableList<JsonObjectProperty> GetPropertyBackingWithout(in SubmitTransactionFailureTransactionTooLarge that, in JsonPropertyName name)
                {
                    if ((that.backing & Backing.Object) != 0)
                    {
                ...
                /// <returns>An immutable list of <see cref="JsonObjectProperty"/>, built from the existing object, without the given property.</returns>
                /// <exception cref="InvalidOperationException">The value is not an object.</exception>
                public static ImmutableList<JsonObjectProperty> GetPropertyBackingWithout(in SubmitTransactionFailureTransactionTooLarge that, ReadOnlySpan<char> name)
                {
                    if ((that.backing & Backing.Object) != 0)
                    {
                        return that.objectBacking.Remove(name);
                ...
                /// <returns>An immutable list of <see cref="JsonObjectProperty"/>, built from the existing object, without the given property.</returns>
                /// <exception cref="InvalidOperationException">The value is not an object.</exception>
                public static ImmutableList<JsonObjectProperty> GetPropertyBackingWithout(in SubmitTransactionFailureTransactionTooLarge that, ReadOnlySpan<byte> name)
                {
                    if ((that.backing & Backing.Object) != 0)
                    {
                        return that.objectBacking.Remove(name);
                ...
                /// <returns>An immutable list of <see cref="JsonObjectProperty"/>, built from the existing object, without the given property.</returns>
                /// <exception cref="InvalidOperationException">The value is not an object.</exception>
                public static ImmutableList<JsonObjectProperty> GetPropertyBackingWithout(in SubmitTransactionFailureTransactionTooLarge that, string name)
                {
                    if ((that.backing & Backing.Object) != 0)
                    {
                        return that.objectBacking.Remove(name);
                ...
                /// <exception cref="InvalidOperationException">The value is not an object.</exception>
                public static ImmutableList<JsonObjectProperty> GetPropertyBackingWith(in SubmitTransactionFailureTransactionTooLarge that, in JsonPropertyName name, in JsonAny value)
                {
                    if ((that.backing & Backing.Object) != 0)
                    {
