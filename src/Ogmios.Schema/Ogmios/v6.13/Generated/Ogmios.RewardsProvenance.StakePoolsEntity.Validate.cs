        ...
        public readonly partial struct StakePoolsEntity
        {
            ...
            public ValidationContext Validate(in ValidationContext validationContext, ValidationLevel level = ValidationLevel.Flag)
            {
                ...
                if (level > ValidationLevel.Basic)
                {
                    ...
                    result = result.PushSchemaLocation("OgmiosDotnet/src/Ogmios.Schema/Ogmios/v6.13/Source/ogmios.json#/definitions/RewardsProvenance/properties/stakePools");
                }
            ...
            public static partial class CorvusValidation
            {
                    ...
                    ValidationLevel level = ValidationLevel.Flag)
                {
                    ...
                    int propertyCount = 0;
                    foreach (JsonObjectProperty<Generated.Ogmios.RewardsProvenance.StakePoolsEntity.StakePoolRewardsProvenance> property in value.EnumerateObject())
                    {
