...
public readonly partial struct Ogmios
{
    ...
    public ValidationContext Validate(in ValidationContext validationContext, ValidationLevel level = ValidationLevel.Flag)
    {
        ...
        if (level > ValidationLevel.Basic)
        {
            ...
            result = result.PushSchemaLocation("OgmiosDotnet/src/Ogmios.Schema/Ogmios/v6.13/Source/ogmios.json");
        }
    ...
    public static partial class CorvusValidation
    {
            ...
            ValidationLevel level = ValidationLevel.Flag)
        {
            ...
            bool hasSeenQueryLedgerStateStakePoolsPerformancesValue = false;
            bool hasSeenQueryLedgerStateStakePoolsPerformancesResponse = false;
            ...
            foreach (JsonObjectProperty property in value.EnumerateObject())
            {
                ...
                else if (property.NameEquals(JsonPropertyNames.QueryLedgerStateStakePoolsPerformancesValueUtf8, JsonPropertyNames.QueryLedgerStateStakePoolsPerformancesValue))
                {
                    hasSeenQueryLedgerStateStakePoolsPerformancesValue = true;
                    result = result.WithLocalProperty(propertyCount);
                    if (level > ValidationLevel.Basic)
                    {
                        result = result.PushValidationLocationReducedPathModifierAndProperty(new("#/properties/QueryLedgerStateStakePoolsPerformances"), JsonPropertyNames.QueryLedgerStateStakePoolsPerformancesValue);
                    }

                    ValidationContext propertyResult = property.Value.As<Generated.Ogmios.QueryLedgerStateStakePoolsPerformances>().Validate(result.CreateChildContext(), level);
                    if (level == ValidationLevel.Flag && !propertyResult.IsValid)
                    {
                        return propertyResult;
                    }
                ...
                else if (property.NameEquals(JsonPropertyNames.QueryLedgerStateStakePoolsPerformancesResponseUtf8, JsonPropertyNames.QueryLedgerStateStakePoolsPerformancesResponse))
                {
                    hasSeenQueryLedgerStateStakePoolsPerformancesResponse = true;
                    result = result.WithLocalProperty(propertyCount);
                    if (level > ValidationLevel.Basic)
                    {
                        result = result.PushValidationLocationReducedPathModifierAndProperty(new("#/properties/QueryLedgerStateStakePoolsPerformancesResponse"), JsonPropertyNames.QueryLedgerStateStakePoolsPerformancesResponse);
                    }

                    ValidationContext propertyResult = property.Value.As<Generated.Ogmios.QueryLedgerStateStakePoolsPerformancesResponseEntity>().Validate(result.CreateChildContext(), level);
                    if (level == ValidationLevel.Flag && !propertyResult.IsValid)
                    {
                        return propertyResult;
                    }
            ...
            if (!hasSeenQueryLedgerStateStakePoolsPerformancesValue)
            {
                if (level >= ValidationLevel.Basic)
                {
                    result = result.WithResult(isValid: false, "Validation properties - the required property 'QueryLedgerStateStakePoolsPerformances' was not present.");
                }
                else
                {
                    return ValidationContext.InvalidContext;
            ...
            {
                result = result.WithResult(isValid: true, "Validation properties - the required property 'QueryLedgerStateStakePoolsPerformances' was present.");
            }
            ...
            if (!hasSeenQueryLedgerStateStakePoolsPerformancesResponse)
            {
                if (level >= ValidationLevel.Basic)
                {
                    result = result.WithResult(isValid: false, "Validation properties - the required property 'QueryLedgerStateStakePoolsPerformancesResponse' was not present.");
                }
                else
                {
                    return ValidationContext.InvalidContext;
            ...
            {
                result = result.WithResult(isValid: true, "Validation properties - the required property 'QueryLedgerStateStakePoolsPerformancesResponse' was present.");
            }
            ...
            if (level > ValidationLevel.Basic)
            {
                result = result.PushValidationLocationReducedPathModifier(new("#/required/71"));
            }
            ...
            if (level > ValidationLevel.Basic)
            {
                result = result.PushValidationLocationReducedPathModifier(new("#/required/72"));
            }
