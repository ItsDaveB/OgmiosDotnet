            ...
            public readonly partial struct RequiredDeclaredSpendingAndMismatchReason
            {
                ...
                public ValidationContext Validate(in ValidationContext validationContext, ValidationLevel level = ValidationLevel.Flag)
                {
                    ...
                    if (level > ValidationLevel.Basic)
                    {
                        ...
                        result = result.PushSchemaLocation("OgmiosDotnet/src/Ogmios.Schema/Ogmios/v6.13/Source/ogmios.json#/definitions/SubmitTransactionFailure/oneOf/37/properties/data");
                    }
