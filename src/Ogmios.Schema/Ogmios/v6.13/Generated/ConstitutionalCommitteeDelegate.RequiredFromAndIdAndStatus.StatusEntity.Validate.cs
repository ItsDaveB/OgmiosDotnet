        ...
        public readonly partial struct StatusEntity
        {
            ...
            public ValidationContext Validate(in ValidationContext validationContext, ValidationLevel level = ValidationLevel.Flag)
            {
                ...
                if (level > ValidationLevel.Basic)
                {
                    ...
                    result = result.PushSchemaLocation("OgmiosDotnet/src/Ogmios.Schema/Ogmios/v6.13/Source/cardano.json#/definitions/ConstitutionalCommitteeDelegate/oneOf/0/properties/status");
                }
