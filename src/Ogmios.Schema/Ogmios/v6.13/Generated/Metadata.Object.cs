...
public readonly partial struct Metadata
    : IJsonObject<Generated.Metadata>
{
    /// <summary>
    ...
    /// </para>
    /// </remarks>
    public Generated.MetadataLabels Labels
    {
        get
        {
            if ((this.backing & Backing.JsonElement) != 0)
            {
                ...
                if (this.jsonElementBacking.TryGetProperty(JsonPropertyNames.LabelsUtf8, out JsonElement result))
                {
                    return new(result);
                }
            }
            ...
            if ((this.backing & Backing.Object) != 0)
            {
                if (this.objectBacking.TryGetValue(JsonPropertyNames.Labels, out JsonAny result))
                {
                    return result.As<Generated.MetadataLabels>();
                }
            }
    ...
    /// </summary>
    public static Metadata Create(in Generated.DigestBlake2b256 hash, in Generated.MetadataLabels labels)
    {
        var builder = ImmutableList.CreateBuilder<JsonObjectProperty>();
        builder.Add(JsonPropertyNames.Hash, hash.AsAny);
        builder.Add(JsonPropertyNames.Labels, labels.AsAny);
    ...
    /// </para>
    /// </remarks>
    public Metadata WithHash(in Generated.DigestBlake2b256 value)
    {
        return this.SetProperty(JsonPropertyNames.Hash, value);
    }

    /// <summary>
    /// Sets the <c>labels</c> property.
    /// </summary>
    /// <param name="value">The new property value</param>
    /// <returns>The instance with the property set.</returns>
    public Metadata WithLabels(in Generated.MetadataLabels value)
    {
        return this.SetProperty(JsonPropertyNames.Labels, value);
    }
