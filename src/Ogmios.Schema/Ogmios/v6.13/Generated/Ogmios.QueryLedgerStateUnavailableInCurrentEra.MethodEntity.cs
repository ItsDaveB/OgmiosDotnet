...
public readonly partial struct Ogmios
{
    ...
    public readonly partial struct QueryLedgerStateUnavailableInCurrentEra
    {
...

        {
            ...
            /// </summary>
            public static string SchemaLocation { get; } = "OgmiosDotnet/src/Ogmios.Schema/Ogmios/v6.13/Source/ogmios.json#/properties/QueryLedgerStateUnavailableInCurrentEra/properties/method";
            ...
            /// <param name="matchQueryLedgerStateDelegateRepresentatives">Match 3rd item.</param>
            /// <param name="matchQueryLedgerStateEpoch">Match 4th item.</param>
            /// <param name="matchQueryLedgerStateEraStart">Match 5th item.</param>
            /// <param name="matchQueryLedgerStateEraSummaries">Match 6th item.</param>
            /// <param name="matchQueryLedgerStateGovernanceProposals">Match 7th item.</param>
            /// <param name="matchQueryLedgerStateLiveStakeDistribution">Match 8th item.</param>
            /// <param name="matchQueryLedgerStateNonces">Match 9th item.</param>
            /// <param name="matchQueryLedgerStateOperationalCertificates">Match 10th item.</param>
            /// <param name="matchQueryLedgerStateProjectedRewards">Match 11th item.</param>
            /// <param name="matchQueryLedgerStateProtocolParameters">Match 12th item.</param>
            /// <param name="matchQueryLedgerStateProposedProtocolParameters">Match 13th item.</param>
            /// <param name="matchQueryLedgerStateRewardAccountSummaries">Match 14th item.</param>
            /// <param name="matchQueryLedgerStateRewardsProvenance">Match 15th item.</param>
            /// <param name="matchQueryLedgerStateStakePools">Match 16th item.</param>
            /// <param name="matchQueryLedgerStateStakePoolsPerformances">Match 17th item.</param>
            /// <param name="matchQueryLedgerStateUtxo">Match 18th item.</param>
            /// <param name="matchQueryLedgerStateTip">Match 19th item.</param>
            /// <param name="matchQueryLedgerStateTreasuryAndReserves">Match 20th item.</param>
            ...
            public TOut Match<TIn, TOut>(
                ...
                Func<TIn, TOut> matchQueryLedgerStateDelegateRepresentatives,
                ...
                Func<TIn, TOut> matchQueryLedgerStateNonces,
                Func<TIn, TOut> matchQueryLedgerStateOperationalCertificates,
                ...
                Func<TIn, TOut> matchQueryLedgerStateStakePoolsPerformances,
                ...
                Func<TIn, TOut> defaultMatch)
            {
                ...
                {
                    return matchQueryLedgerStateDelegateRepresentatives(context);
                }
                ...
                {
                    return matchQueryLedgerStateNonces(context);
                }

                if (this.Equals(CorvusValidation.Enum10))
                {
                    return matchQueryLedgerStateOperationalCertificates(context);
                }
                ...
                {
                    return matchQueryLedgerStateStakePoolsPerformances(context);
                }
            ...
            public TOut Match<TOut>(
                ...
                Func<TOut> matchQueryLedgerStateDelegateRepresentatives,
                ...
                Func<TOut> matchQueryLedgerStateNonces,
                Func<TOut> matchQueryLedgerStateOperationalCertificates,
                ...
                Func<TOut> matchQueryLedgerStateStakePoolsPerformances,
                ...
                Func<TOut> defaultMatch)
            {
                ...
                if (this.Equals(CorvusValidation.Enum3))
                {
                    return matchQueryLedgerStateDelegateRepresentatives();
                }
                ...
                if (this.Equals(CorvusValidation.Enum9))
                {
                    return matchQueryLedgerStateNonces();
                }

                if (this.Equals(CorvusValidation.Enum10))
                {
                    return matchQueryLedgerStateOperationalCertificates();
                }
                ...
                if (this.Equals(CorvusValidation.Enum17))
                {
                    return matchQueryLedgerStateStakePoolsPerformances();
                }
