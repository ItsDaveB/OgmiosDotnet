            ...
            public readonly partial struct RequiredCredentialAndFrom
            {
                ...
                public ValidationContext Validate(in ValidationContext validationContext, ValidationLevel level = ValidationLevel.Flag)
                {
                    ...
                    if (level > ValidationLevel.Basic)
                    {
                        ...
                        result = result.PushSchemaLocation("OgmiosDotnet/src/Ogmios.Schema/Ogmios/v6.13/Source/cardano.json#/definitions/DelegateRepresentativeSummary/oneOf/0/properties/delegators/items");
                    }
