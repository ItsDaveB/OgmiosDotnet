        ...
        public readonly partial struct QueryLedgerStateRewardAccountSummariesResponse
        {
            ...
            public ValidationContext Validate(in ValidationContext validationContext, ValidationLevel level = ValidationLevel.Flag)
            {
                ...
                if (level > ValidationLevel.Basic)
                {
                    ...
                    result = result.PushSchemaLocation("OgmiosDotnet/src/Ogmios.Schema/Ogmios/v6.13/Source/ogmios.json#/properties/QueryLedgerStateRewardAccountSummariesResponse/oneOf/0");
                }
                    ...
                    ValidationLevel level = ValidationLevel.Flag)
                {
                    ...
                    foreach (JsonObjectProperty property in value.EnumerateObject())
                    {
                        ...
                        else if (property.NameEquals(JsonPropertyNames.ResultUtf8, JsonPropertyNames.Result))
                        {
                            ...
                            ValidationContext propertyResult = property.Value.As<Generated.Ogmios.QueryLedgerStateRewardAccountSummariesResponseEntity.QueryLedgerStateRewardAccountSummariesResponse.RewardAccountSummaryArray>().Validate(result.CreateChildContext(), level);
                            if (level == ValidationLevel.Flag && !propertyResult.IsValid)
                            {
                                return propertyResult;
                            }
