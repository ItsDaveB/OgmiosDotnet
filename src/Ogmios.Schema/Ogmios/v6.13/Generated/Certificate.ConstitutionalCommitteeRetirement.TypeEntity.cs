...
public readonly partial struct Certificate
{
    ...
    public readonly partial struct ConstitutionalCommitteeRetirement
    {
...

        {
            ...
            /// </summary>
            public static string SchemaLocation { get; } = "OgmiosDotnet/src/Ogmios.Schema/Ogmios/v6.13/Source/cardano.json#/definitions/Certificate/oneOf/7/properties/type";
