...
public class ChainSynchronizationMessageHandlersTests
{
    ...
    private static NextBlockResponse CreateMockResponse(string direction)
    {
        ...
        {
            "backward" => NextBlockResponse.Create(NextBlockResponse.JsonrpcEntity.EnumValues.Value20, NextBlockResponse.MethodEntity.EnumValues.NextBlock,
            ...
            "forward" => NextBlockResponse.Create(NextBlockResponse.JsonrpcEntity.EnumValues.Value20, NextBlockResponse.MethodEntity.EnumValues.NextBlock,
