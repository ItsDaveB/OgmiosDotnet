        ...
        public readonly partial struct SubmitTransactionFailureNetworkMismatch
        {
            ...
            public readonly partial struct DataEntity
            {
                ...
                public readonly partial struct DataEntityRequiredDiscriminatedTypeAndExpectedNetworkAndInvalidEntities
                {
                    ...
                    /// </summary>
#if NET8_0_OR_GREATER
                    [CollectionBuilder(typeof(RewardAccountArray), "Create")]
#endif
                    public readonly partial struct RewardAccountArray
                        : IJsonArray<Generated.Ogmios.SubmitTransactionFailure.SubmitTransactionFailureNetworkMismatch.DataEntity.DataEntityRequiredDiscriminatedTypeAndExpectedNetworkAndInvalidEntities.RewardAccountArray>,
                          IReadOnlyCollection<Generated.RewardAccount>
                    {
                        /// <summary>
                        /// Gets an empty array.
                        /// </summary>
                        public static RewardAccountArray EmptyArray { get; } = From(ImmutableList<JsonAny>.Empty);
                        ...
                        /// <inheritdoc/>
                        Corvus.Json.JsonAny IJsonArray<RewardAccountArray>.this[int index]
                        {
                            get
                            {
                        ...
                        public Generated.RewardAccount this[int index]
                        {
                            get
                            {
                                if ((this.backing & Backing.JsonElement) != 0)
                                ...
                                if ((this.backing & Backing.Array) != 0)
                                {
                                    try
                                    {
                                        return this.arrayBacking[index].As<Generated.RewardAccount>();
                                    }
                                    catch (ArgumentOutOfRangeException ex)
                                    {
                                        throw new IndexOutOfRangeException(ex.Message, ex);
                        ...
                        public static implicit operator RewardAccountArray(ImmutableList<JsonAny> value)
                        {
                            return new(value);
                        }
                        ...
                        /// </summary>
                        /// <param name="value">The value from which to convert.</param>
                        public static implicit operator ImmutableList<JsonAny>(RewardAccountArray value)
                        {
                            return
                        ...
                        /// </summary>
                        /// <param name="value">The value from which to convert.</param>
                        public static implicit operator RewardAccountArray(JsonArray value)
                        {
                        ...
                        /// </summary>
                        /// <param name="value">The value from which to convert.</param>
                        public static implicit operator JsonArray(RewardAccountArray value)
                        {
                            return
                                value.AsArray;
                        }
                        ...
                        /// <summary>
                        /// Initializes a new instance of the <see cref="RewardAccountArray"/> struct.
                        /// </summary>
                        ...
                        public static RewardAccountArray From(ImmutableList<JsonAny> items)
                        {
                            return new(items);
                        }

                        /// <summary>
                        /// Create an new instance of the <see cref="RewardAccountArray"/>" struct from a span of items.
                        /// </summary>
                        ...
                        public static RewardAccountArray Create(ReadOnlySpan<Generated.RewardAccount> items)
                        {
                            return new([..items]);
                        }
                        ...
                        public static RewardAccountArray FromItems(params Generated.RewardAccount[] items)
                        {
                            return new([..items]);
                        }
                        ...
                        public static RewardAccountArray FromItems(in Generated.RewardAccount item1)
                        {
                        ...
                        /// <returns>An instance of the array constructed from the values.</returns>
                        public static RewardAccountArray FromItems(in Generated.RewardAccount item1, in Generated.RewardAccount item2)
                        {
                        ...
                        /// <returns>An instance of the array constructed from the values.</returns>
                        public static RewardAccountArray FromItems(in Generated.RewardAccount item1, in Generated.RewardAccount item2, in Generated.RewardAccount item3)
                        {
                        ...
                        /// <returns>An instance of the array constructed from the values.</returns>
                        public static RewardAccountArray FromItems(in Generated.RewardAccount item1, in Generated.RewardAccount item2, in Generated.RewardAccount item3, in Generated.RewardAccount item4)
                        {
                        ...
                        /// <returns>An instance of the array constructed from the values.</returns>
                        public static RewardAccountArray FromItems(in Generated.RewardAccount item1, in Generated.RewardAccount item2, in Generated.RewardAccount item3, in Generated.RewardAccount item4, in Generated.RewardAccount item5)
                        {
                        ...
                        /// <returns>An instance of the array constructed from the values.</returns>
                        public static RewardAccountArray FromItems(in Generated.RewardAccount item1, in Generated.RewardAccount item2, in Generated.RewardAccount item3, in Generated.RewardAccount item4, in Generated.RewardAccount item5, in Generated.RewardAccount item6)
                        {
                        ...
                        /// <returns>An instance of the array constructed from the values.</returns>
                        public static RewardAccountArray FromItems(in Generated.RewardAccount item1, in Generated.RewardAccount item2, in Generated.RewardAccount item3, in Generated.RewardAccount item4, in Generated.RewardAccount item5, in Generated.RewardAccount item6, in Generated.RewardAccount item7)
                        {
                        ...
                        public static RewardAccountArray FromRange(IEnumerable<Generated.RewardAccount> items)
                        {
                            return new([..items]);
                        }
                        ...
                        /// <param name="items">The items from which to construct the instance.</param>
                        /// <returns>An instance of the array constructed from the items .</returns>
                        static RewardAccountArray IJsonArray<RewardAccountArray>.FromRange(IEnumerable<JsonAny> items)
                        {
                            return new([..items]);
                        }
                        ...
                        /// <param name="items">The items from which to construct the instance.</param>
                        /// <returns>An instance of the array constructed from the items.</returns>
                        static RewardAccountArray IJsonArray<RewardAccountArray>.FromRange<T>(IEnumerable<T> items)
                        {
                        ...
                        /// <inheritdoc/>
                        IEnumerator<Generated.RewardAccount> IEnumerable<Generated.RewardAccount>.GetEnumerator() => this.EnumerateArray();

                        /// <inheritdoc/>
                        IEnumerator IEnumerable.GetEnumerator() => this.EnumerateArray();

                        /// <inheritdoc/>
                        int IReadOnlyCollection<Generated.RewardAccount>.Count => this.GetArrayLength();
                        ...
                        /// <inheritdoc/>
                        public JsonArrayEnumerator<Generated.RewardAccount> EnumerateArray()
                        {
                            if ((this.backing & Backing.JsonElement) != 0)
                            {
                        ...
                        /// <inheritdoc/>
                        JsonArrayEnumerator IJsonArray<RewardAccountArray>.EnumerateArray()
                        {
                            if ((this.backing & Backing.JsonElement) != 0)
                            {
                                return new(this.jsonElementBacking);
                        ...
                        /// <inheritdoc/>
                        JsonArrayEnumerator<TItem> IJsonArray<RewardAccountArray>.EnumerateArray<TItem>()
                        {
                            if ((this.backing & Backing.JsonElement) != 0)
                            {
                                return new(this.jsonElementBacking);
                        ...
                        /// <inheritdoc/>
                        RewardAccountArray IJsonArray<RewardAccountArray>.Add(in JsonAny item1)
                        {
                        ...
                        /// <inheritdoc/>
                        RewardAccountArray IJsonArray<RewardAccountArray>.Add(params JsonAny[] items)
                        {
                            ImmutableList<JsonAny>.Builder builder = __CorvusArrayHelpers.GetImmutableListBuilder(this);
                        ...
                        /// <inheritdoc/>
                        RewardAccountArray IJsonArray<RewardAccountArray>.AddRange<TArray>(in TArray items)
                        {
                            ImmutableList<JsonAny>.Builder builder = __CorvusArrayHelpers.GetImmutableListBuilder(this);
                        ...
                        /// <inheritdoc/>
                        RewardAccountArray IJsonArray<RewardAccountArray>.AddRange<TItem>(IEnumerable<TItem> items)
                        {
                            ImmutableList<JsonAny>.Builder builder = __CorvusArrayHelpers.GetImmutableListBuilder(this);
                        ...
                        /// <inheritdoc/>
                        RewardAccountArray IJsonArray<RewardAccountArray>.AddRange(IEnumerable<JsonAny> items)
                        {
                            ImmutableList<JsonAny>.Builder builder = __CorvusArrayHelpers.GetImmutableListBuilder(this);
                        ...
                        /// <inheritdoc/>
                        RewardAccountArray IJsonArray<RewardAccountArray>.Insert(int index, in JsonAny item1)
                        {
                            return new(__CorvusArrayHelpers.GetImmutableListWith(this, index, item1));
                        }

                        /// <inheritdoc/>
                        RewardAccountArray IJsonArray<RewardAccountArray>.InsertRange<TArray>(int index, in TArray items)
                        {
                            return new(__CorvusArrayHelpers.GetImmutableListWith(this, index, items.EnumerateArray()));
                        }

                        /// <inheritdoc/>
                        RewardAccountArray IJsonArray<RewardAccountArray>.InsertRange<TItem>(int index, IEnumerable<TItem> items)
                        {
                            return new(__CorvusArrayHelpers.GetImmutableListWith(this, index, items.Select(item => item.AsAny)));
                        }

                        /// <inheritdoc/>
                        RewardAccountArray IJsonArray<RewardAccountArray>.InsertRange(int index, IEnumerable<JsonAny> items)
                        {
                            return new(__CorvusArrayHelpers.GetImmutableListWith(this, index, items));
                        }

                        /// <inheritdoc/>
                        RewardAccountArray IJsonArray<RewardAccountArray>.Replace(in JsonAny oldValue, in JsonAny newValue)
                        {
                            return new(__CorvusArrayHelpers.GetImmutableListReplacing(this, oldValue, newValue));
                        }

                        /// <inheritdoc/>
                        RewardAccountArray IJsonArray<RewardAccountArray>.SetItem(int index, in JsonAny value)
                        {
                            return new(__CorvusArrayHelpers.GetImmutableListSetting(this, index, value));
                        }

                        /// <inheritdoc/>
                        public RewardAccountArray Add(in Generated.RewardAccount item1)
                        {
                            ImmutableList<JsonAny>.Builder builder = __CorvusArrayHelpers.GetImmutableListBuilder(this);
                        ...
                        /// <inheritdoc/>
                        public RewardAccountArray Add(params Generated.RewardAccount[] items)
                        {
                            ImmutableList<JsonAny>.Builder builder = __CorvusArrayHelpers.GetImmutableListBuilder(this);
                            foreach (Generated.RewardAccount item in items)
                            {
                                builder.Add(item.AsAny);
                            }
                        ...
                        /// <inheritdoc/>
                        public RewardAccountArray AddRange(IEnumerable<Generated.RewardAccount> items)
                        {
                            ImmutableList<JsonAny>.Builder builder = __CorvusArrayHelpers.GetImmutableListBuilder(this);
                            foreach (Generated.RewardAccount item in items)
                            {
                        ...
                        /// <inheritdoc/>
                        public RewardAccountArray Insert(int index, in Generated.RewardAccount item1)
                        {
                            return new(__CorvusArrayHelpers.GetImmutableListWith(this, index, item1));
                        }

                        /// <inheritdoc/>
                        public RewardAccountArray InsertRange(int index, IEnumerable<Generated.RewardAccount> items)
                        {
                            return new(__CorvusArrayHelpers.GetImmutableListWith(this, index, items.Select(item => item.AsAny)));
                        }

                        /// <inheritdoc/>
                        public RewardAccountArray Replace(in Generated.RewardAccount oldValue, in Generated.RewardAccount newValue)
                        {
                            return new(__CorvusArrayHelpers.GetImmutableListReplacing(this, oldValue, newValue));
                        }

                        /// <inheritdoc/>
                        public RewardAccountArray SetItem(int index, in Generated.RewardAccount value)
                        {
                            return new(__CorvusArrayHelpers.GetImmutableListSetting(this, index, value));
                        }

                        /// <inheritdoc/>
                        RewardAccountArray IJsonArray<RewardAccountArray>.Remove(in JsonAny oldValue)
                        {
                            return new(__CorvusArrayHelpers.GetImmutableListWithout(this, oldValue));
                        }

                        /// <inheritdoc/>
                        RewardAccountArray IJsonArray<RewardAccountArray>.RemoveAt(int index)
                        {
                            return new(__CorvusArrayHelpers.GetImmutableListWithoutRange(this, index, 1));
                        }

                        /// <inheritdoc/>
                        RewardAccountArray IJsonArray<RewardAccountArray>.RemoveRange(int index, int count)
                        {
                            return new(__CorvusArrayHelpers.GetImmutableListWithoutRange(this, index, count));
                        }

                        /// <inheritdoc/>
                        public RewardAccountArray Remove(in Generated.RewardAccount oldValue)
                        {
                            return new(__CorvusArrayHelpers.GetImmutableListWithout(this, oldValue));
                        }
                        ...
                        private static class __CorvusArrayHelpers
                        {
                            ...
                            /// <exception cref = "InvalidOperationException">The value is not an array.</exception>
                            public static ImmutableList<JsonAny> GetImmutableList(in RewardAccountArray arrayInstance)
                            {
                            ...
                            /// <exception cref = "InvalidOperationException">The value is not an array.</exception>
                            public static ImmutableList<JsonAny>.Builder GetImmutableListBuilder(in RewardAccountArray arrayInstance)
                            {
                            ...
                            public static ImmutableList<JsonAny> GetImmutableListSetting(in RewardAccountArray arrayInstance, int index, in JsonAny value)
                            {
                                if ((arrayInstance.backing & Backing.JsonElement) != 0)
                                {
                                    if (arrayInstance.jsonElementBacking.ValueKind == JsonValueKind.Array)
                            ...
                            /// <exception cref = "InvalidOperationException">The value is not an array.</exception>
                            public static ImmutableList<JsonAny> GetImmutableListReplacing(in RewardAccountArray arrayInstance, in JsonAny oldItem, in JsonAny newItem)
                            {
                                if ((arrayInstance.backing & Backing.JsonElement) != 0)
                                {
                                    if (arrayInstance.jsonElementBacking.ValueKind == JsonValueKind.Array)
                            ...
                            /// <exception cref = "InvalidOperationException">The value is not an array.</exception>
                            public static ImmutableList<JsonAny> GetImmutableListWithout(in RewardAccountArray arrayInstance, in JsonAny item)
                            {
                                if ((arrayInstance.backing & Backing.JsonElement) != 0)
                                {
                                    if (arrayInstance.jsonElementBacking.ValueKind == JsonValueKind.Array)
                            ...
                            /// <exception cref = "InvalidOperationException">The value is not an array.</exception>
                            /// <exception cref = "IndexOutOfRangeException">Thrown if the range is beyond the bounds of the array.</exception>
                            public static ImmutableList<JsonAny> GetImmutableListWithoutRange(in RewardAccountArray arrayInstance, int index, int count)
                            {
                                if ((arrayInstance.backing & Backing.JsonElement) != 0)
                                {
                                    if (arrayInstance.jsonElementBacking.ValueKind == JsonValueKind.Array)
                            ...
                            // <exception cref = "InvalidOperationException">The value is not an array.</exception>
                            // <exception cref = "IndexOutOfRangeException">Thrown if the range is beyond the bounds of the array.</exception>
                            public static ImmutableList<JsonAny> GetImmutableListWith(in RewardAccountArray arrayInstance, int index, in JsonAny value)
                            {
                                if ((arrayInstance.backing & Backing.JsonElement) != 0)
                                {
                                    if (arrayInstance.jsonElementBacking.ValueKind == JsonValueKind.Array)
                            ...
                            /// <exception cref = "InvalidOperationException">The value is not an array.</exception>
                            /// <exception cref = "IndexOutOfRangeException">Thrown if the range is beyond the bounds of the array.</exception>
                            public static ImmutableList<JsonAny> GetImmutableListWith<TEnumerable>(in RewardAccountArray arrayInstance, int index, TEnumerable values)
