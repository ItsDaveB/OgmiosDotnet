...
/// </summary>
public readonly partial struct BootstrapProtocolUpdate
{
    /// <summary>
    /// Generated from JSON Schema.
    /// </summary>
#if NET8_0_OR_GREATER
    [CollectionBuilder(typeof(BootstrapVoteArray), "Create")]
#endif
    public readonly partial struct BootstrapVoteArray
        : IJsonArray<Generated.BootstrapProtocolUpdate.BootstrapVoteArray>,
          IReadOnlyCollection<Generated.BootstrapVote>
    {
        /// <summary>
        /// Gets an empty array.
        /// </summary>
        public static BootstrapVoteArray EmptyArray { get; } = From(ImmutableList<JsonAny>.Empty);
        ...
        /// <inheritdoc/>
        Corvus.Json.JsonAny IJsonArray<BootstrapVoteArray>.this[int index]
        {
            get
            {
        ...
        public Generated.BootstrapVote this[int index]
        {
            get
            {
                if ((this.backing & Backing.JsonElement) != 0)
                ...
                if ((this.backing & Backing.Array) != 0)
                {
                    try
                    {
                        return this.arrayBacking[index].As<Generated.BootstrapVote>();
                    }
                    catch (ArgumentOutOfRangeException ex)
                    {
                        throw new IndexOutOfRangeException(ex.Message, ex);
        ...
        public static implicit operator BootstrapVoteArray(ImmutableList<JsonAny> value)
        {
            return new(value);
        }
        ...
        /// </summary>
        /// <param name="value">The value from which to convert.</param>
        public static implicit operator ImmutableList<JsonAny>(BootstrapVoteArray value)
        {
            return
        ...
        /// </summary>
        /// <param name="value">The value from which to convert.</param>
        public static implicit operator BootstrapVoteArray(JsonArray value)
        {
        ...
        /// </summary>
        /// <param name="value">The value from which to convert.</param>
        public static implicit operator JsonArray(BootstrapVoteArray value)
        {
            return
                value.AsArray;
        }
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="BootstrapVoteArray"/> struct.
        /// </summary>
        ...
        public static BootstrapVoteArray From(ImmutableList<JsonAny> items)
        {
            return new(items);
        }

        /// <summary>
        /// Create an new instance of the <see cref="BootstrapVoteArray"/>" struct from a span of items.
        /// </summary>
        ...
        public static BootstrapVoteArray Create(ReadOnlySpan<Generated.BootstrapVote> items)
        {
            return new([..items]);
        }
        ...
        public static BootstrapVoteArray FromItems(params Generated.BootstrapVote[] items)
        {
            return new([..items]);
        }
        ...
        public static BootstrapVoteArray FromItems(in Generated.BootstrapVote item1)
        {
        ...
        /// <returns>An instance of the array constructed from the values.</returns>
        public static BootstrapVoteArray FromItems(in Generated.BootstrapVote item1, in Generated.BootstrapVote item2)
        {
        ...
        /// <returns>An instance of the array constructed from the values.</returns>
        public static BootstrapVoteArray FromItems(in Generated.BootstrapVote item1, in Generated.BootstrapVote item2, in Generated.BootstrapVote item3)
        {
        ...
        /// <returns>An instance of the array constructed from the values.</returns>
        public static BootstrapVoteArray FromItems(in Generated.BootstrapVote item1, in Generated.BootstrapVote item2, in Generated.BootstrapVote item3, in Generated.BootstrapVote item4)
        {
        ...
        /// <returns>An instance of the array constructed from the values.</returns>
        public static BootstrapVoteArray FromItems(in Generated.BootstrapVote item1, in Generated.BootstrapVote item2, in Generated.BootstrapVote item3, in Generated.BootstrapVote item4, in Generated.BootstrapVote item5)
        {
        ...
        /// <returns>An instance of the array constructed from the values.</returns>
        public static BootstrapVoteArray FromItems(in Generated.BootstrapVote item1, in Generated.BootstrapVote item2, in Generated.BootstrapVote item3, in Generated.BootstrapVote item4, in Generated.BootstrapVote item5, in Generated.BootstrapVote item6)
        {
        ...
        /// <returns>An instance of the array constructed from the values.</returns>
        public static BootstrapVoteArray FromItems(in Generated.BootstrapVote item1, in Generated.BootstrapVote item2, in Generated.BootstrapVote item3, in Generated.BootstrapVote item4, in Generated.BootstrapVote item5, in Generated.BootstrapVote item6, in Generated.BootstrapVote item7)
        {
        ...
        public static BootstrapVoteArray FromRange(IEnumerable<Generated.BootstrapVote> items)
        {
            return new([..items]);
        }
        ...
        /// <param name="items">The items from which to construct the instance.</param>
        /// <returns>An instance of the array constructed from the items .</returns>
        static BootstrapVoteArray IJsonArray<BootstrapVoteArray>.FromRange(IEnumerable<JsonAny> items)
        {
            return new([..items]);
        }
        ...
        /// <param name="items">The items from which to construct the instance.</param>
        /// <returns>An instance of the array constructed from the items.</returns>
        static BootstrapVoteArray IJsonArray<BootstrapVoteArray>.FromRange<T>(IEnumerable<T> items)
        {
        ...
        /// <inheritdoc/>
        IEnumerator<Generated.BootstrapVote> IEnumerable<Generated.BootstrapVote>.GetEnumerator() => this.EnumerateArray();

        /// <inheritdoc/>
        IEnumerator IEnumerable.GetEnumerator() => this.EnumerateArray();

        /// <inheritdoc/>
        int IReadOnlyCollection<Generated.BootstrapVote>.Count => this.GetArrayLength();
        ...
        /// <inheritdoc/>
        public JsonArrayEnumerator<Generated.BootstrapVote> EnumerateArray()
        {
            if ((this.backing & Backing.JsonElement) != 0)
            {
        ...
        /// <inheritdoc/>
        JsonArrayEnumerator IJsonArray<BootstrapVoteArray>.EnumerateArray()
        {
            if ((this.backing & Backing.JsonElement) != 0)
            {
                return new(this.jsonElementBacking);
        ...
        /// <inheritdoc/>
        JsonArrayEnumerator<TItem> IJsonArray<BootstrapVoteArray>.EnumerateArray<TItem>()
        {
            if ((this.backing & Backing.JsonElement) != 0)
            {
                return new(this.jsonElementBacking);
        ...
        /// <inheritdoc/>
        BootstrapVoteArray IJsonArray<BootstrapVoteArray>.Add(in JsonAny item1)
        {
        ...
        /// <inheritdoc/>
        BootstrapVoteArray IJsonArray<BootstrapVoteArray>.Add(params JsonAny[] items)
        {
            ImmutableList<JsonAny>.Builder builder = __CorvusArrayHelpers.GetImmutableListBuilder(this);
        ...
        /// <inheritdoc/>
        BootstrapVoteArray IJsonArray<BootstrapVoteArray>.AddRange<TArray>(in TArray items)
        {
            ImmutableList<JsonAny>.Builder builder = __CorvusArrayHelpers.GetImmutableListBuilder(this);
        ...
        /// <inheritdoc/>
        BootstrapVoteArray IJsonArray<BootstrapVoteArray>.AddRange<TItem>(IEnumerable<TItem> items)
        {
            ImmutableList<JsonAny>.Builder builder = __CorvusArrayHelpers.GetImmutableListBuilder(this);
        ...
        /// <inheritdoc/>
        BootstrapVoteArray IJsonArray<BootstrapVoteArray>.AddRange(IEnumerable<JsonAny> items)
        {
            ImmutableList<JsonAny>.Builder builder = __CorvusArrayHelpers.GetImmutableListBuilder(this);
        ...
        /// <inheritdoc/>
        BootstrapVoteArray IJsonArray<BootstrapVoteArray>.Insert(int index, in JsonAny item1)
        {
            return new(__CorvusArrayHelpers.GetImmutableListWith(this, index, item1));
        }

        /// <inheritdoc/>
        BootstrapVoteArray IJsonArray<BootstrapVoteArray>.InsertRange<TArray>(int index, in TArray items)
        {
            return new(__CorvusArrayHelpers.GetImmutableListWith(this, index, items.EnumerateArray()));
        }

        /// <inheritdoc/>
        BootstrapVoteArray IJsonArray<BootstrapVoteArray>.InsertRange<TItem>(int index, IEnumerable<TItem> items)
        {
            return new(__CorvusArrayHelpers.GetImmutableListWith(this, index, items.Select(item => item.AsAny)));
        }

        /// <inheritdoc/>
        BootstrapVoteArray IJsonArray<BootstrapVoteArray>.InsertRange(int index, IEnumerable<JsonAny> items)
        {
            return new(__CorvusArrayHelpers.GetImmutableListWith(this, index, items));
        }

        /// <inheritdoc/>
        BootstrapVoteArray IJsonArray<BootstrapVoteArray>.Replace(in JsonAny oldValue, in JsonAny newValue)
        {
            return new(__CorvusArrayHelpers.GetImmutableListReplacing(this, oldValue, newValue));
        }

        /// <inheritdoc/>
        BootstrapVoteArray IJsonArray<BootstrapVoteArray>.SetItem(int index, in JsonAny value)
        {
            return new(__CorvusArrayHelpers.GetImmutableListSetting(this, index, value));
        }

        /// <inheritdoc/>
        public BootstrapVoteArray Add(in Generated.BootstrapVote item1)
        {
            ImmutableList<JsonAny>.Builder builder = __CorvusArrayHelpers.GetImmutableListBuilder(this);
        ...
        /// <inheritdoc/>
        public BootstrapVoteArray Add(params Generated.BootstrapVote[] items)
        {
            ImmutableList<JsonAny>.Builder builder = __CorvusArrayHelpers.GetImmutableListBuilder(this);
            foreach (Generated.BootstrapVote item in items)
            {
                builder.Add(item.AsAny);
            }
        ...
        /// <inheritdoc/>
        public BootstrapVoteArray AddRange(IEnumerable<Generated.BootstrapVote> items)
        {
            ImmutableList<JsonAny>.Builder builder = __CorvusArrayHelpers.GetImmutableListBuilder(this);
            foreach (Generated.BootstrapVote item in items)
            {
        ...
        /// <inheritdoc/>
        public BootstrapVoteArray Insert(int index, in Generated.BootstrapVote item1)
        {
            return new(__CorvusArrayHelpers.GetImmutableListWith(this, index, item1));
        }

        /// <inheritdoc/>
        public BootstrapVoteArray InsertRange(int index, IEnumerable<Generated.BootstrapVote> items)
        {
            return new(__CorvusArrayHelpers.GetImmutableListWith(this, index, items.Select(item => item.AsAny)));
        }

        /// <inheritdoc/>
        public BootstrapVoteArray Replace(in Generated.BootstrapVote oldValue, in Generated.BootstrapVote newValue)
        {
            return new(__CorvusArrayHelpers.GetImmutableListReplacing(this, oldValue, newValue));
        }

        /// <inheritdoc/>
        public BootstrapVoteArray SetItem(int index, in Generated.BootstrapVote value)
        {
            return new(__CorvusArrayHelpers.GetImmutableListSetting(this, index, value));
        }

        /// <inheritdoc/>
        BootstrapVoteArray IJsonArray<BootstrapVoteArray>.Remove(in JsonAny oldValue)
        {
            return new(__CorvusArrayHelpers.GetImmutableListWithout(this, oldValue));
        }

        /// <inheritdoc/>
        BootstrapVoteArray IJsonArray<BootstrapVoteArray>.RemoveAt(int index)
        {
            return new(__CorvusArrayHelpers.GetImmutableListWithoutRange(this, index, 1));
        }

        /// <inheritdoc/>
        BootstrapVoteArray IJsonArray<BootstrapVoteArray>.RemoveRange(int index, int count)
        {
            return new(__CorvusArrayHelpers.GetImmutableListWithoutRange(this, index, count));
        }

        /// <inheritdoc/>
        public BootstrapVoteArray Remove(in Generated.BootstrapVote oldValue)
        {
            return new(__CorvusArrayHelpers.GetImmutableListWithout(this, oldValue));
        }
        ...
        private static class __CorvusArrayHelpers
        {
            ...
            /// <exception cref = "InvalidOperationException">The value is not an array.</exception>
            public static ImmutableList<JsonAny> GetImmutableList(in BootstrapVoteArray arrayInstance)
            {
            ...
            /// <exception cref = "InvalidOperationException">The value is not an array.</exception>
            public static ImmutableList<JsonAny>.Builder GetImmutableListBuilder(in BootstrapVoteArray arrayInstance)
            {
            ...
            public static ImmutableList<JsonAny> GetImmutableListSetting(in BootstrapVoteArray arrayInstance, int index, in JsonAny value)
            {
                if ((arrayInstance.backing & Backing.JsonElement) != 0)
                {
                    if (arrayInstance.jsonElementBacking.ValueKind == JsonValueKind.Array)
            ...
            /// <exception cref = "InvalidOperationException">The value is not an array.</exception>
            public static ImmutableList<JsonAny> GetImmutableListReplacing(in BootstrapVoteArray arrayInstance, in JsonAny oldItem, in JsonAny newItem)
            {
                if ((arrayInstance.backing & Backing.JsonElement) != 0)
                {
                    if (arrayInstance.jsonElementBacking.ValueKind == JsonValueKind.Array)
            ...
            /// <exception cref = "InvalidOperationException">The value is not an array.</exception>
            public static ImmutableList<JsonAny> GetImmutableListWithout(in BootstrapVoteArray arrayInstance, in JsonAny item)
            {
                if ((arrayInstance.backing & Backing.JsonElement) != 0)
                {
                    if (arrayInstance.jsonElementBacking.ValueKind == JsonValueKind.Array)
            ...
            /// <exception cref = "InvalidOperationException">The value is not an array.</exception>
            /// <exception cref = "IndexOutOfRangeException">Thrown if the range is beyond the bounds of the array.</exception>
            public static ImmutableList<JsonAny> GetImmutableListWithoutRange(in BootstrapVoteArray arrayInstance, int index, int count)
            {
                if ((arrayInstance.backing & Backing.JsonElement) != 0)
                {
                    if (arrayInstance.jsonElementBacking.ValueKind == JsonValueKind.Array)
            ...
            // <exception cref = "InvalidOperationException">The value is not an array.</exception>
            // <exception cref = "IndexOutOfRangeException">Thrown if the range is beyond the bounds of the array.</exception>
            public static ImmutableList<JsonAny> GetImmutableListWith(in BootstrapVoteArray arrayInstance, int index, in JsonAny value)
            {
                if ((arrayInstance.backing & Backing.JsonElement) != 0)
                {
                    if (arrayInstance.jsonElementBacking.ValueKind == JsonValueKind.Array)
            ...
            /// <exception cref = "InvalidOperationException">The value is not an array.</exception>
            /// <exception cref = "IndexOutOfRangeException">Thrown if the range is beyond the bounds of the array.</exception>
            public static ImmutableList<JsonAny> GetImmutableListWith<TEnumerable>(in BootstrapVoteArray arrayInstance, int index, TEnumerable values)
