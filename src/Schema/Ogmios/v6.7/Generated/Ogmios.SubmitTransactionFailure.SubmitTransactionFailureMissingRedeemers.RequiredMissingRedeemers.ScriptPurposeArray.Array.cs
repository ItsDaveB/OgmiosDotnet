    ...
    public readonly partial struct SubmitTransactionFailure
    {
        ...
        public readonly partial struct SubmitTransactionFailureMissingRedeemers
        {
            ...
            public readonly partial struct RequiredMissingRedeemers
            {
                ...
                /// </summary>
#if NET8_0_OR_GREATER
                [CollectionBuilder(typeof(ScriptPurposeArray), "Create")]
#endif
                public readonly partial struct ScriptPurposeArray
                    : IJsonArray<Generated.Ogmios.SubmitTransactionFailure.SubmitTransactionFailureMissingRedeemers.RequiredMissingRedeemers.ScriptPurposeArray>,
                      IReadOnlyCollection<Generated.ScriptPurpose>
                {
                    /// <summary>
                    /// Gets an empty array.
                    /// </summary>
                    public static ScriptPurposeArray EmptyArray { get; } = From(ImmutableList<JsonAny>.Empty);
                    ...
                    /// <inheritdoc/>
                    Corvus.Json.JsonAny IJsonArray<ScriptPurposeArray>.this[int index]
                    {
                        get
                        {
                    ...
                    public Generated.ScriptPurpose this[int index]
                    {
                        get
                        {
                            if ((this.backing & Backing.JsonElement) != 0)
                            ...
                            if ((this.backing & Backing.Array) != 0)
                            {
                                try
                                {
                                    return this.arrayBacking[index].As<Generated.ScriptPurpose>();
                                }
                                catch (ArgumentOutOfRangeException ex)
                                {
                                    throw new IndexOutOfRangeException(ex.Message, ex);
                    ...
                    public static implicit operator ScriptPurposeArray(ImmutableList<JsonAny> value)
                    {
                        return new(value);
                    }
                    ...
                    /// </summary>
                    /// <param name="value">The value from which to convert.</param>
                    public static implicit operator ImmutableList<JsonAny>(ScriptPurposeArray value)
                    {
                        return
                    ...
                    /// </summary>
                    /// <param name="value">The value from which to convert.</param>
                    public static implicit operator ScriptPurposeArray(JsonArray value)
                    {
                    ...
                    /// </summary>
                    /// <param name="value">The value from which to convert.</param>
                    public static implicit operator JsonArray(ScriptPurposeArray value)
                    {
                        return
                            value.AsArray;
                    }
                    ...
                    /// <summary>
                    /// Initializes a new instance of the <see cref="ScriptPurposeArray"/> struct.
                    /// </summary>
                    ...
                    public static ScriptPurposeArray From(ImmutableList<JsonAny> items)
                    {
                        return new(items);
                    }

                    /// <summary>
                    /// Create an new instance of the <see cref="ScriptPurposeArray"/>" struct from a span of items.
                    /// </summary>
                    ...
                    public static ScriptPurposeArray Create(ReadOnlySpan<Generated.ScriptPurpose> items)
                    {
                        return new([..items]);
                    }
                    ...
                    public static ScriptPurposeArray FromItems(params Generated.ScriptPurpose[] items)
                    {
                        return new([..items]);
                    }
                    ...
                    public static ScriptPurposeArray FromItems(in Generated.ScriptPurpose item1)
                    {
                    ...
                    /// <returns>An instance of the array constructed from the values.</returns>
                    public static ScriptPurposeArray FromItems(in Generated.ScriptPurpose item1, in Generated.ScriptPurpose item2)
                    {
                    ...
                    /// <returns>An instance of the array constructed from the values.</returns>
                    public static ScriptPurposeArray FromItems(in Generated.ScriptPurpose item1, in Generated.ScriptPurpose item2, in Generated.ScriptPurpose item3)
                    {
                    ...
                    /// <returns>An instance of the array constructed from the values.</returns>
                    public static ScriptPurposeArray FromItems(in Generated.ScriptPurpose item1, in Generated.ScriptPurpose item2, in Generated.ScriptPurpose item3, in Generated.ScriptPurpose item4)
                    {
                    ...
                    /// <returns>An instance of the array constructed from the values.</returns>
                    public static ScriptPurposeArray FromItems(in Generated.ScriptPurpose item1, in Generated.ScriptPurpose item2, in Generated.ScriptPurpose item3, in Generated.ScriptPurpose item4, in Generated.ScriptPurpose item5)
                    {
                    ...
                    /// <returns>An instance of the array constructed from the values.</returns>
                    public static ScriptPurposeArray FromItems(in Generated.ScriptPurpose item1, in Generated.ScriptPurpose item2, in Generated.ScriptPurpose item3, in Generated.ScriptPurpose item4, in Generated.ScriptPurpose item5, in Generated.ScriptPurpose item6)
                    {
                    ...
                    /// <returns>An instance of the array constructed from the values.</returns>
                    public static ScriptPurposeArray FromItems(in Generated.ScriptPurpose item1, in Generated.ScriptPurpose item2, in Generated.ScriptPurpose item3, in Generated.ScriptPurpose item4, in Generated.ScriptPurpose item5, in Generated.ScriptPurpose item6, in Generated.ScriptPurpose item7)
                    {
                    ...
                    public static ScriptPurposeArray FromRange(IEnumerable<Generated.ScriptPurpose> items)
                    {
                        return new([..items]);
                    }
                    ...
                    /// <param name="items">The items from which to construct the instance.</param>
                    /// <returns>An instance of the array constructed from the items .</returns>
                    static ScriptPurposeArray IJsonArray<ScriptPurposeArray>.FromRange(IEnumerable<JsonAny> items)
                    {
                        return new([..items]);
                    }
                    ...
                    /// <param name="items">The items from which to construct the instance.</param>
                    /// <returns>An instance of the array constructed from the items.</returns>
                    static ScriptPurposeArray IJsonArray<ScriptPurposeArray>.FromRange<T>(IEnumerable<T> items)
                    {
                    ...
                    /// <inheritdoc/>
                    IEnumerator<Generated.ScriptPurpose> IEnumerable<Generated.ScriptPurpose>.GetEnumerator() => this.EnumerateArray();

                    /// <inheritdoc/>
                    IEnumerator IEnumerable.GetEnumerator() => this.EnumerateArray();

                    /// <inheritdoc/>
                    int IReadOnlyCollection<Generated.ScriptPurpose>.Count => this.GetArrayLength();
                    ...
                    /// <inheritdoc/>
                    public JsonArrayEnumerator<Generated.ScriptPurpose> EnumerateArray()
                    {
                        if ((this.backing & Backing.JsonElement) != 0)
                        {
                    ...
                    /// <inheritdoc/>
                    JsonArrayEnumerator IJsonArray<ScriptPurposeArray>.EnumerateArray()
                    {
                        if ((this.backing & Backing.JsonElement) != 0)
                        {
                            return new(this.jsonElementBacking);
                    ...
                    /// <inheritdoc/>
                    JsonArrayEnumerator<TItem> IJsonArray<ScriptPurposeArray>.EnumerateArray<TItem>()
                    {
                        if ((this.backing & Backing.JsonElement) != 0)
                        {
                            return new(this.jsonElementBacking);
                    ...
                    /// <inheritdoc/>
                    ScriptPurposeArray IJsonArray<ScriptPurposeArray>.Add(in JsonAny item1)
                    {
                    ...
                    /// <inheritdoc/>
                    ScriptPurposeArray IJsonArray<ScriptPurposeArray>.Add(params JsonAny[] items)
                    {
                        ImmutableList<JsonAny>.Builder builder = __CorvusArrayHelpers.GetImmutableListBuilder(this);
                    ...
                    /// <inheritdoc/>
                    ScriptPurposeArray IJsonArray<ScriptPurposeArray>.AddRange<TArray>(in TArray items)
                    {
                        ImmutableList<JsonAny>.Builder builder = __CorvusArrayHelpers.GetImmutableListBuilder(this);
                    ...
                    /// <inheritdoc/>
                    ScriptPurposeArray IJsonArray<ScriptPurposeArray>.AddRange<TItem>(IEnumerable<TItem> items)
                    {
                        ImmutableList<JsonAny>.Builder builder = __CorvusArrayHelpers.GetImmutableListBuilder(this);
                    ...
                    /// <inheritdoc/>
                    ScriptPurposeArray IJsonArray<ScriptPurposeArray>.AddRange(IEnumerable<JsonAny> items)
                    {
                        ImmutableList<JsonAny>.Builder builder = __CorvusArrayHelpers.GetImmutableListBuilder(this);
                    ...
                    /// <inheritdoc/>
                    ScriptPurposeArray IJsonArray<ScriptPurposeArray>.Insert(int index, in JsonAny item1)
                    {
                        return new(__CorvusArrayHelpers.GetImmutableListWith(this, index, item1));
                    }

                    /// <inheritdoc/>
                    ScriptPurposeArray IJsonArray<ScriptPurposeArray>.InsertRange<TArray>(int index, in TArray items)
                    {
                        return new(__CorvusArrayHelpers.GetImmutableListWith(this, index, items.EnumerateArray()));
                    }

                    /// <inheritdoc/>
                    ScriptPurposeArray IJsonArray<ScriptPurposeArray>.InsertRange<TItem>(int index, IEnumerable<TItem> items)
                    {
                        return new(__CorvusArrayHelpers.GetImmutableListWith(this, index, items.Select(item => item.AsAny)));
                    }

                    /// <inheritdoc/>
                    ScriptPurposeArray IJsonArray<ScriptPurposeArray>.InsertRange(int index, IEnumerable<JsonAny> items)
                    {
                        return new(__CorvusArrayHelpers.GetImmutableListWith(this, index, items));
                    }

                    /// <inheritdoc/>
                    ScriptPurposeArray IJsonArray<ScriptPurposeArray>.Replace(in JsonAny oldValue, in JsonAny newValue)
                    {
                        return new(__CorvusArrayHelpers.GetImmutableListReplacing(this, oldValue, newValue));
                    }

                    /// <inheritdoc/>
                    ScriptPurposeArray IJsonArray<ScriptPurposeArray>.SetItem(int index, in JsonAny value)
                    {
                        return new(__CorvusArrayHelpers.GetImmutableListSetting(this, index, value));
                    }

                    /// <inheritdoc/>
                    public ScriptPurposeArray Add(in Generated.ScriptPurpose item1)
                    {
                        ImmutableList<JsonAny>.Builder builder = __CorvusArrayHelpers.GetImmutableListBuilder(this);
                    ...
                    /// <inheritdoc/>
                    public ScriptPurposeArray Add(params Generated.ScriptPurpose[] items)
                    {
                        ImmutableList<JsonAny>.Builder builder = __CorvusArrayHelpers.GetImmutableListBuilder(this);
                        foreach (Generated.ScriptPurpose item in items)
                        {
                            builder.Add(item.AsAny);
                        }
                    ...
                    /// <inheritdoc/>
                    public ScriptPurposeArray AddRange(IEnumerable<Generated.ScriptPurpose> items)
                    {
                        ImmutableList<JsonAny>.Builder builder = __CorvusArrayHelpers.GetImmutableListBuilder(this);
                        foreach (Generated.ScriptPurpose item in items)
                        {
                    ...
                    /// <inheritdoc/>
                    public ScriptPurposeArray Insert(int index, in Generated.ScriptPurpose item1)
                    {
                        return new(__CorvusArrayHelpers.GetImmutableListWith(this, index, item1));
                    }

                    /// <inheritdoc/>
                    public ScriptPurposeArray InsertRange(int index, IEnumerable<Generated.ScriptPurpose> items)
                    {
                        return new(__CorvusArrayHelpers.GetImmutableListWith(this, index, items.Select(item => item.AsAny)));
                    }

                    /// <inheritdoc/>
                    public ScriptPurposeArray Replace(in Generated.ScriptPurpose oldValue, in Generated.ScriptPurpose newValue)
                    {
                        return new(__CorvusArrayHelpers.GetImmutableListReplacing(this, oldValue, newValue));
                    }

                    /// <inheritdoc/>
                    public ScriptPurposeArray SetItem(int index, in Generated.ScriptPurpose value)
                    {
                        return new(__CorvusArrayHelpers.GetImmutableListSetting(this, index, value));
                    }

                    /// <inheritdoc/>
                    ScriptPurposeArray IJsonArray<ScriptPurposeArray>.Remove(in JsonAny oldValue)
                    {
                        return new(__CorvusArrayHelpers.GetImmutableListWithout(this, oldValue));
                    }

                    /// <inheritdoc/>
                    ScriptPurposeArray IJsonArray<ScriptPurposeArray>.RemoveAt(int index)
                    {
                        return new(__CorvusArrayHelpers.GetImmutableListWithoutRange(this, index, 1));
                    }

                    /// <inheritdoc/>
                    ScriptPurposeArray IJsonArray<ScriptPurposeArray>.RemoveRange(int index, int count)
                    {
                        return new(__CorvusArrayHelpers.GetImmutableListWithoutRange(this, index, count));
                    }

                    /// <inheritdoc/>
                    public ScriptPurposeArray Remove(in Generated.ScriptPurpose oldValue)
                    {
                        return new(__CorvusArrayHelpers.GetImmutableListWithout(this, oldValue));
                    }
                    ...
                    private static class __CorvusArrayHelpers
                    {
                        ...
                        /// <exception cref = "InvalidOperationException">The value is not an array.</exception>
                        public static ImmutableList<JsonAny> GetImmutableList(in ScriptPurposeArray arrayInstance)
                        {
                        ...
                        /// <exception cref = "InvalidOperationException">The value is not an array.</exception>
                        public static ImmutableList<JsonAny>.Builder GetImmutableListBuilder(in ScriptPurposeArray arrayInstance)
                        {
                        ...
                        public static ImmutableList<JsonAny> GetImmutableListSetting(in ScriptPurposeArray arrayInstance, int index, in JsonAny value)
                        {
                            if ((arrayInstance.backing & Backing.JsonElement) != 0)
                            {
                                if (arrayInstance.jsonElementBacking.ValueKind == JsonValueKind.Array)
                        ...
                        /// <exception cref = "InvalidOperationException">The value is not an array.</exception>
                        public static ImmutableList<JsonAny> GetImmutableListReplacing(in ScriptPurposeArray arrayInstance, in JsonAny oldItem, in JsonAny newItem)
                        {
                            if ((arrayInstance.backing & Backing.JsonElement) != 0)
                            {
                                if (arrayInstance.jsonElementBacking.ValueKind == JsonValueKind.Array)
                        ...
                        /// <exception cref = "InvalidOperationException">The value is not an array.</exception>
                        public static ImmutableList<JsonAny> GetImmutableListWithout(in ScriptPurposeArray arrayInstance, in JsonAny item)
                        {
                            if ((arrayInstance.backing & Backing.JsonElement) != 0)
                            {
                                if (arrayInstance.jsonElementBacking.ValueKind == JsonValueKind.Array)
                        ...
                        /// <exception cref = "InvalidOperationException">The value is not an array.</exception>
                        /// <exception cref = "IndexOutOfRangeException">Thrown if the range is beyond the bounds of the array.</exception>
                        public static ImmutableList<JsonAny> GetImmutableListWithoutRange(in ScriptPurposeArray arrayInstance, int index, int count)
                        {
                            if ((arrayInstance.backing & Backing.JsonElement) != 0)
                            {
                                if (arrayInstance.jsonElementBacking.ValueKind == JsonValueKind.Array)
                        ...
                        // <exception cref = "InvalidOperationException">The value is not an array.</exception>
                        // <exception cref = "IndexOutOfRangeException">Thrown if the range is beyond the bounds of the array.</exception>
                        public static ImmutableList<JsonAny> GetImmutableListWith(in ScriptPurposeArray arrayInstance, int index, in JsonAny value)
                        {
                            if ((arrayInstance.backing & Backing.JsonElement) != 0)
                            {
                                if (arrayInstance.jsonElementBacking.ValueKind == JsonValueKind.Array)
                        ...
                        /// <exception cref = "InvalidOperationException">The value is not an array.</exception>
                        /// <exception cref = "IndexOutOfRangeException">Thrown if the range is beyond the bounds of the array.</exception>
                        public static ImmutableList<JsonAny> GetImmutableListWith<TEnumerable>(in ScriptPurposeArray arrayInstance, int index, TEnumerable values)
